...
thf(thm_2Eiterate_2ENUMSEG__ADD__SPLIT,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2p: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ V0m @ ( c_2Earithmetic_2E_2B @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
     => ( ( c_2Eiterate_2E_2E_2E @ V0m @ ( c_2Earithmetic_2E_2B @ V1n @ V2p ) )
        = ( c_2Epred__set_2EUNION @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V0m @ V1n ) @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2E_2B @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Earithmetic_2E_2B @ V1n @ V2p ) ) ) ) ) )).
...
thf(thm_2Eiterate_2ENSUM__ADD__SPLIT,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum,V3p: tyop_2Enum_2Enum] :
     ...
     => ( ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1m @ ( c_2Earithmetic_2E_2B @ V2n @ V3p ) ) @ V0f )
        = ( c_2Earithmetic_2E_2B @ ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1m @ V2n ) @ V0f ) @ ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2E_2B @ V2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Earithmetic_2E_2B @ V2n @ V3p ) ) @ V0f ) ) ) ) )).
