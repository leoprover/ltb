...
thf(thm_2Equotient__sum_2ESUM__REL__ind,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0P: ( A_27a > A_27a > $o ) > ( A_27b > A_27b > $o ) > ( tyop_2Esum_2Esum @ A_27a @ A_27b ) > ( tyop_2Esum_2Esum @ A_27a @ A_27b ) > $o] :
      ( ( ! [V1R1: A_27a > A_27a > $o,V2R2: A_27b > A_27b > $o,V3a1: A_27a,V4a2: A_27a] :
            ( V0P @ V1R1 @ V2R2 @ ( c_2Esum_2EINL @ A_27a @ A_27b @ V3a1 ) @ ( c_2Esum_2EINL @ A_27a @ A_27b @ V4a2 ) )
        & ! [V5R1: A_27a > A_27a > $o,V6R2: A_27b > A_27b > $o,V7b1: A_27b,V8b2: A_27b] :
            ( V0P @ V5R1 @ V6R2 @ ( c_2Esum_2EINR @ A_27a @ A_27b @ V7b1 ) @ ( c_2Esum_2EINR @ A_27a @ A_27b @ V8b2 ) )
        & ! [V9R1: A_27a > A_27a > $o,V10R2: A_27b > A_27b > $o,V11a1: A_27a,V12b2: A_27b] :
            ( V0P @ V9R1 @ V10R2 @ ( c_2Esum_2EINL @ A_27a @ A_27b @ V11a1 ) @ ( c_2Esum_2EINR @ A_27a @ A_27b @ V12b2 ) )
        & ! [V13R1: A_27a > A_27a > $o,V14R2: A_27b > A_27b > $o,V15b1: A_27b,V16a2: A_27a] :
            ( V0P @ V13R1 @ V14R2 @ ( c_2Esum_2EINR @ A_27a @ A_27b @ V15b1 ) @ ( c_2Esum_2EINL @ A_27a @ A_27b @ V16a2 ) ) )
     => ! [V17v: A_27a > A_27a > $o,V18v1: A_27b > A_27b > $o,V19v2: tyop_2Esum_2Esum @ A_27a @ A_27b,V20v3: tyop_2Esum_2Esum @ A_27a @ A_27b] :
