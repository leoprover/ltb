...
thf(f2460_0_2E0,type,(
    f2460_0_2E0: u )).

thf(f2460_0_2E1,type,(
    f2460_0_2E1: du > u )).

thf(f2997_0_2E0,type,(
    f2997_0_2E0: u )).

thf(f2997_0_2E1,type,(
    f2997_0_2E1: du > u )).

thf(f2997_0_2E2,type,(
    f2997_0_2E2: du > du > u )).
...
thf(mono_2Ef2997_0,type,(
    mono_2Ef2997_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(arityeq1_2Emono_2Ef2460_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ A_27a @ ( f2460_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ f2460_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Elist_2EMAP_2E2_2Emono_2EA_27a_20mono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
...
thf(def0_2Ethm_2Elist_2EMAP__ID,axiom,(
    ! [A_27a: d,V1x_2E0: u] :
      ( ( s @ A_27a @ ( f2460_0_2E1 @ ( s @ A_27a @ V1x_2E0 ) ) )
      = ( s @ A_27a @ V1x_2E0 ) ) )).

thf(thm_2Elist_2EMAP__ID,axiom,(
    ! [A_27a: d,V0l_2E0: u] :
      ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ f2460_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) )
      & ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ c_2Ecombin_2EI_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) )).
...
thf(def0_2Ethm_2Erich__list_2ECOUNT__LIST__ADD,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V2n_27: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2997_0 @ V0n @ V2n_27 )
      = ( mono_2Ec_2Earithmetic_2E_2B @ V2n_27 @ V0n ) ) )).

thf(thm_2Erich__list_2ECOUNT__LIST__ADD,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Erich__list_2ECOUNT__LIST @ ( mono_2Ec_2Earithmetic_2E_2B @ V0n @ V1m ) )
      = ( mono_2Ec_2Elist_2EAPPEND_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Erich__list_2ECOUNT__LIST @ V0n ) @ ( mono_2Ec_2Elist_2EMAP_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ef2997_0 @ V0n ) @ ( mono_2Ec_2Erich__list_2ECOUNT__LIST @ V1m ) ) ) ) )).
