...
thf(conj_thm_2Erich__list_2ELENGTH__FRONT,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( V0l
         != ( c_2Elist_2ENIL @ A_27a ) )
       => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ ( ap @ ( c_2Elist_2EFRONT @ A_27a ) @ V0l ) ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Eprim__rec_2EPRE @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l ) ) ) ) ) ) )).
