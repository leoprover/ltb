     ...
     => ! [V1m] :
         ...
         => ! [V2a] :
             ...
             => ! [V3b] :
                 ...
                 => ap(ap(ap(ap(c_2Eieee_2Efdiv,V0X),V1m),V2a),V3b) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Eieee_2Eis__nan,V0X),V2a)),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Eieee_2Eis__nan,V0X),V3b)),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eieee_2Eis__zero,V0X),V2a)),ap(ap(c_2Eieee_2Eis__zero,V0X),V3b))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eieee_2Eis__infinity,V0X),V2a)),ap(ap(c_2Eieee_2Eis__infinity,V0X),V3b)))))),ap(c_2Eieee_2Esome__nan,V0X)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Eieee_2Eis__infinity,V0X),V2a)),ap(ap(c_2Eieee_2Eis__zero,V0X),V3b))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(c_2Eieee_2Esign,V2a)),ap(c_2Eieee_2Esign,V3b))),ap(c_2Eieee_2Eplus__infinity,V0X)),ap(c_2Eieee_2Eminus__infinity,V0X))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Eieee_2Eis__infinity,V0X),V3b)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(c_2Eieee_2Esign,V2a)),ap(c_2Eieee_2Esign,V3b))),ap(c_2Eieee_2Eplus__zero,V0X)),ap(c_2Eieee_2Eminus__zero,V0X))),ap(ap(ap(c_2Eieee_2Ezerosign,V0X),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(c_2Eieee_2Esign,V2a)),ap(c_2Eieee_2Esign,V3b))),c_2Enum_2E0),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(ap(c_2Eieee_2Eround,V0X),V1m),ap(ap(c_2Ereal_2E_2F,ap(ap(c_2Eieee_2Evalof,V0X),V2a)),ap(ap(c_2Eieee_2Evalof,V0X),V3b))))))) ) ) ) ) )).
...
fof(conj_thm_2Efloat_2EFLOAT__DIV__RELATIVE,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Eieee_2Efloat)
     => ! [V1b] :
          ( mem(V1b,ty_2Eieee_2Efloat)
         => ( ( p(ap(c_2Eieee_2EFinite,V0a))
              ...
              & ~ p(ap(c_2Eieee_2EIszero,V1b))
              & p(ap(c_2Efloat_2Enormalizes,ap(ap(c_2Ereal_2E_2F,ap(c_2Eieee_2EVal,V0a)),ap(c_2Eieee_2EVal,V1b)))) )
           => ( p(ap(c_2Eieee_2EFinite,ap(ap(c_2Eieee_2Efloat__div,V0a),V1b)))
              & ? [V2e] :
                  ( mem(V2e,ty_2Erealax_2Ereal)
                  & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,V2e)),ap(ap(c_2Ereal_2E_2F,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Ereal_2Epow,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))))))))
                  & ap(c_2Eieee_2EVal,ap(ap(c_2Eieee_2Efloat__div,V0a),V1b)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(c_2Eieee_2EVal,V0a)),ap(c_2Eieee_2EVal,V1b))),ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2e)) ) ) ) ) ) )).
