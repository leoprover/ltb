...
thf(conj_thm_2Ereal__topology_2EBILINEAR__CONTINUOUS__ON__COMPOSE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EBILINEAR__DOT,lemma,
    ( p
    @ ( ap @ c_2Ereal__topology_2Ebilinear
      @ ( lam @ ty_2Erealax_2Ereal
        @ ^ [V0x: $i] :
            ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1y: $i] :
                ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ V0x ) @ V1y ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__DOT2,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
