...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__WITHIN__SEQUENTIALLY,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
            ...
            <=> ! [V3x: $i] :
                 ...
                 => ( ( ! [V4n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V3x,inj__ty_2Enum_2Enum(V4n))),V1s))
                   ...
                   => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),V3x)),ap(V0f,inj__ty_2Erealax_2Ereal(V2a))),c_2Ereal__topology_2Esequentially)) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__SEQUENTIALLY,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
