...
thf(ax_thm_2Erich__list_2ELASTN__def,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1xs: $i] :
      ( ( mem @ V1xs @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1xs )
        = ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ V1xs ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2ELASTN,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0l: $i] :
          ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
