...
fof(ax_thm_2Enumeral_2Etexp__help__def,axiom,
    ( ! [V0acc] :
        ( mem(V0acc,ty_2Enum_2Enum)
       => ap(ap(c_2Enumeral_2Etexp__help,c_2Enum_2E0),V0acc) = ap(c_2Earithmetic_2EBIT2,V0acc) )
    & ! [V1n] :
        ( mem(V1n,ty_2Enum_2Enum)
       => ! [V2acc] :
            ( mem(V2acc,ty_2Enum_2Enum)
           => ap(ap(c_2Enumeral_2Etexp__help,ap(c_2Enum_2ESUC,V1n)),V2acc) = ap(ap(c_2Enumeral_2Etexp__help,V1n),ap(c_2Earithmetic_2EBIT1,V2acc)) ) ) )).

fof(conj_thm_2Enumeral_2Enumeral__texp__help,conjecture,(
    ! [V0acc] :
      ( mem(V0acc,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
