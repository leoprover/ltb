...
thf(conj_thm_2Ecardinal_2ECARD__NOT__LT,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__MUL__FINITE,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__MUL__ABSORB__LE,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__MUL__LT__LEMMA,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
