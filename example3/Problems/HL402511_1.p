...
tff(thm_2EquantHeuristics_2EIMP__NEG__CONTRA,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1i_2E0: u,V2x_2E0: u] :
      ( ~ p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0),s(A_27a,V1i_2E0)))))
