...
tff(mem_c_2Efcp_2EFCP__HD,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efcp_2EFCP__HD(A_27a,A_27a),arr(ty_2Efcp_2Ecart(A_27a,A_27a),A_27a)) )).
...
tff(ax_thm_2Efcp_2EFCP__HD__def,axiom,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
     ...
     => ap(c_2Efcp_2EFCP__HD(A_27a,A_27a),V0v) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V0v),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) ) )).
...
tff(conj_thm_2Efcp_2EFCP__HD,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ap(c_2Efcp_2EFCP__HD(A_27a,A_27a),V0v) = ap(c_2Elist_2EHD(A_27a),ap(c_2Efcp_2EV2L(A_27a,A_27a),V0v)) ) )).
