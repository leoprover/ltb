...
tff(conj_thm_2EDecode_2Eenc2dec__some__alt,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1e: $i] :
          ( mem(V1e,arr(A_27a,ty_2Elist_2Elist(bool)))
         => ! [V2l: tp__c_ty_2Elist_2Elist_o,V3x: $i] :
             ...
             => ( p(ap(ap(c_2EEncode_2Ewf__encoder(A_27a),V0p),V1e))
               => ( ap(ap(ap(c_2EDecode_2Eenc2dec(A_27a),V0p),V1e),inj__c_ty_2Elist_2Elist_o(V2l)) = ap(c_2Eoption_2ESOME(ty_2Epair_2Eprod(A_27a,A_27a)),V3x)
                <=> ( p(ap(V0p,ap(c_2Epair_2EFST(A_27a,A_27a),V3x)))
                    & V2l = surj__c_ty_2Elist_2Elist_o(ap(ap(c_2Elist_2EAPPEND(bool),ap(V1e,ap(c_2Epair_2EFST(A_27a,A_27a),V3x))),ap(c_2Epair_2ESND(A_27a,A_27a),V3x))) ) ) ) ) ) ) )).
