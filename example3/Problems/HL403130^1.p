...
thf(f3711_0_2E0,type,(
    f3711_0_2E0: u )).

thf(f3711_0_2E1,type,(
    f3711_0_2E1: du > u )).

thf(f3711_1_2E0,type,(
    f3711_1_2E0: u )).

thf(f3711_1_2E1,type,(
    f3711_1_2E1: du > u )).

thf(f3711_1_2E2,type,(
    f3711_1_2E2: du > du > u )).

thf(f3711_2_2E0,type,(
    f3711_2_2E0: u )).

thf(f3711_2_2E1,type,(
    f3711_2_2E1: du > u )).

thf(f3711_3_2E0,type,(
    f3711_3_2E0: u )).

thf(f3711_3_2E1,type,(
    f3711_3_2E1: du > u )).

thf(f3711_4_2E0,type,(
    f3711_4_2E0: u )).

thf(f3711_4_2E1,type,(
    f3711_4_2E1: du > u )).

thf(f3711_5_2E0,type,(
    f3711_5_2E0: u )).

thf(f3711_5_2E1,type,(
    f3711_5_2E1: du > u )).

thf(f3711_5_2E2,type,(
    f3711_5_2E2: du > du > u )).
...
thf(mono_2Ef3711_0,type,(
    mono_2Ef3711_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3711_1,type,(
    mono_2Ef3711_1: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3711_2,type,(
    mono_2Ef3711_2: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3711_3,type,(
    mono_2Ef3711_3: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3711_4,type,(
    mono_2Ef3711_4: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3711_5,type,(
    mono_2Ef3711_5: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EBEFORE__SIMP,axiom,(
    ! [V9t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3711_4 @ V9t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def1_2Ethm_2ETemporal__Logic_2EBEFORE__SIMP,axiom,(
    ! [V5t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3711_2 @ V5t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def2_2Ethm_2ETemporal__Logic_2EBEFORE__SIMP,axiom,(
    ! [V7t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3711_3 @ V7t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def3_2Ethm_2ETemporal__Logic_2EBEFORE__SIMP,axiom,(
    ! [V2t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3711_0 @ V2t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def4_2Ethm_2ETemporal__Logic_2EBEFORE__SIMP,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V10t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3711_5 @ V1a @ V10t )
    <=> ( (~) @ ( V1a @ V10t ) ) ) )).

thf(def5_2Ethm_2ETemporal__Logic_2EBEFORE__SIMP,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3711_1 @ V0b @ V3t )
    <=> ( (~) @ ( V0b @ V3t ) ) ) )).

thf(thm_2ETemporal__Logic_2EBEFORE__SIMP,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2ETemporal__Logic_2EBEFORE @ mono_2Ef3711_0 @ V0b )
        = ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ ( mono_2Ef3711_1 @ V0b ) ) )
      & ! [V4x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EBEFORE @ mono_2Ef3711_2 @ V0b @ V4x )
        <=> ( (~) @ ( V0b @ V4x ) ) )
      & ! [V6x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EBEFORE @ V1a @ mono_2Ef3711_3 @ V6x )
          = mono_2Ec_2Ebool_2ET )
      & ! [V8x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EBEFORE @ V1a @ mono_2Ef3711_4 @ V8x )
          = mono_2Ec_2Ebool_2EF )
      & ( ( mono_2Ec_2ETemporal__Logic_2EBEFORE @ V1a @ V1a )
        = ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ ( mono_2Ef3711_5 @ V1a ) ) ) ) )).
