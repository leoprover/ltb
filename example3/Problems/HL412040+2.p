...
fof(conj_thm_2Elebesgue_2Eintegrable__indicator,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
...
fof(conj_thm_2Elebesgue_2Eintegral__cmul,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Elebesgue_2Eintegral__cmul__indicator,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ! [V2c] :
                 ...
                 => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                      & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))) )
                   => ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),f4149(A_27a,V1s,V2c)) = ap(c_2Eextreal_2ENormal,ap(ap(c_2Erealax_2Ereal__mul,V2c),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s))) ) ) ) ) ) )).
