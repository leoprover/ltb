...
thf(thm_2Egcd_2EGCD__ADD__R__THM,axiom,
    ( ! [V0a: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum] :
        ...
        = ( mono_2Ec_2Egcd_2Egcd @ V0a @ V1b ) )
    & ! [V2a: mono_2Etyop_2Enum_2Enum,V3b: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Egcd_2Egcd @ V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V3b @ V2a ) )
        = ( mono_2Ec_2Egcd_2Egcd @ V2a @ V3b ) ) )).
...
thf(thm_2Egcd_2ELINEAR__GCD,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( (~) @ ( V0n = mono_2Ec_2Enum_2E0 ) )
     => ? [V2p: mono_2Etyop_2Enum_2Enum,V3q: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Earithmetic_2E_2A @ V2p @ V0n )
          = ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2E_2A @ V3q @ V1m ) @ ( mono_2Ec_2Egcd_2Egcd @ V1m @ V0n ) ) ) ) )).
