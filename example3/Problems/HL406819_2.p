...
tff(conj_thm_2Epred__set_2EINSERT__UNION__EQ,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(mem_c_2Etc_2ETC__ITER,axiom,(
    ! [A_27a: del] : mem(c_2Etc_2ETC__ITER(A_27a),arr(ty_2Elist_2Elist(A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)))) )).
...
tff(conj_thm_2Etc_2ETC__MOD__LEM,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(ax_thm_2Etc_2ETC__ITER,axiom,(
    ! [A_27a: del] :
      ( ! [V0r: $i] :
          ( mem(V0r,ty_2Efinite__map_2Efmap(A_27a,A_27a))
      ...
      & ! [V1x: $i] :
         ...
         => ! [V2d: $i] :
             ...
             => ! [V3r: $i] :
                  ( mem(V3r,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                 => ap(ap(c_2Etc_2ETC__ITER(A_27a),ap(ap(c_2Elist_2ECONS(A_27a),V1x),V2d)),V3r) = ap(ap(c_2Etc_2ETC__ITER(A_27a),V2d),ap(ap(c_2Efinite__map_2Eo__f(A_27a,A_27a,A_27a),ap(ap(c_2Etc_2ETC__MOD(A_27a),V1x),ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V3r),V1x))),V3r)) ) ) ) ) )).

tff(conj_thm_2Etc_2ETC__ITER__THM,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1d: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( ap(ap(c_2Epred__set_2EUNION(A_27a),V3s),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1d)) = ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V2f)
