...
thf(conj_thm_2Elist_2ESUM__IMAGE__eq__SUM__MAP__SET__TO__LIST,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Esorting_2EPERM__INTRO,lemma,(
    ! [A_27a: del,V0x: $i] :
...
thf(conj_thm_2Esorting_2EPERM__SUM,lemma,(
...
thf(conj_thm_2Esorting_2EPERM__SET__TO__LIST__count__COUNT__LIST,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ ( c_2Esorting_2EPERM @ ty_2Enum_2Enum ) @ ( ap @ ( c_2Elist_2ESET__TO__LIST @ ty_2Enum_2Enum ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).

thf(conj_thm_2Esorting_2ESUM__IMAGE__count__SUM__GENLIST,conjecture,(
    ! [V0f: $i] :
