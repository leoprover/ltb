...
tff(conj_thm_2EHolSmt_2Er023,conjecture,(
    ! [A_27a: del,V0p: tp__o,V1x: $i] :
     ...
     => ! [V2y: $i] :
         ...
         => ! [V3z: $i] :
              ( mem(V3z,A_27a)
             => ap(ap(ap(c_2Ebool_2ECOND(A_27a),inj__o(V0p)),V1x),ap(ap(ap(c_2Ebool_2ECOND(A_27a),inj__o(V0p)),V2y),V3z)) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),inj__o(V0p)),V1x),V3z) ) ) ) )).
