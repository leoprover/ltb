...
thf(arityeq2_2Emono_2Ec_2Ebool_2Eliteral__case_2E2_2Emono_2EA_27c_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27a @ ( c_2Ebool_2Eliteral__case_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) @ ( s @ A_27c @ X1_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ c_2Ebool_2Eliteral__case_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27c @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Ebool_2Eliteral__case_2E2_2Emono_2EA_27c_20mono_2EA_27b,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27b @ ( c_2Ebool_2Eliteral__case_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ X0_2E0 ) @ ( s @ A_27c @ X1_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ c_2Ebool_2Eliteral__case_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ A_27c @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Ecombin_2EGEN__literal__case__RAND,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0v_2E0: u,V1f_2E0: u,V2P_2E0: u] :
      ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V2P_2E0 ) @ ( s @ A_27b @ ( c_2Ebool_2Eliteral__case_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ V1f_2E0 ) @ ( s @ A_27c @ V0v_2E0 ) ) ) ) )
      = ( s @ A_27a @ ( c_2Ebool_2Eliteral__case_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V2P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ V1f_2E0 ) ) ) @ ( s @ A_27c @ V0v_2E0 ) ) ) ) )).
