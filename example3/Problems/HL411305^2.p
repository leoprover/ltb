...
thf(conj_thm_2Ereal__topology_2EOPEN__INTERVAL__RIGHT,lemma,(
...
thf(conj_thm_2Ereal__topology_2EOPEN__POSITIVE__ORTHANT,conjecture,
    ( p
    @ ( ap @ c_2Ereal__topology_2EOpen
      @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V0x: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V0x ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V0x ) ) ) ) ) )).
