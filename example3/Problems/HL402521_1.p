...
tff(f2923_0_2E0,type,(
    f2923_0_2E0: u )).

tff(f2923_0_2E2,type,(
    f2923_0_2E2: ( du * du ) > u )).
...
tff(arityeq2_2Ef2923_0_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f2923_0_2E2(s(A_27a,X0_2E0),s(A_27a,X1_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f2923_0_2E0),s(A_27a,X0_2E0))),s(A_27a,X1_2E0)))) )).
...
tff(def0_2Ethm_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS__EQ__2,axiom,(
    ! [A_27a: d,V1i_2E0: u,V0v_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f2923_0_2E2(s(A_27a,V1i_2E0),s(A_27a,V0v_2E0)))))
    <=> s(A_27a,V1i_2E0) = s(A_27a,V0v_2E0) ) )).

tff(thm_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS__EQ__2,conjecture,(
    ! [A_27a: d,V0v_2E0: u,V1i_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS_2E3(s(A_27a,V0v_2E0),s(A_27a,V1i_2E0),s(tyop_2Emin_2Ebool,f2923_0_2E2(s(A_27a,V1i_2E0),s(A_27a,V0v_2E0))))))) )).
