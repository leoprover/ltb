...
fof(conj_thm_2Ereal__topology_2ECOMPACT__REAL__LEMMA,lemma,(
    ! [V0s] :
                         ...
                         => ? [V8N] :
                              ...
                              & ! [V9n] :
                                 ...
                                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V8N),V9n))
                                   => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0s,ap(V4r,V9n))),V3l))),V7e)) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECOMPACT__LEMMA,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
