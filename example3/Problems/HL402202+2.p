...
fof(conj_thm_2Epred__set_2EREST__PSUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Epred__set_2ECARD__PSUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(lamtp_f419,axiom,(
    ! [A_27a,A_27a] : mem(f419(A_27a,A_27a),arr(arr(arr(A_27a,bool),arr(arr(A_27a,bool),bool)),bool)) )).
...
fof(lamtp_f422,axiom,(
    ! [A_27a,A_27a,V2SET__TO__LIST] :
...
fof(lamtp_f421,axiom,(
    ! [A_27a,A_27a,A_27a] : mem(f421(A_27a,A_27a,A_27a),arr(arr(arr(A_27a,bool),ty_2Elist_2Elist(A_27a)),arr(arr(A_27a,bool),ty_2Elist_2Elist(A_27a)))) )).

fof(lameq_f421,axiom,(
    ! [A_27a,A_27a,A_27a,V2SET__TO__LIST] :
      ( mem(V2SET__TO__LIST,arr(arr(A_27a,bool),ty_2Elist_2Elist(A_27a)))
...
fof(ax_thm_2Elist_2ESET__TO__LIST__primitive__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Elist_2ESET__TO__LIST(A_27a) = ap(ap(c_2Erelation_2EWFREC(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emin_2E_40(arr(arr(A_27a,bool),arr(arr(A_27a,bool),bool))),f419(A_27a,A_27a))),f421(A_27a,A_27a,A_27a)) ) )).

fof(conj_thm_2Elist_2ESET__TO__LIST__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
