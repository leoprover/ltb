...
tff(conj_thm_2EHolSmt_2Et025,conjecture,(
    ! [V0x: tp__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone,V1y: tp__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone] :
      ( surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) = surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(ap(c_2Ewords_2Eword__or(ty_2Eone_2Eone),ap(c_2Ewords_2Eword__1comp(ty_2Eone_2Eone),inj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V0x))),ap(c_2Ewords_2Eword__1comp(ty_2Eone_2Eone),inj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V1y))))
      | ~ ( ~ p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),inj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V0x)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
          | ~ p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),inj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V1y)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).
