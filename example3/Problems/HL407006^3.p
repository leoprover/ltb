...
thf(thm_2Einteger__word_2EINT__ZERO__LT__INT__MIN,axiom,(
    ! [A_27a: $tType] :
      ( c_2Einteger_2Eint__lt @ ( c_2Einteger__word_2EINT__MIN @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) ) )).
...
thf(thm_2Einteger__word_2Eword__msb__i2w__lt__0,conjecture,(
    ! [A_27a: $tType,V0i: tyop_2Einteger_2Eint] :
     ...
     => ( ( c_2Ewords_2Eword__msb @ A_27a @ ( c_2Einteger__word_2Ei2w @ A_27a @ V0i ) )
        = ( c_2Einteger_2Eint__lt @ V0i @ ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) ) ) ) )).
