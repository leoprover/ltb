...
thf(thm_2Ereal__topology_2ECOMPACT__LEMMA,conjecture,(
    ! [A_27a: d,V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Ebounded__def @ V1s )
        & ! [V2n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V0x @ V2n ) @ V1s ) )
     => ? [V3l: mono_2Etyop_2Erealax_2Ereal,V4r: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
          ( ! [V5m: mono_2Etyop_2Enum_2Enum,V6n: mono_2Etyop_2Enum_2Enum] :
              ( ( mono_2Ec_2Eprim__rec_2E_3C @ V5m @ V6n )
             => ( mono_2Ec_2Eprim__rec_2E_3C @ ( V4r @ V5m ) @ ( V4r @ V6n ) ) )
          & ! [V7e: mono_2Etyop_2Erealax_2Ereal] :
              ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V7e )
             => ? [V8N: mono_2Etyop_2Enum_2Enum] :
                ! [V9n: mono_2Etyop_2Enum_2Enum,V10i_2E0: u] :
                  ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V8N @ V9n )
                 => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0x @ ( V4r @ V9n ) ) @ V3l ) ) @ V7e ) ) ) ) ) )).
