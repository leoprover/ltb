...
thf(thm_2Eenumeral_2Esdiff__ind,conjecture,(
    ! [A_27a: $tType,V0P: ( tyop_2Etoto_2Etoto @ A_27a ) > ( tyop_2Elist_2Elist @ A_27a ) > ( tyop_2Elist_2Elist @ A_27a ) > $o] :
      ( ( ! [V1cmp: tyop_2Etoto_2Etoto @ A_27a] :
            ( V0P @ V1cmp @ ( c_2Elist_2ENIL @ A_27a ) @ ( c_2Elist_2ENIL @ A_27a ) )
        & ! [V2cmp: tyop_2Etoto_2Etoto @ A_27a,V3x: A_27a,V4l: tyop_2Elist_2Elist @ A_27a] :
            ( V0P @ V2cmp @ ( c_2Elist_2ECONS @ A_27a @ V3x @ V4l ) @ ( c_2Elist_2ENIL @ A_27a ) )
        & ! [V5cmp: tyop_2Etoto_2Etoto @ A_27a,V6y: A_27a,V7m: tyop_2Elist_2Elist @ A_27a] :
            ( V0P @ V5cmp @ ( c_2Elist_2ENIL @ A_27a ) @ ( c_2Elist_2ECONS @ A_27a @ V6y @ V7m ) )
        & ! [V8cmp: tyop_2Etoto_2Etoto @ A_27a,V9x: A_27a,V10l: tyop_2Elist_2Elist @ A_27a,V11y: A_27a,V12m: tyop_2Elist_2Elist @ A_27a] :
            ( ( ( ( ( c_2Etoto_2Eapto @ A_27a @ V8cmp @ V9x @ V11y )
                  = c_2EternaryComparisons_2EEQUAL )
               => ( V0P @ V8cmp @ V10l @ V12m ) )
              & ( ( ( c_2Etoto_2Eapto @ A_27a @ V8cmp @ V9x @ V11y )
                  = c_2EternaryComparisons_2EGREATER )
               => ( V0P @ V8cmp @ ( c_2Elist_2ECONS @ A_27a @ V9x @ V10l ) @ V12m ) )
              & ( ( ( c_2Etoto_2Eapto @ A_27a @ V8cmp @ V9x @ V11y )
                  = c_2EternaryComparisons_2ELESS )
               => ( V0P @ V8cmp @ V10l @ ( c_2Elist_2ECONS @ A_27a @ V11y @ V12m ) ) ) )
           => ( V0P @ V8cmp @ ( c_2Elist_2ECONS @ A_27a @ V9x @ V10l ) @ ( c_2Elist_2ECONS @ A_27a @ V11y @ V12m ) ) ) )
     => ! [V13v: tyop_2Etoto_2Etoto @ A_27a,V14v1: tyop_2Elist_2Elist @ A_27a,V15v2: tyop_2Elist_2Elist @ A_27a] :
