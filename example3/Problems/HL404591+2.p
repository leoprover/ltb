...
fof(conj_thm_2Epred__set_2EFORALL__IN__BIGUNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2ECOUNTABLE__CROSS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2ECOUNTABLE__AS__IMAGE__SUBSET__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2ECOUNTABLE__BIGUNION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0A] :
