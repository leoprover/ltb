...
fof(lamtp_f813,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f813(V0n),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).

fof(lameq_f813,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V2n_27] :
          ( mem(V2n_27,ty_2Enum_2Enum)
         => ap(f813(V0n),V2n_27) = ap(ap(c_2Earithmetic_2E_2B,V2n_27),V0n) ) ) )).

fof(conj_thm_2Erich__list_2ECOUNT__LIST__ADD,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ap(c_2Erich__list_2ECOUNT__LIST,ap(ap(c_2Earithmetic_2E_2B,V0n),V1m)) = ap(ap(c_2Elist_2EAPPEND(ty_2Enum_2Enum),ap(c_2Erich__list_2ECOUNT__LIST,V0n)),ap(ap(c_2Elist_2EMAP(ty_2Enum_2Enum,ty_2Enum_2Enum),f813(V0n)),ap(c_2Erich__list_2ECOUNT__LIST,V1m))) ) ) )).
