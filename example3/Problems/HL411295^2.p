...
thf(conj_thm_2Ereal__topology_2ECLOSED__STANDARD__HYPERPLANE,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ...
      @ ( ap @ c_2Ereal__topology_2EClosed
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V1x ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ V1x ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) ) ) ) )).
