...
fof(conj_thm_2Epred__set_2EDELETE__EQ__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Eiterate_2EFINREC__1__LEMMA,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1b] :
                 ...
                 => ! [V2s] :
                     ...
                     => ! [V3a] :
                          ( mem(V3a,A_27b)
                         => ( p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V0f),V1b),V2s),V3a),ap(c_2Enum_2ESUC,c_2Enum_2E0)))
                          <=> ? [V4x] :
                                ( mem(V4x,A_27a)
