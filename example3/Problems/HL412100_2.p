...
tff(conj_thm_2Eprobability_2EPROB__INCREASING__UNION,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2f: $i] :
             ...
             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                  ...
                  & ! [V3n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(V2f,inj__ty_2Enum_2Enum(V3n))),ap(V2f,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n)))))
                  & V1s = ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) )
               => p(ap(ap(c_2Eseq_2E_2D_2D_3E,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Eprobability_2Eprob(A_27a),V0p)),V2f)),ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s))) ) ) ) ) )).
