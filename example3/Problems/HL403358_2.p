...
tff(conj_thm_2Ebag_2EBAG__GEN__SUM__TAILREC,conjecture,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(ty_2Enum_2Enum),V0b))
       => ! [V1x: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__SUM,ap(ap(c_2Ebag_2EBAG__INSERT(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1x)),V0b)),inj__ty_2Enum_2Enum(V2a))) = surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__SUM,V0b),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1x)),inj__ty_2Enum_2Enum(V2a)))) ) ) )).
