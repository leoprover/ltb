...
tff(lmtp_f911,type,(
    f911: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f911,axiom,(
    ! [V2t1: tp__ty_2Enum_2Enum,V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => mem(f911(V2t1,V0b),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f911,axiom,(
    ! [V2t1: tp__ty_2Enum_2Enum,V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V3t2: tp__ty_2Enum_2Enum] : ap(f911(V2t1,V0b),inj__ty_2Enum_2Enum(V3t2)) = ap(V0b,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V3t2)),inj__ty_2Enum_2Enum(V2t1))) ) )).

tff(lmtp_f910,type,(
    f910: $i > $i )).

tff(lamtp_f910,axiom,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => mem(f910(V0b),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f910,axiom,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V2t1: tp__ty_2Enum_2Enum] : ap(f910(V0b),inj__ty_2Enum_2Enum(V2t1)) = ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f911(V2t1,V0b)) ) )).

tff(lmtp_f912,type,(
    f912: ( $i * $i ) > $i )).

tff(lamtp_f912,axiom,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a: $i] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
         => mem(f912(V0b,V1a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f912,axiom,(
    ! [V0b: $i] :
     ...
     => ! [V1a: $i] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
         => ! [V4t0: tp__ty_2Enum_2Enum] : ap(f912(V0b,V1a),inj__ty_2Enum_2Enum(V4t0)) = ap(ap(c_2Emin_2E_3D(bool),ap(ap(ap(c_2ETemporal__Logic_2EWHEN,V1a),V0b),inj__ty_2Enum_2Enum(V4t0))),ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V1a),V0b),inj__ty_2Enum_2Enum(V4t0))) ) ) )).

tff(lmtp_f914,type,(
    f914: ( tp__ty_2Enum_2Enum * $i * $i ) > $i )).

tff(lamtp_f914,axiom,(
    ! [V5t1: tp__ty_2Enum_2Enum,V1a: $i] :
      ( mem(V1a,arr(ty_2Enum_2Enum,bool))
     => ! [V0b: $i] :
          ( mem(V0b,arr(ty_2Enum_2Enum,bool))
         => mem(f914(V5t1,V1a,V0b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f913,axiom,(
    ! [V0b: $i] :
     ...
     => ! [V1a: $i] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
         => ! [V5t1: tp__ty_2Enum_2Enum] : ap(f913(V0b,V1a),inj__ty_2Enum_2Enum(V5t1)) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f914(V5t1,V1a,V0b)) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EWHEN__SWHEN__LEMMA,conjecture,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a: $i] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
         => p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f910(V0b))),ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f912(V0b,V1a))),ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f913(V0b,V1a)))) ) ) )).
