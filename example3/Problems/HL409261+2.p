...
fof(conj_thm_2Ereal_2EREAL__NEG__THIRD,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eintegral_2EREAL__ARCH__POW2,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ? [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Eintegral_2EREAL__POW__MONO,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ! [V2x] :
             ...
             => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2x))
                  & p(ap(ap(c_2Earithmetic_2E_3C_3D,V0m),V1n)) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Ereal_2Epow,V2x),V0m)),ap(ap(c_2Ereal_2Epow,V2x),V1n))) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EREAL__LE__INV2,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eintegral_2ERSUM__DIFF__BOUND,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eintegral_2EINTEGRABLE__LIMIT,conjecture,(
    ! [V0f] :
