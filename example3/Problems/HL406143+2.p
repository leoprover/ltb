...
fof(lameq_f2248,axiom,(
    ! [A_27a,V0w] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
         => ap(f2248(A_27a,V0w),V1i) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(c_2Ewords_2Eword__msb(A_27a),V0w))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),V1i))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ewords_2Eword__msb(A_27a),V0w)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(c_2Ewords_2Eword__2comp(A_27a),V0w)),V1i))) ) ) )).

fof(conj_thm_2Ewords_2Eword__abs,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
