...
tff(conj_thm_2Ecomparison_2Epair__cmp__cong,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0cmp1: $i] :
     ...
     => ! [V1cmp2: $i] :
         ...
         => ! [V2v1: $i] :
             ...
             => ! [V3v2: $i] :
                  ( mem(V3v2,ty_2Epair_2Eprod(A_27b,A_27b))
                 => ! [V4cmp1_27: $i] :
                     ...
                     => ! [V5cmp2_27: $i] :
                         ...
                         => ! [V6v1_27: $i] :
                             ...
                             => ! [V7v2_27: $i] :
                                  ( mem(V7v2_27,ty_2Epair_2Eprod(A_27b,A_27b))
                                 => ( ( V2v1 = V6v1_27
                                      & V3v2 = V7v2_27
                                      & ! [V8a: $i] :
                                          ( mem(V8a,A_27a)
                                             ...
                                             => ! [V10c: $i] :
                                                 ...
                                                 => ! [V11d: $i] :
                                                     ...
                                                     => ( ( V6v1_27 = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V8a),V9b)
                                                          & V7v2_27 = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V10c),V11d) )
                                             ...
                                             => ! [V14c: $i] :
                                                 ...
                                                 => ! [V15d: $i] :
                                                     ...
                                                     => ( ( V6v1_27 = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V12a),V13b)
                                                          & V7v2_27 = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V14c),V15d) )
                                   ...
                                   => surj__ty_2EternaryComparisons_2Eordering(ap(ap(ap(ap(c_2EternaryComparisons_2Epair__compare(A_27a,A_27a,A_27a,A_27a),V0cmp1),V1cmp2),V2v1),V3v2)) = surj__ty_2EternaryComparisons_2Eordering(ap(ap(ap(ap(c_2EternaryComparisons_2Epair__compare(A_27a,A_27a,A_27a,A_27a),V4cmp1_27),V5cmp2_27),V6v1_27),V7v2_27)) ) ) ) ) ) ) ) ) ) )).
