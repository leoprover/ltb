...
thf(c_2Efcp_2EFCP__HD_2E0,type,(
    c_2Efcp_2EFCP__HD_2E0: u )).

thf(c_2Efcp_2EFCP__HD_2E1,type,(
    c_2Efcp_2EFCP__HD_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ec_2Efcp_2EFCP__HD_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ A_27a @ ( c_2Efcp_2EFCP__HD_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ A_27a ) @ c_2Efcp_2EFCP__HD_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Efcp_2EFCP__HD__def,axiom,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u] :
      ( ( s @ A_27a @ ( c_2Efcp_2EFCP__HD_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0v_2E0 ) ) )
      = ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0v_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) ) )).
...
thf(thm_2Efcp_2EFCP__HD,conjecture,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u] :
      ( ( s @ A_27a @ ( c_2Efcp_2EFCP__HD_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0v_2E0 ) ) )
      = ( s @ A_27a @ ( c_2Elist_2EHD_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Efcp_2EV2L_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0v_2E0 ) ) ) ) ) ) )).
