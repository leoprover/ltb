...
thf(c_2Emachine__ieee_2Efp16__roundToIntegral,type,(
    c_2Emachine__ieee_2Efp16__roundToIntegral: tyop_2Ebinary__ieee_2Erounding > ( tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) > ( tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) )).
...
thf(thm_2Emachine__ieee_2Efp16__roundToIntegral,conjecture,
    ( ! [V0mode: tyop_2Ebinary__ieee_2Erounding,V1a: tyop_2Ebinary__ieee_2Efloat @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) )] :
        ( ( c_2Emachine__ieee_2Efp16__roundToIntegral @ V0mode @ ( c_2Emachine__ieee_2Efloat__to__fp16 @ V1a ) )
        = ( c_2Emachine__ieee_2Efloat__to__fp16 @ ( c_2Ebinary__ieee_2Efloat__round__to__integral @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) @ V0mode @ V1a ) ) )
    & ! [V2mode: tyop_2Ebinary__ieee_2Erounding,V3a: tyop_2Enum_2Enum] :
        ( ( c_2Emachine__ieee_2Efp16__roundToIntegral @ V2mode @ ( c_2Ewords_2En2w @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) @ V3a ) )
        = ( c_2Emachine__ieee_2Efloat__to__fp16 @ ( c_2Ebinary__ieee_2Efloat__round__to__integral @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) @ V2mode @ ( c_2Emachine__ieee_2Efp16__to__float @ ( c_2Ewords_2En2w @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) @ V3a ) ) ) ) ) )).
