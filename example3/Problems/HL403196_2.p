...
tff(conj_thm_2EreaderMonad_2EBIND__UNITL,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0x: $i] :
      ( mem(V0x,A_27c)
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27c,arr(A_27a,A_27b)))
         => ap(ap(c_2EreaderMonad_2EBIND(A_27c,A_27c,A_27c),ap(c_2EreaderMonad_2EUNIT(A_27c,A_27c),V0x)),V1f) = ap(V1f,V0x) ) ) )).
