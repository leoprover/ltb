...
tff(lamtp_f3735,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V0net: $i] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
         => mem(f3735(A_27a,V1f,V0net),arr(ty_2Erealax_2Ereal,bool)) ) ) )).

tff(lameq_f3735,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V0net: $i] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
         => ! [V2l: tp__ty_2Erealax_2Ereal] : ap(f3735(A_27a,V1f,V0net),inj__ty_2Erealax_2Ereal(V2l)) = ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),inj__ty_2Erealax_2Ereal(V2l)),V0net) ) ) )).
...
tff(ax_thm_2Ereal__topology_2Elim__def,axiom,(
    ! [A_27a: del,V0net: $i] :
     ...
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Elim__def(A_27a),V0net),V1f)) = surj__ty_2Erealax_2Ereal(ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f3735(A_27a,V1f,V0net))) ) ) )).
...
tff(lamtp_f4011,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Enum_2Enum,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f4011(V1s,V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f4011,axiom,(
    ! [V1s: $i] :
     ...
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2n: tp__ty_2Enum_2Enum] : ap(f4011(V1s,V0f),inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V2n)))),V0f) ) ) )).

tff(conj_thm_2Ereal__topology_2ESUMS__LIM,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(ap(c_2Ereal__topology_2Elim__def(ty_2Enum_2Enum),c_2Ereal__topology_2Esequentially),f4011(V1s,V0f))),V1s))
