...
tff(conj_thm_2Eextreal_2Eadd__ldistrib__normal,lemma,(
...
tff(conj_thm_2Eextreal_2Eadd__ldistrib__normal2,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Eextreal_2Eextreal,V2z: tp__ty_2Eextreal_2Eextreal] :
...
tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__NOT__INFTY,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__CMUL2,conjecture,(
    ! [A_27a: del,V0s: $i] :
