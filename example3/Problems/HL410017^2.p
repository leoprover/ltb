...
thf(conj_thm_2Eproduct_2EREAL__ADD__AC,conjecture,(
    ! [V0m: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Erealax_2Ereal,V2p: tp__ty_2Erealax_2Ereal] :
      ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) @ ( inj__ty_2Erealax_2Ereal @ V1n ) ) )
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V1n ) ) @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) ) )
      & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) @ ( inj__ty_2Erealax_2Ereal @ V1n ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2p ) ) )
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V1n ) ) @ ( inj__ty_2Erealax_2Ereal @ V2p ) ) ) ) )
      & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V1n ) ) @ ( inj__ty_2Erealax_2Ereal @ V2p ) ) ) )
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V1n ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) @ ( inj__ty_2Erealax_2Ereal @ V2p ) ) ) ) ) ) )).
