...
tff(conj_thm_2Ewords_2Eword__msb__add__word__L,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Ewords_2EWORD__SUM__ZERO,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
...
tff(conj_thm_2Ewords_2Ew2n__add,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Einteger__word_2Ew2i__neg,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Einteger__word_2Esub__overflow,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Efcp_2Ecart(bool,bool))
