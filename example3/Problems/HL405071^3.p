     ...
     => ( ? [V6i: tyop_2Enum_2Enum > A_27a,V7q: tyop_2Enum_2Enum > A_27state] :
      ...
      <=> ? [V11x0: tyop_2Enum_2Enum,V12l: tyop_2Enum_2Enum,V13j: tyop_2Enum_2Enum > A_27a,V14p: tyop_2Enum_2Enum > A_27state] :
            ...
            & ! [V15t: tyop_2Enum_2Enum] :
                ( ( c_2Eprim__rec_2E_3C @ V15t @ ( c_2Earithmetic_2E_2B @ V11x0 @ V12l ) )
               => ( V0TransRel @ ( c_2Epair_2E_2C @ A_27a @ ( tyop_2Epair_2Eprod @ A_27state @ A_27state ) @ ( V13j @ V15t ) @ ( c_2Epair_2E_2C @ A_27state @ A_27state @ ( V14p @ V15t ) @ ( V14p @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
            & ? [V16t: tyop_2Enum_2Enum] :
                ( ( c_2Eprim__rec_2E_3C @ V16t @ V12l )
                & ( V2Accept @ ( V14p @ ( c_2Earithmetic_2E_2B @ V11x0 @ V16t ) ) ) )
            & ( ( V14p @ V11x0 )
              = ( V14p @ ( c_2Earithmetic_2E_2B @ V11x0 @ V12l ) ) ) ) ) ) )).
