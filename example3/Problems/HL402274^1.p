...
thf(f2459_0_2E0,type,(
    f2459_0_2E0: u )).

thf(f2459_0_2E1,type,(
    f2459_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef2459_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( f2459_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ f2459_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Elist_2ELIST__BIND_2E2_2Emono_2EA_27a_20mono_2Etyop_2Elist_2Elist_28A_27a_29,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELIST__BIND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) ) )
...
thf(def0_2Ethm_2Elist_2ELIST__BIND__ID,axiom,(
    ! [A_27a: d,V1x_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( f2459_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1x_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1x_2E0 ) ) )).

thf(thm_2Elist_2ELIST__BIND__ID,conjecture,(
    ! [A_27a: d,V0l_2E0: u] :
      ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELIST__BIND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0l_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ f2459_0_2E0 ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFLAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0l_2E0 ) ) ) )
      & ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELIST__BIND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0l_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ c_2Ecombin_2EI_2E0 ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFLAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0l_2E0 ) ) ) ) ) )).
