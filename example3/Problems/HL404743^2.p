...
thf(conj_thm_2Efinite__map_2EFEVERY__FUPDATE,lemma,(
...
thf(conj_thm_2Epred__set_2ECOMPL__UNION,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Efinite__map_2EFEVERY__FUPDATE__LIST,conjecture,(
