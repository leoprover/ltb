...
fof(conj_thm_2Ereal__topology_2EREAL__WLOG__LE,lemma,(
    ! [V0P] :
...
fof(lamtp_f3703,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => mem(f3703(V0a,V1b),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

fof(lameq_f3703,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ! [V2u] :
             ...
             => ap(f3703(V0a,V1b),V2u) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2u)),V0a)),ap(ap(c_2Erealax_2Ereal__mul,V2u),V1b))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2u)),ap(ap(c_2Erealax_2Ereal__lt,V2u),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EOPEN__SEGMENT__ALT,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ( V0a != V1b
           => ap(c_2Ereal__topology_2Eopen__segment,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3703(V0a,V1b)) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ESEGMENT__REFL,lemma,
    ( ! [V0a] :
        ( mem(V0a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__REAL__LEMMA,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__SEGMENT,conjecture,
    ( ! [V0a] :
        ( mem(V0a,ty_2Erealax_2Ereal)
       => ! [V1b] :
            ( mem(V1b,ty_2Erealax_2Ereal)
