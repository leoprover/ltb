...
tff(lamtp_f967,axiom,(
    ! [A_27a: del,V2e: $i] :
      ( mem(V2e,A_27a)
     => ! [V0b0: $i] :
          ( mem(V0b0,arr(A_27a,ty_2Enum_2Enum))
         => mem(f967(A_27a,V2e,V0b0),arr(A_27a,ty_2Enum_2Enum)) ) ) )).

tff(lameq_f967,axiom,(
    ! [A_27a: del,V2e: $i] :
      ( mem(V2e,A_27a)
     => ! [V0b0: $i] :
          ( mem(V0b0,arr(A_27a,ty_2Enum_2Enum))
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f967(A_27a,V2e,V0b0),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(A_27a),V3x),V2e)),ap(ap(c_2Earithmetic_2E_2D,ap(V0b0,V2e)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(V0b0,V3x)) ) ) ) )).

tff(conj_thm_2Ebag_2EBAG__DELETE__concrete,conjecture,(
    ! [A_27a: del,V0b0: $i] :
      ( mem(V0b0,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
         => ! [V2e: $i] :
             ...
             => ( p(ap(ap(ap(c_2Ebag_2EBAG__DELETE(A_27a),V0b0),V2e),V1b))
              <=> ( p(ap(ap(c_2Earithmetic_2E_3E,ap(V0b0,V2e)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
                  & V1b = f967(A_27a,V2e,V0b0) ) ) ) ) ) )).
