...
fof(conj_thm_2EHolSmt_2Er084,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
         => ! [V2z] :
              ( mem(V2z,ty_2Einteger_2Eint)
             => ap(ap(c_2Einteger_2Eint__add,ap(ap(c_2Einteger_2Eint__add,V0x),V1y)),V2z) = ap(ap(c_2Einteger_2Eint__add,V0x),ap(ap(c_2Einteger_2Eint__add,V2z),V1y)) ) ) ) )).
