...
tff(f4293_0_2E0,type,(
    f4293_0_2E0: u )).

tff(f4293_0_2E2,type,(
    f4293_0_2E2: ( du * du ) > u )).

tff(f4293_1_2E0,type,(
    f4293_1_2E0: u )).

tff(f4293_1_2E1,type,(
    f4293_1_2E1: du > u )).

tff(f4293_1_2E2,type,(
    f4293_1_2E2: ( du * du ) > u )).
...
tff(arityeq2_2Ef4293_0_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f4293_0_2E2(s(tyop_2Elist_2Elist(A_27a),X0_2E0),s(tyop_2Ellist_2Ellist(A_27a),X1_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool)),f4293_0_2E0),s(tyop_2Elist_2Elist(A_27a),X0_2E0))),s(tyop_2Ellist_2Ellist(A_27a),X1_2E0)))) )).

tff(arityeq1_2Ef4293_1_2E1,axiom,(
    ! [A_27a: d,X0_2E0: u] : s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool),f4293_1_2E1(s(tyop_2Elist_2Elist(A_27a),X0_2E0))) = s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool)),f4293_1_2E0),s(tyop_2Elist_2Elist(A_27a),X0_2E0))) )).

tff(arityeq2_2Ef4293_1_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f4293_1_2E2(s(tyop_2Elist_2Elist(A_27a),X0_2E0),s(tyop_2Elist_2Elist(A_27a),X1_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool)),f4293_1_2E0),s(tyop_2Elist_2Elist(A_27a),X0_2E0))),s(tyop_2Elist_2Elist(A_27a),X1_2E0)))) )).
...
tff(def0_2Ethm_2Ellist_2ELPREFIX__fromList,axiom,(
    ! [A_27a: d,V0l_2E0: u,V1ll_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f4293_0_2E2(s(tyop_2Elist_2Elist(A_27a),V0l_2E0),s(tyop_2Ellist_2Ellist(A_27a),V1ll_2E0)))))
...
tff(def1_2Ethm_2Ellist_2ELPREFIX__fromList,axiom,(
    ! [A_27a: d,V0l_2E0: u,V2ys_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f4293_1_2E2(s(tyop_2Elist_2Elist(A_27a),V0l_2E0),s(tyop_2Elist_2Elist(A_27a),V2ys_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elist_2EisPREFIX_2E2(s(tyop_2Elist_2Elist(A_27a),V0l_2E0),s(tyop_2Elist_2Elist(A_27a),V2ys_2E0)))) )).

tff(thm_2Ellist_2ELPREFIX__fromList,conjecture,(
    ! [A_27a: d,V0l_2E0: u,V1ll_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ellist_2ELPREFIX_2E2(s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2EfromList_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0))),s(tyop_2Ellist_2Ellist(A_27a),V1ll_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Eoption_2Eoption__CASE_2E3(s(tyop_2Eoption_2Eoption(tyop_2Elist_2Elist(A_27a)),c_2Ellist_2EtoList_2E1(s(tyop_2Ellist_2Ellist(A_27a),V1ll_2E0))),s(tyop_2Emin_2Ebool,f4293_0_2E2(s(tyop_2Elist_2Elist(A_27a),V0l_2E0),s(tyop_2Ellist_2Ellist(A_27a),V1ll_2E0))),s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool),f4293_1_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0)))))) )).
