...
thf(conj_thm_2EOmega__Automata_2EBOREL__HIERARCHY__G,conjecture,(
    ! [V0a: $i] :
     ...
     => ! [V1t0: tp__ty_2Enum_2Enum] :
          ...
          <=> ? [V3q: $i] :
                ...
                & ? [V5t: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V3q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V5t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) )
          & ( ! [V6t: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ V0a @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V6t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) )
          <=> ? [V7q: $i] :
                ...
                & ? [V9t1: tp__ty_2Enum_2Enum] :
                  ! [V10t2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V7q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V9t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V10t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) ) )
          ...
          <=> ? [V12q: $i] :
                ...
                & ! [V14t1: tp__ty_2Enum_2Enum] :
                  ? [V15t2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V12q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V14t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V15t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) ) ) ) ) )).
