...
thf(thm_2Ereal__topology_2EBIGINTER__GSPEC,conjecture,(
          ...
          = ( c_2Epred__set_2EGSPEC @ A_27b @ A_27b
            @ ^ [V3a: A_27b] :
                ...
                @ ( c_2Ebool_2E_21 @ A_27a
                  @ ^ [V4x: A_27a] :
                      ( c_2Emin_2E_3D_3D_3E @ ( V0P @ V4x ) @ ( c_2Ebool_2EIN @ A_27b @ V3a @ ( V1f @ V4x ) ) ) ) ) ) )
            ...
            @ ^ [V9a: A_27e] :
                ...
                @ ( c_2Ebool_2E_21 @ A_27c
                  @ ^ [V10x: A_27c] :
                      ...
                      @ ^ [V11y: A_27d] :
                          ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V10x @ V11y ) @ ( c_2Ebool_2EIN @ A_27e @ V9a @ ( V6f @ V10x @ V11y ) ) ) ) ) ) ) )
                ...
                @ ( c_2Ebool_2E_21 @ A_27f
                  @ ^ [V18x: A_27f] :
                      ...
                      @ ^ [V19y: A_27g] :
                          ...
                          @ ^ [V20z: A_27h] :
                              ( c_2Emin_2E_3D_3D_3E @ ( V12P @ V18x @ V19y @ V20z ) @ ( c_2Ebool_2EIN @ A_27i @ V17a @ ( V13f @ V18x @ V19y @ V20z ) ) ) ) ) ) ) ) ) ) )).
