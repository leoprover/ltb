...
fof(conj_thm_2Erich__list_2EELL__MEM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => p(ap(ap(c_2Ebool_2EIN(A_27a),ap(ap(c_2Erich__list_2EELL(A_27a),V0n),V1l)),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1l))) ) ) ) ) )).
