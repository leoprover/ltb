...
tff(conj_thm_2Epath_2Eel__def__compute,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0p: $i] :
          ( mem(V0p,ty_2Epath_2Epath(A_27a,A_27a))
         => ap(ap(c_2Epath_2Eel(A_27a,A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V0p) = ap(c_2Epath_2Efirst(A_27a,A_27a),V0p) )
      ...
      & ! [V3n: tp__ty_2Enum_2Enum,V4p: $i] :
         ...
         => ap(ap(c_2Epath_2Eel(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(V3n)))),V4p) = ap(ap(c_2Epath_2Eel(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(V3n)))),ap(c_2Epath_2Etail(A_27a,A_27a),V4p)) ) ) )).
