...
tff(lameq_f958,axiom,(
    ! [V1a: $i] :
     ...
     => ! [V0y: $i] :
          ( mem(V0y,arr(ty_2Enum_2Enum,bool))
         => ! [V2t: tp__ty_2Enum_2Enum] : ap(f958(V1a,V0y),inj__ty_2Enum_2Enum(V2t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1a,inj__ty_2Enum_2Enum(V2t))),ap(V0y,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2t)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EEVENTUAL__FIX,conjecture,(
    ! [V0y: $i] :
      ( mem(V0y,arr(ty_2Enum_2Enum,bool))
     => ! [V1a: $i] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
