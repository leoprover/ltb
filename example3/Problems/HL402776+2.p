...
fof(conj_thm_2Erich__list_2ESUM__FLAT,conjecture,(
    ! [V0l] :
      ( mem(V0l,ty_2Elist_2Elist(ty_2Elist_2Elist(ty_2Enum_2Enum)))
     => ap(c_2Elist_2ESUM,ap(c_2Elist_2EFLAT(ty_2Enum_2Enum),V0l)) = ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(ty_2Elist_2Elist(ty_2Enum_2Enum),ty_2Elist_2Elist(ty_2Enum_2Enum)),c_2Elist_2ESUM),V0l)) ) )).
