...
tff(thm_2Ebool_2ERES__ABSTRACT__DEF,axiom,(
    ! [A_27a: d,A_27b: d] :
      ...
      & ! [V3p_2E0: u,V4m1_2E0: u,V5m2_2E0: u] :
          ( ! [V6x_2E0: u] :
              ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,V6x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V3p_2E0)))))
...
tff(thm_2Eres__quan_2ERES__ABSTRACT__EQUAL,conjecture,(
