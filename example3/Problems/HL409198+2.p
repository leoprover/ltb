...
fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__SUB,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V1f] :
             ...
             => ! [V2f_27] :
                  ( mem(V2f_27,arr(A_27a,ty_2Erealax_2Ereal))
                 => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                   => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3190(A_27a,V1f,V2f_27)),V0s) = ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V1f),V0s)),ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V2f_27),V0s)) ) ) ) ) ) )).
