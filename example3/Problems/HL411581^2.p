...
thf(conj_thm_2Ereal__topology_2EINTERVAL__SUBSET__IS__INTERVAL,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EINTERVAL__CONTAINS__COMPACT__NEIGHBOURHOOD,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
