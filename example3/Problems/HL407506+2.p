...
fof(conj_thm_2Ereal_2EREAL__MUL__SUB1__CANCEL,conjecture,(
    ! [V0z] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
             ...
             => ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2y),V1x)),ap(ap(c_2Erealax_2Ereal__mul,V2y),ap(ap(c_2Ereal_2Ereal__sub,V0z),V1x))) = ap(ap(c_2Erealax_2Ereal__mul,V2y),V0z) ) ) ) )).
