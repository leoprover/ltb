...
tff(ax_thm_2Earithmetic_2EMODEQ__DEF,axiom,(
    ...
    <=> ? [V3a: tp__ty_2Enum_2Enum,V4b: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V3a)),inj__ty_2Enum_2Enum(V0n))),inj__ty_2Enum_2Enum(V1m1))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V4b)),inj__ty_2Enum_2Enum(V0n))),inj__ty_2Enum_2Enum(V2m2))) ) )).

tff(conj_thm_2Earithmetic_2EMODEQ__0__CONG,conjecture,(
    ! [V0m1: tp__ty_2Enum_2Enum,V1m2: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(ap(c_2Earithmetic_2EMODEQ,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0m1)),inj__ty_2Enum_2Enum(V1m2)))
    <=> V0m1 = V1m2 ) )).
