...
fof(conj_thm_2Efloat_2EERROR__BOUND__NORM__STRONG,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Efloat_2EREAL__IN__BINADE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ( p(ap(c_2Efloat_2Enormalizes,V0x))
       => ? [V1j] :
...
fof(conj_thm_2Efloat_2EERROR__BOUND__NORM__STRONG__NORMALIZE,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ( p(ap(c_2Efloat_2Enormalizes,V0x))
       => ? [V1j] :
