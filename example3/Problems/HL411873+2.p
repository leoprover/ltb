...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__OPEN__PREIMAGE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EOPEN__HALFSPACE__COMPONENT__GT,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ESEPARATION__CLOSURES,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
