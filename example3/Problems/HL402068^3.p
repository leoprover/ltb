...
thf(c_2Eset__relation_2Enum__order,type,(
    c_2Eset__relation_2Enum__order: 
      !>[A_27a: $tType] :
        ( ( A_27a > tyop_2Enum_2Enum ) > ( A_27a > $o ) > ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) )).
...
thf(thm_2Eset__relation_2Enum__order__def,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1s: A_27a > $o] :
      ( ( c_2Eset__relation_2Enum__order @ A_27a @ V0f @ V1s )
      = ( c_2Epred__set_2EGSPEC @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a )
        @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ $o )
          @ ^ [V2x: A_27a,V3y: A_27a] :
              ( c_2Epair_2E_2C @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ $o @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V2x @ V3y ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V1s ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V3y @ V1s ) @ ( c_2Earithmetic_2E_3C_3D @ ( V0f @ V2x ) @ ( V0f @ V3y ) ) ) ) ) ) ) ) )).

thf(thm_2Eset__relation_2Elinear__order__num__order,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1s: A_27a > $o,V2t: tyop_2Enum_2Enum > $o] :
      ( ( c_2Epred__set_2EINJ @ A_27a @ tyop_2Enum_2Enum @ V0f @ V1s @ V2t )
     => ( c_2Eset__relation_2Elinear__order @ A_27a @ ( c_2Eset__relation_2Enum__order @ A_27a @ V0f @ V1s ) @ V1s ) ) )).
