...
tff(conj_thm_2Ereal__topology_2EOPEN__IMP__LOCALLY__COMPACT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EOpen,V0s))
       => p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__INTER,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__OPEN__IN,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
