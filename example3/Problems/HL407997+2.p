...
fof(conj_thm_2Ereal_2EREAL__LT__ADDL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2EPOW__PLUS1,lemma,(
    ! [V0e] :
...
fof(lameq_f2878,axiom,(
    ! [V0f] :
     ...
     => ! [V4n] :
          ( mem(V4n,ty_2Enum_2Enum)
         => ap(f2878(V0f),V4n) = ap(c_2Erealax_2Einv,ap(V0f,V4n)) ) ) )).

fof(conj_thm_2Eseq_2ESEQ__INV0,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( ! [V1y] :
            ( mem(V1y,ty_2Erealax_2Ereal)
       ...
       => p(ap(ap(c_2Eseq_2E_2D_2D_3E,f2878(V0f)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))) ) ) )).
...
fof(conj_thm_2Eseq_2ESEQ__POWER__ABS,conjecture,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
