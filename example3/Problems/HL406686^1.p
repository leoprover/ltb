...
thf(thm_2Eint__arith_2ECONJ__EQ__ELIM,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1v_2E0: u,V2e_2E0: u] :
      ( ( ( ( s @ A_27a @ V1v_2E0 )
          = ( s @ A_27a @ V2e_2E0 ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V1v_2E0 ) ) ) ) )
    <=> ( ( ( s @ A_27a @ V1v_2E0 )
          = ( s @ A_27a @ V2e_2E0 ) )
