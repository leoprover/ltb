    ...
    ! [A_27a,V0a] :
     ...
     => ! [V1x] :
         ...
         => ! [V4i] :
             ...
             => ap(f3608(A_27a,V0a,V1x),V4i) = ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),ap(V0a,V4i)),V1x) ) ) ) )).

fof(conj_thm_2Emeasure_2Eindicator__fn__suminf,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
         => ! [V1x] :
             ...
             => ( ! [V2m] :
                   ...
                   => ! [V3n] :
                       ...
                       => ( V2m != V3n
                         => p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V0a,V2m)),ap(V0a,V3n))) ) ) )
               => ap(c_2Eextreal_2Eext__suminf,f3608(A_27a,V0a,V1x)) = ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0a),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))),V1x) ) ) ) ) )).
