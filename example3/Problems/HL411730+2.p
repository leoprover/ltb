    ...
    ! [A_27a,V1f] :
     ...
     => ! [V0net] :
         ...
         => ! [V2l] :
             ...
             => ap(f3735(A_27a,V1f,V0net),V2l) = ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),V2l),V0net) ) ) ) )).
...
fof(ax_thm_2Ereal__topology_2Elim__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0net] :
         ...
         => ! [V1f] :
              ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
             => ap(ap(c_2Ereal__topology_2Elim__def(A_27a),V0net),V1f) = ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f3735(A_27a,V1f,V0net)) ) ) ) )).
    ...
    ! [V1s] :
     ...
     => ! [V0f] :
         ...
         => ! [V2n] :
             ...
             => ap(f4011(V1s,V0f),V2n) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V2n))),V0f) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUMS__LIM,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
