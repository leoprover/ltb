...
fof(conj_thm_2Estring_2ESTRCAT__EXPLODE,conjecture,(
    ! [V0s1] :
      ( mem(V0s1,ty_2Elist_2Elist(ty_2Estring_2Echar))
     => ! [V1s2] :
          ( mem(V1s2,ty_2Elist_2Elist(ty_2Estring_2Echar))
         => ap(ap(c_2Elist_2EAPPEND(ty_2Estring_2Echar),V0s1),V1s2) = ap(ap(ap(c_2Elist_2EFOLDR(ty_2Estring_2Echar,ty_2Estring_2Echar),c_2Elist_2ECONS(ty_2Estring_2Echar)),V1s2),ap(c_2Estring_2EEXPLODE,V0s1)) ) ) )).
