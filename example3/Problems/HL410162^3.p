...
thf(thm_2Emeasure_2ESIGMA__ALGEBRA__FN,conjecture,(
    ...
    <=> ( ( c_2Emeasure_2Esubset__class @ A_27a @ ( c_2Emeasure_2Espace @ A_27a @ V0a ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) )
        ...
        & ! [V2f: tyop_2Enum_2Enum > A_27a > $o] :
           ...
           => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V2f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) ) ) ) ) )).
