...
thf(thm_2Eres__quan_2ERES__EXISTS__EMPTY,axiom,(
    ! [A_27a: d,V0p_2E0: u] :
      ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2ERES__EXISTS_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EEMPTY_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0p_2E0 ) ) ) ) ) )).

thf(thm_2Eres__quan_2ERES__EXISTS__NOT__EMPTY,conjecture,(
