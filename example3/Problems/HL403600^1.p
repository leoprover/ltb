...
thf(thm_2Einftree_2Erelrec__cases,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0a0_2E0: u,V1a1_2E0: u,V2a2_2E0: u,V3a3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Einftree_2Erelrec_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0a0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ V1a1_2E0 ) @ ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ V2a2_2E0 ) @ ( s @ A_27b @ V3a3_2E0 ) ) ) )
    <=> ( ? [V4a_2E0: u] :
            ( ( ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ V2a2_2E0 )
              = ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( c_2Einftree_2EiLf_2E1 @ ( s @ A_27a @ V4a_2E0 ) ) ) )
            & ( ( s @ A_27b @ V3a3_2E0 )
              = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0a0_2E0 ) @ ( s @ A_27a @ V4a_2E0 ) ) ) ) )
        | ? [V5b_2E0: u,V6df_2E0: u,V7g_2E0: u] :
            ( ( ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ V2a2_2E0 )
              = ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( c_2Einftree_2EiNd_2E2 @ ( s @ A_27c @ V5b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ V6df_2E0 ) ) ) )
            & ( ( s @ A_27b @ V3a3_2E0 )
              = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ V1a1_2E0 ) @ ( s @ A_27c @ V5b_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ V7g_2E0 ) ) ) )
            & ! [V8d_2E0: u] :
