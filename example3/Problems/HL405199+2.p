...
fof(lameq_f2108,axiom,(
    ! [A_27a,A_27b,V0ls] :
     ...
     => ! [V1k] :
         ...
         => ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ap(f2108(A_27a,A_27b,V0ls,V1k),V2n) = ap(ap(c_2Emin_2E_3D(A_27a),ap(ap(c_2Elist_2EEL(A_27a),V2n),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0ls))),V1k) ) ) ) )).

fof(conj_thm_2Ealist_2EALOOKUP__LEAST__EL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ealist_2EALOOKUP__ALL__DISTINCT__MEM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
