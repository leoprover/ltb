...
thf(conj_thm_2Ereal__topology_2EALWAYS__EVENTUALLY,lemma,(
    ! [A_27a: del,V0p: $i] :
...
thf(conj_thm_2Ereal__topology_2EEVENTUALLY__MP,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1p: $i] :
          ( ( mem @ V1p @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ELIM__NULL__CMUL__BOUNDED,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
                  ...
                  ( ( ( p
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V4a: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V2g @ V4a ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V1f @ V4a ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3B ) ) ) ) )
                        @ V0net ) )
                    ...
                    @ ( ap
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V5n: $i] :
                                ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V1f @ V5n ) ) @ ( ap @ V2g @ V5n ) ) ) )
