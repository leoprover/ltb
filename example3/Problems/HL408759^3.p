...
thf(thm_2EHolSmt_2Er138,conjecture,(
    ...
    <=> ( ( c_2Erealax_2Ereal__add @ V2x @ ( c_2Erealax_2Ereal__add @ V1y @ ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__neg @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V3a ) @ V0z ) ) )
        = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )).
