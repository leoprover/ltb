...
thf(conj_thm_2Ellist_2ELNTH__LGENLIST,lemma,(
...
thf(conj_thm_2Ellist_2ELMAP__LGENLIST,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27b @ A_27a ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Enum_2Enum @ A_27b ) )
         => ! [V2limopt: tp__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum] :
              ( ( ap @ ( ap @ ( c_2Ellist_2ELMAP @ A_27b @ A_27a ) @ V0f ) @ ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27b ) @ V1g ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V2limopt ) ) )
              = ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ A_27a @ A_27b ) @ V0f ) @ V1g ) ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V2limopt ) ) ) ) ) )).
