...
tff(conj_thm_2Epred__set_2ECARD__SING__CROSS,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27b,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27b),V1P))
           => surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),ap(ap(c_2Epred__set_2EINSERT(A_27a),V0x),c_2Epred__set_2EEMPTY(A_27a))),V1P))) = surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27b),V1P)) ) ) ) )).

tff(conj_thm_2Epred__set_2ECARD__CROSS,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27b,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0P))
              & p(ap(c_2Epred__set_2EFINITE(A_27b),V1Q)) )
           => surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0P),V1Q))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2A,ap(c_2Epred__set_2ECARD(A_27a),V0P)),ap(c_2Epred__set_2ECARD(A_27b),V1Q))) ) ) ) )).
