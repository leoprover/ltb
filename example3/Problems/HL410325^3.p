...
thf(thm_2Ereal__topology_2EPOWERSET__CLAUSES,conjecture,(
    ! [A_27a: $tType,A_27b: $tType] :
      ( ( ( c_2Epred__set_2EGSPEC @ ( A_27b > $o ) @ ( A_27b > $o )
          @ ^ [V0s: A_27b > $o] :
              ( c_2Epair_2E_2C @ ( A_27b > $o ) @ $o @ V0s @ ( c_2Epred__set_2ESUBSET @ A_27b @ V0s @ ( c_2Epred__set_2EEMPTY @ A_27b ) ) ) )
      ...
      & ! [V1a: A_27a,V2t: A_27a > $o] :
          ( ( c_2Epred__set_2EGSPEC @ ( A_27a > $o ) @ ( A_27a > $o )
            @ ^ [V3s: A_27a > $o] :
                ( c_2Epair_2E_2C @ ( A_27a > $o ) @ $o @ V3s @ ( c_2Epred__set_2ESUBSET @ A_27a @ V3s @ ( c_2Epred__set_2EINSERT @ A_27a @ V1a @ V2t ) ) ) )
          = ( c_2Epred__set_2EUNION @ ( A_27a > $o )
            @ ( c_2Epred__set_2EGSPEC @ ( A_27a > $o ) @ ( A_27a > $o )
              @ ^ [V4s: A_27a > $o] :
                  ( c_2Epair_2E_2C @ ( A_27a > $o ) @ $o @ V4s @ ( c_2Epred__set_2ESUBSET @ A_27a @ V4s @ V2t ) ) )
            @ ( c_2Epred__set_2EIMAGE @ ( A_27a > $o ) @ ( A_27a > $o )
              @ ^ [V5s: A_27a > $o] :
                  ( c_2Epred__set_2EINSERT @ A_27a @ V1a @ V5s )
              @ ( c_2Epred__set_2EGSPEC @ ( A_27a > $o ) @ ( A_27a > $o )
                @ ^ [V6s: A_27a > $o] :
                    ( c_2Epair_2E_2C @ ( A_27a > $o ) @ $o @ V6s @ ( c_2Epred__set_2ESUBSET @ A_27a @ V6s @ V2t ) ) ) ) ) ) ) )).
