...
tff(conj_thm_2Eintegral_2EDINT__COMBINE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Eintegral_2EDINT__DELTA__LEFT,lemma,(
...
tff(conj_thm_2Eintegral_2EDINT__DELTA__RIGHT,lemma,(
...
tff(lmtp_f3212,type,(
    f3212: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3212,axiom,(
    ! [V2c: tp__ty_2Erealax_2Ereal] : mem(f3212(V2c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3212,axiom,(
    ! [V2c: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f3212(V2c),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),inj__ty_2Erealax_2Ereal(V2c))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).

tff(conj_thm_2Eintegral_2EDINT__DELTA,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),f3212(V2c)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) )).
