...
thf(thm_2Elist_2ELUPDATE__compute,conjecture,(
    ! [A_27a: d] :
      ...
      & ! [V2e_2E0: u,V3x_2E0: u,V4l_2E0: u] :
          ...
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_2E0 ) ) ) )
      & ! [V5e_2E0: u,V6n: mono_2Etyop_2Enum_2Enum,V7x_2E0: u,V8l_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V5e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V6n ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V7x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V8l_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V7x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V5e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V6n ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V8l_2E0 ) ) ) ) ) )
      & ! [V9e_2E0: u,V10n: mono_2Etyop_2Enum_2Enum,V11x_2E0: u,V12l_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V9e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V10n ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V11x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V12l_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V11x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V9e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V10n ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V12l_2E0 ) ) ) ) ) ) ) )).
