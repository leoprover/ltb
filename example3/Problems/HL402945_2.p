...
tff(conj_thm_2EpatternMatches_2EPMATCH__EXTEND__OLD,conjecture,(
                 ...
                 => ! [V4r__old: $i] :
                     ...
                     => ( ap(V4r__old,V0v__old) = c_2Eoption_2ENONE(A_27c)
                       => ( ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V0v__old),V2rows__old) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V1v__new),V3rows__new)
                         => ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V0v__old),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27c))),V4r__old),V2rows__old)) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V1v__new),V3rows__new) ) ) ) ) ) ) ) )).
