...
thf(conj_thm_2Eset__relation_2Emaximal__TC,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1r: $i] :
          ( ( mem @ V1r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
         => ( ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ ( ap @ ( c_2Eset__relation_2Edomain @ A_27a @ A_27a ) @ V1r ) ) @ V0s ) )
           ...
           => ( ( ap @ ( ap @ ( c_2Eset__relation_2Emaximal__elements @ A_27a ) @ V0s ) @ ( ap @ ( c_2Eset__relation_2Etc @ A_27a ) @ V1r ) )
              = ( ap @ ( ap @ ( c_2Eset__relation_2Emaximal__elements @ A_27a ) @ V0s ) @ V1r ) ) ) ) ) )).
