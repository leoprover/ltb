...
fof(conj_thm_2Epred__set_2ESUM__SET__IN__LE,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V1s))
              & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0x),V1s)) )
           => p(ap(ap(c_2Earithmetic_2E_3C_3D,V0x),ap(c_2Epred__set_2ESUM__SET,V1s))) ) ) ) )).
