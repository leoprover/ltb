...
thf(conj_thm_2EConseqConv_2Eexists__eq__thm,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2EpatternMatches_2EPMATCH__ROW__COND__EX__WEAKEN,conjecture,(
                             ...
                             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2EpatternMatches_2EPMATCH__ROW__COND__EX @ A_27c @ A_27a ) @ V1v ) @ V4p_27 ) @ V5g_27 ) )
                              <=> ( p
                                  @ ( ap @ ( ap @ ( ap @ ( c_2EpatternMatches_2EPMATCH__ROW__COND__EX @ A_27c @ A_27a ) @ V1v ) @ V4p_27 )
                                    @ ( lam @ A_27a
                                      @ ^ [V7x: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V5g_27 @ V7x ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3g @ ( ap @ V0f @ V7x ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
