...
tff(conj_thm_2Ereal__topology_2EIN__COMPONENTS__SUBSET,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSED__COMPONENTS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: $i] :
          ( mem(V1c,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__COMPONENTS,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: $i] :
          ( mem(V1c,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
              & p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1c),ap(c_2Ereal__topology_2Ecomponents,V0s))) )
           => p(ap(c_2Ereal__topology_2Ecompact,V1c)) ) ) ) )).
