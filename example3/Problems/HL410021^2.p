...
thf(conj_thm_2Eproduct_2ENPRODUCT__UNION,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
               ...
               => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ V1s ) @ V2t ) ) @ V0f ) )
                  = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ V1s ) @ V0f ) ) @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ V2t ) @ V0f ) ) ) ) ) ) ) ) )).
