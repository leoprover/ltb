...
thf(f2937_0_2E0,type,(
    f2937_0_2E0: u )).

thf(f2937_0_2E3,type,(
    f2937_0_2E3: du > du > du > u )).

thf(f2937_1_2E0,type,(
    f2937_1_2E0: u )).

thf(f2937_1_2E2,type,(
    f2937_1_2E2: du > du > u )).
...
thf(arityeq3_2Emono_2Ef2937_0_2E3_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2937_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ef2937_1_2E2_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2937_1_2E2 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ f2937_1_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS__EQ__FUN,axiom,(
    ! [A_27b: d,A_27c: d,V4f_2E0: u,V2t1_2E0: u,V3t2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2937_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V4f_2E0 ) @ ( s @ A_27b @ V2t1_2E0 ) @ ( s @ A_27b @ V3t2_2E0 ) ) ) )
    <=> ( ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V4f_2E0 ) @ ( s @ A_27b @ V2t1_2E0 ) ) )
        = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V4f_2E0 ) @ ( s @ A_27b @ V3t2_2E0 ) ) ) ) ) )).

thf(def1_2Ethm_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS__EQ__FUN,axiom,(
    ! [A_27b: d,V2t1_2E0: u,V3t2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2937_1_2E2 @ ( s @ A_27b @ V2t1_2E0 ) @ ( s @ A_27b @ V3t2_2E0 ) ) ) )
    <=> ( ( s @ A_27b @ V2t1_2E0 )
        = ( s @ A_27b @ V3t2_2E0 ) ) ) )).

thf(thm_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS__EQ__FUN,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0v_2E0: u,V1i_2E0: u,V2t1_2E0: u,V3t2_2E0: u,V4f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS_2E3 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ A_27a @ V1i_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( f2937_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V4f_2E0 ) @ ( s @ A_27b @ V2t1_2E0 ) @ ( s @ A_27b @ V3t2_2E0 ) ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS_2E3 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ A_27a @ V1i_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( f2937_1_2E2 @ ( s @ A_27b @ V2t1_2E0 ) @ ( s @ A_27b @ V3t2_2E0 ) ) ) ) ) ) ) )).
