...
thf(thm_2Earithmetic_2EMOD__ELIM,conjecture,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o,V1x: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V2n )
        & ( V0P @ V1x )
        & ! [V3y: mono_2Etyop_2Enum_2Enum] :
            ( ( V0P @ ( mono_2Ec_2Earithmetic_2E_2B @ V3y @ V2n ) )
           => ( V0P @ V3y ) ) )
     => ( V0P @ ( mono_2Ec_2Earithmetic_2EMOD @ V1x @ V2n ) ) ) )).
