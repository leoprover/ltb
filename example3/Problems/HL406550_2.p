...
tff(conj_thm_2Ewords_2EWORD__EXTRACT__ZERO2,lemma,(
    ! [A_27a: del,A_27b: del,V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum] : ap(ap(ap(c_2Ewords_2Eword__extract(A_27b,A_27b),inj__ty_2Enum_2Enum(V0h)),inj__ty_2Enum_2Enum(V1l)),ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) = ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) )).
...
tff(conj_thm_2Ewords_2EWORD__EXTRACT__OVER__ADD2,lemma,(
    ! [A_27a: del,A_27b: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2h: tp__ty_2Enum_2Enum] :
             ...
             => ap(ap(ap(c_2Ewords_2Eword__extract(A_27b,A_27b),inj__ty_2Enum_2Enum(V2h)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(ap(c_2Ewords_2Eword__add(A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V2h)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V0a)),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V2h)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V1b))) = ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V2h)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(ap(c_2Ewords_2Eword__add(A_27a),V0a),V1b)) ) ) ) )).

tff(conj_thm_2Ewords_2EWORD__EXTRACT__OVER__MUL2,lemma,(
    ! [A_27a: del,A_27b: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ealignment_2Ealigned__ge__dim,lemma,(
    ! [A_27a: del,V0p: tp__ty_2Enum_2Enum,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ealignment_2Ealigned__add__sub,conjecture,(
