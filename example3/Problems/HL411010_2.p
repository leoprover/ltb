...
tff(conj_thm_2Ereal__topology_2EBOUNDED__EMPTY,lemma,(
    p(ap(c_2Ereal__topology_2Ebounded__def,c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))) )).

tff(conj_thm_2Ereal__topology_2EBOUNDED__INSERT,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0x)),V1s)))
      <=> p(ap(c_2Ereal__topology_2Ebounded__def,V1s)) ) ) )).

tff(conj_thm_2Ereal__topology_2EBOUNDED__SING,conjecture,(
