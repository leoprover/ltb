...
fof(conj_thm_2Epath_2EfirstP__at__zero,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
             ...
             => ! [V1p] :
                  ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
                 => ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),V1p),c_2Enum_2E0))
                  <=> p(ap(V0P,ap(c_2Epath_2Efirst(A_27a,A_27a),V1p))) ) ) ) ) ) )).

fof(conj_thm_2Epath_2EfirstP__at__unique,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
             ...
             => ! [V1p] :
                 ...
                 => ! [V2n] :
                      ( mem(V2n,ty_2Enum_2Enum)
                     => ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),V1p),V2n))
                       => ! [V3m] :
                            ( mem(V3m,ty_2Enum_2Enum)
                           => ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),V1p),V3m))
                            <=> V3m = V2n ) ) ) ) ) ) ) ) )).
