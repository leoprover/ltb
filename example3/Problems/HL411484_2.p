...
tff(conj_thm_2Ereal__topology_2EDIAMETER__SING,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Ediameter,ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).

tff(conj_thm_2Ereal__topology_2EDIAMETER__EQ__0,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
       => ( surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Ediameter,V0s)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
        <=> ( V0s = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
            | ? [V1a: tp__ty_2Erealax_2Ereal] : V0s = ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) ) ) ) ) )).
