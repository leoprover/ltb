...
thf(c_2Ewords_2Ebit__count_2E0,type,(
    c_2Ewords_2Ebit__count_2E0: u )).

thf(c_2Ewords_2Ebit__count_2E1,type,(
    c_2Ewords_2Ebit__count_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ec_2Ewords_2Ebit__count_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Ewords_2Ebit__count_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ tyop_2Enum_2Enum ) @ c_2Ewords_2Ebit__count_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Ewords_2Ebit__count__def,axiom,(
    ! [A_27a: d,V0w_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Ewords_2Ebit__count_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0w_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Ewords_2Ebit__count__upto_2E2 @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0w_2E0 ) ) ) ) ) )).
...
thf(thm_2Ewords_2Ebit__count__is__zero,conjecture,(
    ! [A_27a: d,V0w_2E0: u] :
      ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Ewords_2Ebit__count_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0w_2E0 ) ) ) )
        = mono_2Ec_2Enum_2E0 )
    <=> ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0w_2E0 )
