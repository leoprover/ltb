...
tff(conj_thm_2Efinite__map_2EFUPDATE__EQ__FUPDATE__LIST,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1kv: $i] :
          ( mem(V1kv,ty_2Epair_2Eprod(A_27a,A_27a))
         => ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0fm),V1kv) = ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V0fm),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),V1kv),c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) )).
