...
thf(f3659_0_2E0,type,(
    f3659_0_2E0: u )).

thf(f3659_0_2E1,type,(
    f3659_0_2E1: du > u )).

thf(f3659_0_2E2,type,(
    f3659_0_2E2: du > du > u )).
...
thf(mono_2Ef3659_0,type,(
    mono_2Ef3659_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2ESWHEN__LINORD,axiom,(
    ! [V1b: mono_2Etyop_2Enum_2Enum > $o,V4t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3659_0 @ V1b @ V4t )
    <=> ( (~) @ ( V1b @ V4t ) ) ) )).
