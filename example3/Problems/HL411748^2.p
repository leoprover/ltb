...
thf(conj_thm_2Ereal__topology_2ESERIES__DIFFS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
            ...
            @ ( ap
              @ ( ap
                @ ( ap @ c_2Ereal__topology_2Esums
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V2n: $i] :
                        ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V2n ) ) @ ( ap @ V0f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V2n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
                @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V1k ) ) )
              @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) ) ) ) )).
