...
tff(conj_thm_2Epatricia_2EREMOVE__ADD,conjecture,(
    ! [A_27a: del,V0t: $i] :
      ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
     => ! [V1k: tp__ty_2Enum_2Enum,V2d: $i] :
          ( mem(V2d,A_27a)
         => ! [V3j: tp__ty_2Enum_2Enum] :
              ( p(ap(c_2Epatricia_2EIS__PTREE(A_27a),V0t))
             => ap(ap(c_2Epatricia_2EREMOVE(A_27a),ap(ap(c_2Epatricia_2EADD(A_27a),V0t),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1k)),V2d))),inj__ty_2Enum_2Enum(V3j)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Epatricia_2Eptree(A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1k)),inj__ty_2Enum_2Enum(V3j))),ap(ap(c_2Epatricia_2EREMOVE(A_27a),V0t),inj__ty_2Enum_2Enum(V3j))),ap(ap(c_2Epatricia_2EADD(A_27a),ap(ap(c_2Epatricia_2EREMOVE(A_27a),V0t),inj__ty_2Enum_2Enum(V3j))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1k)),V2d))) ) ) ) )).
