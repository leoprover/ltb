...
fof(conj_thm_2Einteger_2EINT__LE__CALCULATE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Eint__arith_2Elt__justify__multiplication,lemma,(
    ! [V0n] :
...
fof(conj_thm_2Eint__arith_2Eelim__lt__coeffs1,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
