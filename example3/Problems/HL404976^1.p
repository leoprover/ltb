...
thf(thm_2Equotient__list_2ENIL__PRS,conjecture,(
    ! [A_27a: d,A_27b: d,V0R_2E0: u,V1abs_2E0: u,V2rep_2E0: u] :
     ...
     => ( ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ c_2Elist_2ENIL_2E0 )
        = ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1abs_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) ) ) )).
