...
tff(lmtp_f3945,type,(
    f3945: ( del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f3945,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : mem(f3945(A_27a,V1f,V2n),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3945,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum,V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f3945(A_27a,V1f,V2n),V4x) = ap(ap(c_2Ereal_2Epow,ap(V1f,V4x)),inj__ty_2Enum_2Enum(V2n)) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__POW,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2n: tp__ty_2Enum_2Enum] :
             ...
             => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3945(A_27a,V1f,V2n)),V0net)) ) ) ) )).
