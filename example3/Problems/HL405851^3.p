...
thf(thm_2Ebit_2EBIT__SLICE__THM4,axiom,(
    ! [V0b: tyop_2Enum_2Enum,V1h: tyop_2Enum_2Enum,V2l: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBIT @ V0b @ ( c_2Ebit_2ESLICE @ V1h @ V2l @ V3n ) )
    <=> ( ( c_2Earithmetic_2E_3C_3D @ V2l @ V0b )
        & ( c_2Earithmetic_2E_3C_3D @ V0b @ V1h )
        & ( c_2Ebit_2EBIT @ V0b @ V3n ) ) ) )).
