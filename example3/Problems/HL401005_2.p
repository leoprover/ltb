...
tff(conj_thm_2Earithmetic_2EMOD__ELIM,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => ! [V1x: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
          ( ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V2n)))
            ...
            & ! [V3y: tp__ty_2Enum_2Enum] :
                ( p(ap(V0P,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V3y)),inj__ty_2Enum_2Enum(V2n))))
               => p(ap(V0P,inj__ty_2Enum_2Enum(V3y))) ) )
         => p(ap(V0P,ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V1x)),inj__ty_2Enum_2Enum(V2n)))) ) ) )).
