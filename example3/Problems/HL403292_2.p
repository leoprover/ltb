...
tff(lamtp_f969,axiom,(
    ! [A_27a: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f969(A_27a,A_27a,V0P),arr(A_27a,ty_2Enum_2Enum)) ) )).

tff(lameq_f969,axiom,(
    ! [A_27a: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ap(f969(A_27a,A_27a,V0P),V1x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2EIN(A_27a),V1x),V0P)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) ) ) )).

tff(ax_thm_2Ebag_2EBAG__OF__SET,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ap(c_2Ebag_2EBAG__OF__SET(A_27a),V0P) = f969(A_27a,A_27a,V0P) ) )).

tff(conj_thm_2Ebag_2ESET__OF__EMPTY,conjecture,(
    ! [A_27a: del] : ap(c_2Ebag_2EBAG__OF__SET(A_27a),c_2Epred__set_2EEMPTY(A_27a)) = c_2Ebag_2EEMPTY__BAG(A_27a) )).
