...
thf(f3820_0_2E0,type,(
    f3820_0_2E0: u )).

thf(f3820_0_2E2,type,(
    f3820_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef3820_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3820_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f3820_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ebag_2EBAG__DELETE__concrete,axiom,(
    ! [A_27a: d,V3x_2E0: u,V2e_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3820_0_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ A_27a @ V2e_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V3x_2E0 )
        = ( s @ A_27a @ V2e_2E0 ) ) ) )).

thf(thm_2Ebag_2EBAG__DELETE__concrete,conjecture,(
    ...
    <=> ( ( mono_2Ec_2Earithmetic_2E_3E @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b0_2E0 ) @ ( s @ A_27a @ V2e_2E0 ) ) ) ) @ mono_2Ec_2Enum_2E0 )
        & ! [V3x_2E0: u] :
            ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1b_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
            = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3820_0_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ A_27a @ V2e_2E0 ) ) ) ) @ ( mono_2Ec_2Earithmetic_2E_2D @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b0_2E0 ) @ ( s @ A_27a @ V2e_2E0 ) ) ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b0_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) ) ) )).
