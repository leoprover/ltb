    ...
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0R1_2E0: u,V1abs1_2E0: u,V2rep1_2E0: u] :
     ...
     => ! [V3R2_2E0: u,V4abs2_2E0: u,V5rep2_2E0: u] :
         ...
         => ! [V6p1_2E0: u,V7p2_2E0: u] :
             ...
             => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R1_2E0 ) @ ( s @ A_27a @ ( c_2Epair_2EFST_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V6p1_2E0 ) ) ) ) ) @ ( s @ A_27a @ ( c_2Epair_2EFST_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V7p2_2E0 ) ) ) ) ) ) ) ) ) )).
