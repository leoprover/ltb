...
tff(conj_thm_2Ereal__topology_2ECOMPLETE__INJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
          & ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
       ...
       => ! [V3s: $i] :
            ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
           => ( p(ap(c_2Ereal__topology_2Ecomplete,V3s))
             => p(ap(c_2Ereal__topology_2Ecomplete,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V3s))) ) ) ) ) )).
