...
thf(conj_thm_2Elim_2ECONT__ATTAINS__ALL,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Elim_2ECONT__INJ__LEMMA,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Elim_2ECONT__INJ__LEMMA2,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal_2EREAL__LE__DOUBLE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Elim_2ECONT__INJ__RANGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
