...
tff(conj_thm_2Ereal__topology_2EBILINEAR__CONTINUOUS__ON__COMPOSE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(lmtp_f3845,type,(
    f3845: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3845,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f3845(V0x),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3845,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : ap(f3845(V0x),inj__ty_2Erealax_2Ereal(V1y)) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)) )).

tff(lmtp_f3844,type,(
    f3844: $i )).

tff(lamtp_f3844,axiom,(
    mem(f3844,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3844,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f3844,inj__ty_2Erealax_2Ereal(V0x)) = f3845(V0x) )).

tff(conj_thm_2Ereal__topology_2EBILINEAR__DOT,lemma,(
    p(ap(c_2Ereal__topology_2Ebilinear,f3844)) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__DOT2,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V2s))
               ...
               => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f2907(V0f,V1g)),V2s)) ) ) ) ) )).
