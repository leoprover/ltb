...
thf(thm_2Ebitstring_2Efixwidth,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1v: tyop_2Elist_2Elist @ $o] :
      ( ( c_2Ebitstring_2Efixwidth @ V0n @ V1v )
      = ( c_2Ebool_2ELET @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ $o )
        @ ^ [V2l: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ ( tyop_2Elist_2Elist @ $o ) @ ( c_2Eprim__rec_2E_3C @ V2l @ V0n ) @ ( c_2Ebitstring_2Eextend @ c_2Ebool_2EF @ ( c_2Earithmetic_2E_2D @ V0n @ V2l ) @ V1v ) @ ( c_2Elist_2EDROP @ $o @ ( c_2Earithmetic_2E_2D @ V2l @ V0n ) @ V1v ) )
        @ ( c_2Elist_2ELENGTH @ $o @ V1v ) ) ) )).
