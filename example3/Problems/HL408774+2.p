...
fof(conj_thm_2EHolSmt_2Er153,conjecture,(
    ! [V0a] :
             ...
             => ! [V3y] :
                 ...
                 => ! [V4w] :
                     ...
                     => ! [V5z] :
                         ...
                         => ( V0a = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V1u)),V2x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V3y)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V4w)),V5z)))
                          <=> ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V1u),V2x)),ap(ap(c_2Erealax_2Ereal__add,V3y),ap(ap(c_2Erealax_2Ereal__mul,V4w),V5z))) = ap(c_2Erealax_2Ereal__neg,V0a) ) ) ) ) ) ) ) )).
