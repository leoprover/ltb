...
tff(lameq_f4035,axiom,(
    ! [V1a: $i] :
     ...
     => ! [V0k: $i] :
          ( mem(V0k,arr(ty_2Enum_2Enum,bool))
         => ! [V2n: tp__ty_2Enum_2Enum] : ap(f4035(V1a,V0k),inj__ty_2Enum_2Enum(V2n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2n)),V0k)),ap(V1a,inj__ty_2Enum_2Enum(V2n))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Ereal__topology_2EINFSUM__RESTRICT,conjecture,(
    ! [V0k: $i] :
      ( mem(V0k,arr(ty_2Enum_2Enum,bool))
     => ! [V1a: $i] :
          ( mem(V1a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Einfsum,c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),f4035(V1a,V0k))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Einfsum,V0k),V1a)) ) ) )).
