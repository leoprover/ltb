...
thf(thm_2Elist_2Elist__case__compute,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1b_2E0: u,V2l_2E0: u] :
      ( ( s @ A_27b @ ( c_2Elist_2Elist__CASE_2E3 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) @ ( s @ A_27b @ V1b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) @ V0f_2E0 ) ) )
      = ( s @ A_27b @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ENULL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) @ ( s @ A_27b @ V1b_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27a @ ( c_2Elist_2EHD_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) ) ) ) ) )).

thf(thm_2Elist_2Elazy__list__case__compute,conjecture,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1x_27_2E0: u,V2x_27_27_2E0: u] :
      ( ( s @ A_27b @ ( c_2Elist_2Elist__CASE_2E3 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0x_2E0 ) @ ( s @ A_27b @ V1x_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) @ V2x_27_27_2E0 ) ) )
      = ( s @ A_27b @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ENULL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0x_2E0 ) ) ) @ ( s @ A_27b @ V1x_27_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) @ V2x_27_27_2E0 ) @ ( s @ A_27a @ ( c_2Elist_2EHD_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0x_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0x_2E0 ) ) ) ) ) ) ) ) )).
