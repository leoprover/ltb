...
tff(tp_c_2Estring_2EisHexDigit,type,(
    c_2Estring_2EisHexDigit: $i )).

tff(mem_c_2Estring_2EisHexDigit,axiom,(
    mem(c_2Estring_2EisHexDigit,arr(ty_2Estring_2Echar,bool)) )).

tff(stp_fo_c_2Estring_2EisHexDigit,type,(
    fo__c_2Estring_2EisHexDigit: tp__ty_2Estring_2Echar > tp__o )).

tff(stp_eq_fo_c_2Estring_2EisHexDigit,axiom,(
    ! [X0: tp__ty_2Estring_2Echar] : inj__o(fo__c_2Estring_2EisHexDigit(X0)) = ap(c_2Estring_2EisHexDigit,inj__ty_2Estring_2Echar(X0)) )).

tff(tp_c_2Estring_2EisLower,type,(
    c_2Estring_2EisLower: $i )).

tff(mem_c_2Estring_2EisLower,axiom,(
    mem(c_2Estring_2EisLower,arr(ty_2Estring_2Echar,bool)) )).

tff(stp_fo_c_2Estring_2EisLower,type,(
    fo__c_2Estring_2EisLower: tp__ty_2Estring_2Echar > tp__o )).

tff(stp_eq_fo_c_2Estring_2EisLower,axiom,(
    ! [X0: tp__ty_2Estring_2Echar] : inj__o(fo__c_2Estring_2EisLower(X0)) = ap(c_2Estring_2EisLower,inj__ty_2Estring_2Echar(X0)) )).

tff(tp_c_2Estring_2EtoUpper,type,(
    c_2Estring_2EtoUpper: $i )).

tff(mem_c_2Estring_2EtoUpper,axiom,(
    mem(c_2Estring_2EtoUpper,arr(ty_2Estring_2Echar,ty_2Estring_2Echar)) )).

tff(stp_fo_c_2Estring_2EtoUpper,type,(
    fo__c_2Estring_2EtoUpper: tp__ty_2Estring_2Echar > tp__ty_2Estring_2Echar )).

tff(stp_eq_fo_c_2Estring_2EtoUpper,axiom,(
    ! [X0: tp__ty_2Estring_2Echar] : inj__ty_2Estring_2Echar(fo__c_2Estring_2EtoUpper(X0)) = ap(c_2Estring_2EtoUpper,inj__ty_2Estring_2Echar(X0)) )).
...
tff(ax_thm_2Estring_2EisLower__def,axiom,(
    ! [V0c: tp__ty_2Estring_2Echar] :
...
tff(ax_thm_2Estring_2EisHexDigit__def,axiom,(
    ! [V0c: tp__ty_2Estring_2Echar] :
...
tff(conj_thm_2EASCIInumbers_2EHEX__UNHEX,conjecture,(
    ! [V0c: tp__ty_2Estring_2Echar] :
      ( p(ap(c_2Estring_2EisHexDigit,inj__ty_2Estring_2Echar(V0c)))
