...
thf(thm_2Enumeral__bit_2Enumeral__log2,conjecture,
    ( ! [V0n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Ebit_2ELOG2 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V0n ) ) )
        = ( mono_2Ec_2Enumeral__bit_2EiLOG2 @ ( mono_2Ec_2Enumeral_2EiDUB @ V0n ) ) )
    & ! [V1n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Ebit_2ELOG2 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V1n ) ) )
        = ( mono_2Ec_2Enumeral__bit_2EiLOG2 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1n ) ) ) )).
