...
thf(f13285_0_2E0,type,(
    f13285_0_2E0: u )).

thf(f13285_0_2E1,type,(
    f13285_0_2E1: du > u )).

thf(f13897_0_2E0,type,(
    f13897_0_2E0: u )).

thf(f13897_0_2E1,type,(
    f13897_0_2E1: du > u )).

thf(f13897_0_2E2,type,(
...
thf(mono_2Ef13285_0,type,(
    mono_2Ef13285_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(arityeq1_2Emono_2Ef13897_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f13897_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ f13897_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef13897_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f13897_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
...
thf(def0_2Ethm_2Ereal__topology_2ELINEAR__ID,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13285_0 @ V0x )
      = V0x ) )).

thf(thm_2Ereal__topology_2ELINEAR__ID,axiom,(
    mono_2Ec_2Ereal__topology_2Elinear @ mono_2Ef13285_0 )).
...
thf(def0_2Ethm_2Ereal__topology_2ECONTINUOUS__COMPONENT__COMPOSE,axiom,(
    ! [A_27a: d,V1f_2E0: u,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f13897_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
...
thf(thm_2Ereal__topology_2ECONTINUOUS__COMPONENT__COMPOSE,conjecture,(
    ! [A_27a: d,A_27b: d,V0net_2E0: u,V1f_2E0: u,V2i_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Econtinuous_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f13897_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) ) ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) ) ) )).
