...
thf(f11651_0_2E0,type,(
    f11651_0_2E0: u )).

thf(f11651_0_2E1,type,(
    f11651_0_2E1: du > u )).
...
thf(mono_2Ef11651_0,type,(
    mono_2Ef11651_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).
...
thf(thm_2Eiterate_2ESUP__UNIQUE__FINITE,axiom,(
     ...
     => ( ( ( mono_2Ec_2Ereal_2Esup @ V1s )
      ...
      <=> ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V0a @ V1s )
          & ! [V2y: mono_2Etyop_2Erealax_2Ereal] :
             ...
             => ( mono_2Ec_2Ereal_2Ereal__lte @ V2y @ V0a ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eiterate_2ESUP__INSERT__FINITE,axiom,(
    ! [V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ef11651_0 @ V1s )
    <=> ( V1s = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal ) ) )).

thf(thm_2Eiterate_2ESUP__INSERT__FINITE,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( ( mono_2Ec_2Ereal_2Esup @ ( mono_2Ec_2Epred__set_2EINSERT_2Emono_2Etyop_2Erealax_2Ereal @ V0x @ V1s ) )
        = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef11651_0 @ V1s ) @ V0x @ ( mono_2Ec_2Ereal_2Emax @ V0x @ ( mono_2Ec_2Ereal_2Esup @ V1s ) ) ) ) ) )).
