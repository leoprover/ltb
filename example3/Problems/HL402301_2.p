...
tff(conj_thm_2Elist_2ELIST__TO__SET__GENLIST,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EGENLIST(A_27a),V0f),inj__ty_2Enum_2Enum(V1n))) = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V1n))) ) )).
