...
fof(conj_thm_2Esptree_2Edomain__inter,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0t1] :
             ...
             => ! [V1t2] :
                 ...
                 => ap(c_2Esptree_2Edomain(A_27a),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V0t1),V1t2)) = ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),ap(c_2Esptree_2Edomain(A_27a),V0t1)),ap(c_2Esptree_2Edomain(A_27b),V1t2)) ) ) ) ) )).
