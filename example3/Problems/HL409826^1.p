...
thf(thm_2Eiterate_2ESUM__BOUND__LT,axiom,(
    ! [A_27a: d,V0s_2E0: u,V1f_2E0: u,V2b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
        ...
        & ? [V4x_2E0: u] :
            ...
            & ( mono_2Ec_2Erealax_2Ereal__lt @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) ) @ V2b ) ) )
...
thf(thm_2Eiterate_2ESUM__BOUND__LT__ALL,conjecture,(
    ! [A_27a: d,V0s_2E0: u,V1f_2E0: u,V2b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
        & ( (~)
          @ ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 )
