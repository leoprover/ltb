...
fof(conj_thm_2Epoly_2EORDER__POLY,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1q] :
          ( mem(V1q,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
...
fof(conj_thm_2Epoly_2EORDER__DIVIDES,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1a] :
...
fof(conj_thm_2Epoly_2EORDER__MUL,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Epoly_2EORDER__DIFF,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Epoly_2EPOLY__SQUAREFREE__DECOMP__ORDER,conjecture,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1q] :
          ( mem(V1q,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
