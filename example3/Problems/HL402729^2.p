...
thf(conj_thm_2Erich__list_2EELL__SNOC,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2l: $i] :
              ( ( mem @ V2l @ ( ty_2Elist_2Elist @ A_27a ) )
             => ( ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V1x ) @ V2l ) )
                = ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( ap @ c_2Eprim__rec_2EPRE @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ V2l ) ) ) ) ) )).
