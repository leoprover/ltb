...
fof(lameq_f967,axiom,(
    ! [A_27a,V2e] :
     ...
     => ! [V0b0] :
         ...
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f967(A_27a,V2e,V0b0),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(A_27a),V3x),V2e)),ap(ap(c_2Earithmetic_2E_2D,ap(V0b0,V2e)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(V0b0,V3x)) ) ) ) )).

fof(conj_thm_2Ebag_2EBAG__DELETE__concrete,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b0] :
          ( mem(V0b0,arr(A_27a,ty_2Enum_2Enum))
