...
tff(conj_thm_2Efinite__map_2EFUPDATE__LIST__APPLY__HO__THM,lemma,(
         ...
         => ! [V2kvl: $i] :
             ...
             => ! [V3k: $i] :
                 ...
                 => ( ( ? [V4n: tp__ty_2Enum_2Enum] :
                          ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V4n)),ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27b,A_27b)),V2kvl)))
                          & V3k = ap(ap(c_2Elist_2EEL(A_27b),inj__ty_2Enum_2Enum(V4n)),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),c_2Epair_2EFST(A_27b,A_27b)),V2kvl))
                          & p(ap(V0P,ap(ap(c_2Elist_2EEL(A_27a),inj__ty_2Enum_2Enum(V4n)),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),c_2Epair_2ESND(A_27b,A_27b)),V2kvl))))
                          & ! [V5m: tp__ty_2Enum_2Enum] :
                              ( ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V4n)),inj__ty_2Enum_2Enum(V5m)))
                                & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V5m)),ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27b,A_27b)),V2kvl))) )
                             => ap(ap(c_2Elist_2EEL(A_27b),inj__ty_2Enum_2Enum(V5m)),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),c_2Epair_2EFST(A_27b,A_27b)),V2kvl)) != V3k ) )
...
tff(conj_thm_2Efinite__map_2EFUPDATE__LIST__ALL__DISTINCT__APPLY__MEM,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1ls: $i] :
         ...
         => ! [V2k: $i] :
             ...
             => ! [V3v: $i] :
                 ...
                 => ! [V4fm: $i] :
                     ...
                     => ( ( p(ap(c_2Elist_2EALL__DISTINCT(A_27b),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),c_2Epair_2EFST(A_27b,A_27b)),V1ls)))
                          & p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27b,A_27b)),ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V2k),V3v)),ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(A_27b,A_27b)),V1ls)))
                          & p(ap(V0P,V3v)) )
                       => p(ap(V0P,ap(ap(c_2Efinite__map_2EFAPPLY(A_27b,A_27b),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27b,A_27b),V4fm),V1ls)),V2k))) ) ) ) ) ) ) )).
