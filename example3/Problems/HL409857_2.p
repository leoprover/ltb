...
tff(lamtp_f3386,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3386(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3386,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3i: tp__ty_2Enum_2Enum] : ap(f3386(V0f),inj__ty_2Enum_2Enum(V3i)) = ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Enum_2Enum(V3i))) ) )).

tff(conj_thm_2Eiterate_2ESUM__ABS__NUMSEG,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
