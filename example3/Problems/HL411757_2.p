...
tff(lameq_f4015,axiom,(
    ! [V0x: $i] :
     ...
     => ! [V2y: $i] :
          ( mem(V2y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V5n: tp__ty_2Enum_2Enum] : ap(f4015(V0x,V2y),inj__ty_2Enum_2Enum(V5n)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0x,inj__ty_2Enum_2Enum(V5n))),ap(V2y,inj__ty_2Enum_2Enum(V5n))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__SUB,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0: tp__ty_2Erealax_2Ereal,V2y: $i] :
         ...
         => ! [V3y0: tp__ty_2Erealax_2Ereal,V4s: $i] :
             ...
             => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0x),inj__ty_2Erealax_2Ereal(V1x0)),V4s))
               ...
               => p(ap(ap(ap(c_2Ereal__topology_2Esums,f4015(V0x,V2y)),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V1x0)),inj__ty_2Erealax_2Ereal(V3y0))),V4s)) ) ) ) ) )).

tff(lmtp_f4025,type,(
    f4025: ( $i * $i ) > $i )).

tff(lamtp_f4025,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1y: $i] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f4025(V0x,V1y),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f4025,axiom,(
    ! [V0x: $i] :
     ...
     => ! [V1y: $i] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V3n: tp__ty_2Enum_2Enum] : ap(f4025(V0x,V1y),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0x,inj__ty_2Enum_2Enum(V3n))),ap(V1y,inj__ty_2Enum_2Enum(V3n))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESUMMABLE__SUB,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1y: $i] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,V2s),V0x))
               ...
               => p(ap(ap(c_2Ereal__topology_2Esummable,V2s),f4025(V0x,V1y))) ) ) ) ) )).
