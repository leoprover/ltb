...
fof(conj_thm_2EHolSmt_2Er023,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,bool)
         => ! [V1x] :
             ...
             => ! [V2y] :
                 ...
                 => ! [V3z] :
                      ( mem(V3z,A_27a)
                     => ap(ap(ap(c_2Ebool_2ECOND(A_27a),V0p),V1x),ap(ap(ap(c_2Ebool_2ECOND(A_27a),V0p),V2y),V3z)) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),V0p),V1x),V3z) ) ) ) ) ) )).
