...
fof(def0_2Ethm_2ETemporal__Logic_2ESWHEN__LINORD,axiom,(
    ! [V1b_2E0,V4t_2E0] :
      ( p(s(tyop_2Emin_2Ebool,f3659_0_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),V1b_2E0),s(tyop_2Enum_2Enum,V4t_2E0))))
    <=> ~ p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),V1b_2E0),s(tyop_2Enum_2Enum,V4t_2E0)))) ) )).

fof(thm_2ETemporal__Logic_2ESWHEN__LINORD,conjecture,(
