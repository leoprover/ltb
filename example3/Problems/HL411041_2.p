...
tff(conj_thm_2Ereal__topology_2ECOMPACT__REAL__LEMMA,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__LEMMA,conjecture,(
    ! [A_27a: del,V0x: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V1s))
              & ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0x,inj__ty_2Enum_2Enum(V2n))),V1s)) )
           => ? [V3l: tp__ty_2Erealax_2Ereal,V4r: $i] :
                ( mem(V4r,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
                & ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] :
                    ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V5m)),inj__ty_2Enum_2Enum(V6n)))
