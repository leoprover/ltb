...
fof(ax_thm_2Emachine__ieee_2Efp16__roundToIntegral__def,axiom,(
    ! [V0mode] :
     ...
     => ap(c_2Emachine__ieee_2Efp16__roundToIntegral,V0mode) = ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Emachine__ieee_2Efloat__to__fp16),ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__round__to__integral(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),V0mode)),c_2Emachine__ieee_2Efp16__to__float)) ) )).
...
fof(conj_thm_2Emachine__ieee_2Efp16__roundToIntegral,conjecture,
    ( ! [V0mode] :
        ( mem(V0mode,ty_2Ebinary__ieee_2Erounding)
       => ! [V1a] :
