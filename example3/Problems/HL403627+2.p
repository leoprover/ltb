...
fof(mem_c_2Efcp_2EFCP__HD,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Efcp_2EFCP__HD(A_27a,A_27a),arr(ty_2Efcp_2Ecart(A_27a,A_27a),A_27a)) ) ) )).
    ...
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [V0v] :
             ...
             => ap(c_2Efcp_2EFCP__HD(A_27a,A_27a),V0v) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V0v),c_2Enum_2E0) ) ) ) )).
...
fof(conj_thm_2Efcp_2EFCP__HD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
