...
thf(f4148_0_2E0,type,(
    f4148_0_2E0: u )).

thf(f4148_0_2E1,type,(
    f4148_0_2E1: du > u )).

thf(f4148_0_2E2,type,(
    f4148_0_2E2: du > du > u )).

thf(f4148_1_2E0,type,(
    f4148_1_2E0: u )).

thf(f4148_1_2E1,type,(
    f4148_1_2E1: du > u )).

thf(f4148_1_2E3,type,(
...
thf(arityeq1_2Emono_2Ef4148_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( f4148_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) @ f4148_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4148_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( f4148_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ X1_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ef4148_1_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) @ ( f4148_1_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) ) @ f4148_1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef4148_1_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( f4148_1_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) )
...
thf(def0_2Ethm_2Ellist_2ELUNFOLD__UNIQUE,axiom,(
    ! [A_27a: d,A_27b: d,V1g_2E0: u,V4v1_2E0: u,V5v2_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( f4148_1_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) @ ( s @ A_27a @ V4v1_2E0 ) @ ( s @ A_27b @ V5v2_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27b @ V5v2_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) @ ( s @ A_27a @ V4v1_2E0 ) ) ) ) ) ) )).

thf(def1_2Ethm_2Ellist_2ELUNFOLD__UNIQUE,axiom,(
    ! [A_27a: d,A_27b: d,V1g_2E0: u,V3v_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( f4148_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V3v_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Epair_2Epair__CASE_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V3v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) @ ( f4148_1_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) ) ) ) ) ) )).

thf(thm_2Ellist_2ELUNFOLD__UNIQUE,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1g_2E0: u] :
      ( ! [V2x_2E0: u] :
          ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
          = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ c_2Ellist_2ELNIL_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( f4148_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) ) ) ) ) )
     => ! [V6y_2E0: u] :
          ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) )
          = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELUNFOLD_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) ) ) ) )).
