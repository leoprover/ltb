...
thf(thm_2ETemporal__Logic_2EEVENTUAL__FIX,conjecture,(
    ! [V0y: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ! [V2x: mono_2Etyop_2Enum_2Enum] :
          ( ( V0y @ V2x )
        <=> ( ( V1a @ V2x )
            | ( V0y @ ( mono_2Ec_2Earithmetic_2E_2B @ V2x @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) )
    <=> ( ( V0y
