...
thf(thm_2Enumpair_2Enpair__11,axiom,(
    ! [V0y2: mono_2Etyop_2Enum_2Enum,V1y1: mono_2Etyop_2Enum_2Enum,V2x2: mono_2Etyop_2Enum_2Enum,V3x1: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Enumpair_2Enpair @ V3x1 @ V1y1 )
        = ( mono_2Ec_2Enumpair_2Enpair @ V2x2 @ V0y2 ) )
    <=> ( ( V3x1 = V2x2 )
        & ( V1y1 = V0y2 ) ) ) )).
