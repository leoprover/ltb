...
thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__NEG,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__ADD,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SUB,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
