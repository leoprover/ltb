...
thf(conj_thm_2Ereal__topology_2EPOWERSET__CLAUSES,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ( ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27b @ bool ) @ ( arr @ A_27b @ bool ) )
          @ ( lam @ ( arr @ A_27b @ bool )
            @ ^ [V0s: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27b @ bool ) @ bool ) @ V0s ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27b ) @ V0s ) @ ( c_2Epred__set_2EEMPTY @ A_27b ) ) ) ) )
      ...
      & ! [V1a: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                  @ ( lam @ ( arr @ A_27a @ bool )
                    @ ^ [V3s: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V3s ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V3s ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V1a ) @ V2t ) ) ) ) )
                = ( ap
                  @ ( ap @ ( c_2Epred__set_2EUNION @ ( arr @ A_27a @ bool ) )
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                      @ ( lam @ ( arr @ A_27a @ bool )
                        @ ^ [V4s: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V4s ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V4s ) @ V2t ) ) ) ) )
                  @ ( ap
                    @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                      @ ( lam @ ( arr @ A_27a @ bool )
                        @ ^ [V5s: $i] :
                            ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V1a ) @ V5s ) ) )
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                      @ ( lam @ ( arr @ A_27a @ bool )
                        @ ^ [V6s: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V6s ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V6s ) @ V2t ) ) ) ) ) ) ) ) ) ) )).
