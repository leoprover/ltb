...
fof(conj_thm_2ETemporal__Logic_2EBEFORE__SIGNAL,lemma,(
    ! [V0a] :
...
fof(conj_thm_2EOmega__Automata_2ECO__BUECHI__BEFORE__CLOSURE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3Psi] :
                         ...
                         => ! [V4phi] :
                             ...
                             => ! [V5t0] :
                                 ...
                                 => ! [V6c] :
                                      ( mem(V6c,A_27b)
                                     => ( p(ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f2037(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi)),V4phi),V5t0))
                                      <=> ? [V12p1] :
