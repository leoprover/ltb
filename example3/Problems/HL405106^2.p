...
thf(conj_thm_2Equotient__pred__set_2EUNIV__PRS,conjecture,(
         ...
         => ! [V2rep: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2EQUOTIENT @ A_27a @ A_27b ) @ V0R ) @ V1abs ) @ V2rep ) )
               => ( ( c_2Epred__set_2EUNIV @ A_27b )
                  = ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27b @ bool @ A_27a @ bool ) @ V2rep ) @ ( c_2Ecombin_2EI @ bool ) ) @ ( c_2Epred__set_2EUNIV @ A_27a ) ) ) ) ) ) ) )).
