      ...
      @ ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
        @ ^ [V2t1: tyop_2Enum_2Enum] :
            ...
            @ ^ [V3t2: tyop_2Enum_2Enum] :
                ( V0b @ ( c_2Earithmetic_2E_2B @ V3t2 @ V2t1 ) ) ) )
      @ ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
        @ ^ [V4t0: tyop_2Enum_2Enum] :
            ( c_2Emin_2E_3D @ $o @ ( c_2ETemporal__Logic_2EWHEN @ V1a @ V0b @ V4t0 ) @ ( c_2ETemporal__Logic_2ESWHEN @ V1a @ V0b @ V4t0 ) ) )
      @ ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
        @ ^ [V5t1: tyop_2Enum_2Enum] :
            ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
            @ ^ [V6t2: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2EWHEN @ V1a @ V0b @ ( c_2Earithmetic_2E_2B @ V6t2 @ V5t1 ) ) @ ( c_2Ebool_2E_7E @ ( c_2ETemporal__Logic_2ESWHEN @ V1a @ V0b @ ( c_2Earithmetic_2E_2B @ V6t2 @ V5t1 ) ) ) ) ) ) ) )).
