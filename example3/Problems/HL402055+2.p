...
fof(conj_thm_2Eset__relation_2Efinite__strict__linear__order__has__maximal,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Eset__relation_2Efinite__linear__order__has__maximal,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
