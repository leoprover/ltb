...
tff(conj_thm_2Equotient__pred__set_2EDISJOINT__PRS,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
               ...
               => ! [V3s: $i] :
                   ...
                   => ! [V4t: $i] :
                       ...
                       => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27b),V3s),V4t))
                        <=> p(ap(ap(ap(c_2Equotient__pred__set_2EDISJOINTR(A_27a),V0R),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs),c_2Ecombin_2EI(bool)),V3s)),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs),c_2Ecombin_2EI(bool)),V4t))) ) ) ) ) ) ) ) )).
