...
fof(conj_thm_2Eutil__prob_2EMINIMAL__SUC,lemma,(
    ! [V0n] :
     ...
     => ! [V1p] :
         ...
         => ( ( ap(c_2Enum_2ESUC,V0n) = ap(c_2Eutil__prob_2Eminimal,V1p)
          ...
          <=> ( ~ p(ap(V1p,c_2Enum_2E0))
              & V0n = ap(c_2Eutil__prob_2Eminimal,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V1p),c_2Enum_2ESUC))
              & p(ap(V1p,ap(c_2Enum_2ESUC,V0n))) ) ) ) ) )).

fof(conj_thm_2Eutil__prob_2EMINIMAL__SUC__IMP,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1p] :
          ( mem(V1p,arr(ty_2Enum_2Enum,bool))
