...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__WITHIN__AVOID,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
         ...
         => ! [V3a: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V4e: tp__ty_2Erealax_2Ereal] :
                  ...
                  & ! [V5y: tp__ty_2Erealax_2Ereal] :
                     ...
                     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5y ) ) )
                       != V3a ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__AVOID,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2s: $i] :
          ( ( mem @ V2s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
