...
thf(conj_thm_2Erich__list_2EREPLICATE__APPEND,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1a: $i] :
      ( ( mem @ V1a @ A_27a )
     => ! [V2m: tp__ty_2Enum_2Enum] :
          ( ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ ( ap @ ( c_2Erich__list_2EREPLICATE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1a ) ) @ ( ap @ ( ap @ ( c_2Erich__list_2EREPLICATE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ V1a ) )
          = ( ap @ ( ap @ ( c_2Erich__list_2EREPLICATE @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) @ V1a ) ) ) )).
