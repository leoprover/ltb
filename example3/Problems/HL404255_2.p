...
tff(lamtp_f1726,axiom,(
    ! [A_27a: del,V0d: $i] :
      ( mem(V0d,arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => mem(f1726(A_27a,V0d,V1x),arr(ty_2Elist_2Elist(bool),bool)) ) ) )).
...
tff(lameq_f1726,axiom,(
    ! [A_27a: del,V0d: $i] :
     ...
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ! [V2l: tp__c_ty_2Elist_2Elist_o] : ap(f1726(A_27a,V0d,V1x),inj__c_ty_2Elist_2Elist_o(V2l)) = ap(ap(c_2Emin_2E_3D(ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))),ap(V0d,inj__c_ty_2Elist_2Elist_o(V2l))),ap(c_2Eoption_2ESOME(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),c_2Elist_2ENIL(bool)))) ) ) )).
...
tff(ax_thm_2EDecode_2Edec2enc__def,axiom,(
    ! [A_27a: del,V0d: $i] :
     ...
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => surj__c_ty_2Elist_2Elist_o(ap(ap(c_2EDecode_2Edec2enc(A_27a),V0d),V1x)) = surj__c_ty_2Elist_2Elist_o(ap(c_2Emin_2E_40(ty_2Elist_2Elist(bool)),f1726(A_27a,V0d,V1x))) ) ) )).

tff(conj_thm_2EDecode_2Edec2enc__some,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1d: $i] :
          ( mem(V1d,arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))))
