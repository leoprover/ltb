...
thf(c_2EprimeFactor_2EPRIME__FACTORS_2E2,type,(
    c_2EprimeFactor_2EPRIME__FACTORS_2E2: du > du > u )).
...
thf(thm_2EprimeFactor_2EPRIME__FACTORS__1,axiom,
    ( ( mono_2Ec_2EprimeFactor_2EPRIME__FACTORS @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) )
...
thf(thm_2EprimeFactor_2EPRIME__FACTORS__EXP,conjecture,(
    ! [V0p: mono_2Etyop_2Enum_2Enum,V1e: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Edivides_2Eprime @ V0p )
     => ( ( mono_2Ec_2EprimeFactor_2EPRIME__FACTORS @ ( mono_2Ec_2Earithmetic_2EEXP @ V0p @ V1e ) @ V0p )
        = V1e ) ) )).
