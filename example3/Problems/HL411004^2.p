...
thf(conj_thm_2Ereal__topology_2EBOUNDED__EMPTY,lemma,(
    p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) )).

thf(conj_thm_2Ereal__topology_2EBOUNDED__UNION,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__BIGUNION,conjecture,(
    ! [V0f: $i] :
     ...
     => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0f ) )
       ...
       => ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V0f ) ) ) ) ) )).
