...
thf(f13208_0_2E0,type,(
    f13208_0_2E0: u )).

thf(f13208_0_2E1,type,(
    f13208_0_2E1: du > u )).

thf(f13208_0_2E2,type,(
...
thf(arityeq1_2Emono_2Ef13208_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Erealax_2Ereal] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f13208_0_2E1 @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X0 ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Erealax_2Ereal @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ f13208_0_2E0 ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ef13208_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Erealax_2Ereal,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f13208_0_2E2 @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X0 ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Erealax_2Ereal @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ f13208_0_2E0 ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X0 ) ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ELIM__CONST__EQ,axiom,(
    ! [A_27a: d,V1c: mono_2Etyop_2Erealax_2Ereal,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f13208_0_2E2 @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V1c ) ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
      = V1c ) )).

thf(thm_2Ereal__topology_2ELIM__CONST__EQ,conjecture,(
    ! [A_27a: d,V0net_2E0: u,V1c: mono_2Etyop_2Erealax_2Ereal,V2d: mono_2Etyop_2Erealax_2Ereal] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2E_2D_2D_3E_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f13208_0_2E1 @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V1c ) ) ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V2d ) ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) )
    <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Etrivial__limit_2E1 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) )
        | ( V1c = V2d ) ) ) )).
