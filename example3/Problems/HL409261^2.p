...
thf(conj_thm_2Eintegral_2EREAL__POW__MONO,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2x: tp__ty_2Erealax_2Ereal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) )
        & ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) )
     => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).

thf(conj_thm_2Eintegral_2EREAL__LE__INV2,lemma,(
...
thf(conj_thm_2Eintegral_2ERSUM__DIFF__BOUND,lemma,(
...
thf(conj_thm_2Ereal_2EREAL__NEG__THIRD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Etransc_2EGAUGE__MIN,lemma,(
    ! [V0E: $i] :
     ...
     => ! [V1g1: $i] :
         ...
         => ! [V2g2: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Etransc_2Egauge @ V0E ) @ V1g1 ) )
               ...
               => ( p
                  @ ( ap @ ( ap @ c_2Etransc_2Egauge @ V0E )
                    @ ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V3x: $i] :
                          ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ V1g1 @ V3x ) ) @ ( ap @ V2g2 @ V3x ) ) ) @ ( ap @ V1g1 @ V3x ) ) @ ( ap @ V2g2 @ V3x ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Etransc_2EFINE__MIN,lemma,(
    ! [V0g1: $i] :
     ...
     => ! [V1g2: $i] :
         ...
         => ! [V2D: $i] :
             ...
             => ! [V3p: $i] :
                 ...
                 => ( ( p
                      @ ( ap
                        @ ( ap @ c_2Etransc_2Efine
                          @ ( lam @ ty_2Erealax_2Ereal
                            @ ^ [V4x: $i] :
                                ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ V0g1 @ V4x ) ) @ ( ap @ V1g2 @ V4x ) ) ) @ ( ap @ V0g1 @ V4x ) ) @ ( ap @ V1g2 @ V4x ) ) ) )
                        @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V2D ) @ V3p ) ) )
...
thf(conj_thm_2Eintegral_2EINTEGRABLE__LIMIT,conjecture,(
    ! [V0f: $i] :
