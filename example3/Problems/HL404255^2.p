         ...
         => ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2EDecode_2Edec2enc @ A_27a ) @ V0d ) @ V1x ) )
            = ( surj__c_ty_2Elist_2Elist_o
              @ ( ap @ ( c_2Emin_2E_40 @ ( ty_2Elist_2Elist @ bool ) )
                @ ( lam @ ( ty_2Elist_2Elist @ bool )
                  @ ^ [V2l: $i] :
                      ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) @ ( ap @ V0d @ V2l ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) @ V1x ) @ ( c_2Elist_2ENIL @ bool ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2EDecode_2Edec2enc__some,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1d: $i] :
          ( ( mem @ V1d @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) )
