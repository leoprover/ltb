...
thf(thm_2EOmega__Automata_2EBUECHI__PROP__REDUCTION,conjecture,(
     ...
     => ( ? [V6i_2E0: u,V7q_2E0: u] :
      ...
      <=> ? [V11x0: mono_2Etyop_2Enum_2Enum,V12l: mono_2Etyop_2Enum_2Enum,V13j_2E0: u,V14p_2E0: u] :
            ...
            & ! [V15t: mono_2Etyop_2Enum_2Enum] :
                ( ( mono_2Ec_2Eprim__rec_2E_3C @ V15t @ ( mono_2Ec_2Earithmetic_2E_2B @ V11x0 @ V12l ) )
               => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27state @ A_27state ) ) @ tyop_2Emin_2Ebool ) @ V0TransRel_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27state @ A_27state ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V13j_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V15t ) ) ) ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27state @ A_27state ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27state @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27state ) @ V14p_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V15t ) ) ) ) @ ( s @ A_27state @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27state ) @ V14p_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2B @ V15t @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
            & ? [V16t: mono_2Etyop_2Enum_2Enum] :
                ( ( mono_2Ec_2Eprim__rec_2E_3C @ V16t @ V12l )
                & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27state @ tyop_2Emin_2Ebool ) @ V2Accept_2E0 ) @ ( s @ A_27state @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27state ) @ V14p_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2B @ V11x0 @ V16t ) ) ) ) ) ) ) ) )
            & ( ( s @ A_27state @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27state ) @ V14p_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V11x0 ) ) ) )
              = ( s @ A_27state @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27state ) @ V14p_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2B @ V11x0 @ V12l ) ) ) ) ) ) ) ) ) )).
