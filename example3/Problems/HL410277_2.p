...
tff(conj_thm_2Eextreal_2Epow__0,lemma,(
...
tff(conj_thm_2Eextreal_2Epow__1,lemma,(
...
tff(conj_thm_2Eextreal_2Epow__add,lemma,(
...
tff(conj_thm_2Eextreal_2Epow__not__infty,lemma,(
...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__MUL,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
...
tff(lmtp_f3591,type,(
    f3591: ( del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f3591,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0n: tp__ty_2Enum_2Enum] : mem(f3591(A_27a,V2f,V0n),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f3591,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0n: tp__ty_2Enum_2Enum,V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f3591(A_27a,V2f,V0n),V4x) = ap(ap(c_2Eextreal_2Eextreal__pow,ap(V2f,V4x)),inj__ty_2Enum_2Enum(V0n)) ) ) )).

tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__POW,conjecture,(
         ...
         => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V1a))
              ...
              & ! [V3x: $i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Emeasure_2Espace(A_27a),V1a)))
                   => ( surj__ty_2Eextreal_2Eextreal(ap(V2f,V3x)) != fo__c_2Eextreal_2ENegInf
                      & surj__ty_2Eextreal_2Eextreal(ap(V2f,V3x)) != fo__c_2Eextreal_2EPosInf ) ) ) )
