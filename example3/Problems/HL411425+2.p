...
fof(conj_thm_2Ereal__topology_2EIN__COMPONENTS__NONEMPTY,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECOMPONENTS__EQ__SING,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EIN__COMPONENTS__SELF,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
