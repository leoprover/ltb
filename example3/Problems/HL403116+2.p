...
fof(lameq_f923,axiom,(
    ! [V1b] :
     ...
     => ! [V5t] :
          ( mem(V5t,ty_2Enum_2Enum)
         => ap(f923(V1b),V5t) = ap(c_2Ebool_2E_7E,ap(V1b,V5t)) ) ) )).

fof(lamtp_f922,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f922,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t] :
              ( mem(V2t,ty_2Enum_2Enum)
             => ap(f922(V0a,V1b),V2t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f893(V1b)),f900(V0a,V1b)),V2t)),ap(ap(c_2ETemporal__Logic_2EALWAYS,f923(V1b)),V2t)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EWHEN__AS__SUNTIL,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
