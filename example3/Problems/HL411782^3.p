...
thf(thm_2Ereal__topology_2EINFSUM__RESTRICT,conjecture,(
    ! [V0k: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2Einfsum @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum )
        @ ^ [V2n: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V2n @ V0k ) @ ( V1a @ V2n ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
      = ( c_2Ereal__topology_2Einfsum @ V0k @ V1a ) ) )).
