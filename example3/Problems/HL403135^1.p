...
thf(f3716_0_2E0,type,(
    f3716_0_2E0: u )).

thf(f3716_0_2E2,type,(
    f3716_0_2E2: du > du > u )).

thf(f3716_0_2E3,type,(
...
thf(mono_2Ef3716_0,type,(
    mono_2Ef3716_0: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(thm_2ETemporal__Logic_2EUNTIL__EVENT,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ...
      = ( mono_2Ec_2ETemporal__Logic_2EUNTIL @ ( mono_2Ef3716_0 @ V1a @ V0b ) @ V0b ) ) )).
