...
thf(conj_thm_2Ereal__topology_2EINTERIOR__HALFSPACE__GE,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
     ...
     => ( ( ap @ c_2Ereal__topology_2Einterior
        ...
        = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V3x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V3x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__gt @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V3x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__HALFSPACE__COMPONENT__GE,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ...
      = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V2x: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__gt @ V2x ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) ) ) )).
