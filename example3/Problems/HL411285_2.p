...
tff(conj_thm_2Ereal__topology_2EPASTING__LEMMA__CLOSED,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EPASTING__LEMMA__EXISTS__CLOSED,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,arr(ty_2Erealax_2Ereal,bool)))
                   ...
                   => ? [V9g: $i] :
                        ...
                        & ! [V10x: tp__ty_2Erealax_2Ereal,V11i: $i] :
                           ...
                           => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V11i),V3k))
                             ...
                             => surj__ty_2Erealax_2Ereal(ap(V9g,inj__ty_2Erealax_2Ereal(V10x))) = surj__ty_2Erealax_2Ereal(ap(ap(V0f,V11i),inj__ty_2Erealax_2Ereal(V10x))) ) ) ) ) ) ) ) ) )).
