...
tff(conj_thm_2Epred__set_2EFORALL__IN__BIGUNION,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1s: $i] :
...
tff(conj_thm_2Ecardinal_2ECOUNTABLE__CROSS,lemma,(
...
tff(conj_thm_2Ecardinal_2ECOUNTABLE__AS__IMAGE__SUBSET__EQ,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2Ecountable(A_27a),V0s))
      <=> ? [V1f: $i] :
...
tff(conj_thm_2Ecardinal_2ECOUNTABLE__BIGUNION,conjecture,(
    ! [A_27a: del,V0A: $i] :
