    ...
    ! [A_27a,V0d] :
     ...
     => ! [V1x] :
         ...
         => ! [V2l] :
             ...
             => ap(f1726(A_27a,V0d,V1x),V2l) = ap(ap(c_2Emin_2E_3D(ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))),ap(V0d,V2l)),ap(c_2Eoption_2ESOME(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),c_2Elist_2ENIL(bool)))) ) ) ) )).
...
fof(ax_thm_2EDecode_2Edec2enc__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0d] :
         ...
         => ! [V1x] :
              ( mem(V1x,A_27a)
             => ap(ap(c_2EDecode_2Edec2enc(A_27a),V0d),V1x) = ap(c_2Emin_2E_40(ty_2Elist_2Elist(bool)),f1726(A_27a,V0d,V1x)) ) ) ) )).

fof(conj_thm_2EDecode_2Edec2enc__some,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
