...
tff(conj_thm_2Ereal__topology_2EOPEN__INTERVAL__RIGHT,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2EOpen,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3265(V0a)))) )).

tff(lmtp_f3909,type,(
    f3909: $i )).

tff(lamtp_f3909,axiom,(
    mem(f3909,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3909,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f3909,inj__ty_2Erealax_2Ereal(V0x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0x)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x))) )).

tff(conj_thm_2Ereal__topology_2EOPEN__POSITIVE__ORTHANT,conjecture,(
    p(ap(c_2Ereal__topology_2EOpen,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3909))) )).
