...
fof(conj_thm_2EindexedLists_2ELIST__RELi__EL__EQN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ( p(ap(ap(ap(c_2EindexedLists_2ELIST__RELi(A_27a,A_27a),V0R),V1l1),V2l2))
                      <=> ( ap(c_2Elist_2ELENGTH(A_27a),V1l1) = ap(c_2Elist_2ELENGTH(A_27b),V2l2)
                          & ! [V3i] :
                             ...
                             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V3i),ap(c_2Elist_2ELENGTH(A_27a),V1l1)))
                               => p(ap(ap(ap(V0R,V3i),ap(ap(c_2Elist_2EEL(A_27a),V3i),V1l1)),ap(ap(c_2Elist_2EEL(A_27b),V3i),V2l2))) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2EindexedLists_2ELIST__RELi__APPEND__I,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2l2] :
                     ...
                     => ! [V3m1] :
                         ...
                         => ! [V4m2] :
                             ...
                             => ( ( p(ap(ap(ap(c_2EindexedLists_2ELIST__RELi(A_27a,A_27a),V0R),V1l1),V2l2))
                                  & p(ap(ap(ap(c_2EindexedLists_2ELIST__RELi(A_27a,A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0R),ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(A_27a),V1l1)))),V3m1),V4m2)) )
                               => p(ap(ap(ap(c_2EindexedLists_2ELIST__RELi(A_27a,A_27a),V0R),ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),V3m1)),ap(ap(c_2Elist_2EAPPEND(A_27b),V2l2),V4m2))) ) ) ) ) ) ) ) ) )).
