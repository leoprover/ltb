...
thf(ax_thm_2EerrorStateMonad_2EES__GUARD__DEF,axiom,(
    ! [A_27a: del,V0b: $o] :
      ( ( ap @ ( c_2EerrorStateMonad_2EES__GUARD @ A_27a ) @ ( inj__o @ V0b ) )
      = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ ty_2Eone_2Eone @ A_27a ) ) ) ) @ ( inj__o @ V0b ) ) @ ( ap @ ( c_2EerrorStateMonad_2EUNIT @ A_27a @ ty_2Eone_2Eone ) @ ( inj__ty_2Eone_2Eone @ fo__c_2Eone_2Eone ) ) ) @ ( c_2EerrorStateMonad_2EES__FAIL @ ( ty_2Epair_2Eprod @ ty_2Eone_2Eone @ A_27a ) @ A_27a ) ) ) )).
...
thf(conj_thm_2EerrorStateMonad_2EBIND__ESGUARD,conjecture,(
    ! [A_27a: del,A_27b: del,V0fM: $i] :
      ( ( mem @ V0fM @ ( arr @ ty_2Eone_2Eone @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) ) ) ) )
     => ( ( ( ap @ ( ap @ ( c_2EerrorStateMonad_2EBIND @ A_27a @ ty_2Eone_2Eone @ A_27b ) @ ( ap @ ( c_2EerrorStateMonad_2EES__GUARD @ A_27a ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) ) @ V0fM )
          = ( c_2EerrorStateMonad_2EES__FAIL @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27a ) )
        & ( ( ap @ ( ap @ ( c_2EerrorStateMonad_2EBIND @ A_27a @ ty_2Eone_2Eone @ A_27b ) @ ( ap @ ( c_2EerrorStateMonad_2EES__GUARD @ A_27a ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) ) @ V0fM )
