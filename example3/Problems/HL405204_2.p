...
tff(conj_thm_2Ealist_2Ealist__to__fmap__to__alist__PERM,lemma,(
...
tff(conj_thm_2Ealist_2EPERM__fmap__to__alist,lemma,(
...
tff(conj_thm_2Ealist_2Ealist__to__fmap__PERM,conjecture,(
    ! [A_27a: del,A_27b: del,V0l1: $i] :
     ...
     => ! [V1l2: $i] :
         ...
         => ( ( p(ap(ap(c_2Esorting_2EPERM(ty_2Epair_2Eprod(A_27a,A_27a)),V0l1),V1l2))
              & p(ap(c_2Elist_2EALL__DISTINCT(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0l1))) )
           => ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V0l1) = ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V1l2) ) ) ) )).
