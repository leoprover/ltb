...
fof(conj_thm_2EprimeFactor_2EPRIME__FACTORS__1,lemma,(
...
fof(conj_thm_2EprimeFactor_2EPRIME__FACTORS__MULT,lemma,(
    ! [V0a] :
...
fof(conj_thm_2EprimeFactor_2EFACTORS__prime,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Enum_2Enum)
     => ( p(ap(c_2Edivides_2Eprime,V0p))
...
fof(conj_thm_2EprimeFactor_2EPRIME__FACTORS__EXP,conjecture,(
    ! [V0p] :
      ( mem(V0p,ty_2Enum_2Enum)
     => ! [V1e] :
