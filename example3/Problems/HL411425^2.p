...
thf(conj_thm_2Ereal__topology_2EIN__COMPONENTS__NONEMPTY,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EIN__COMPONENTS__SELF,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V0s ) ) )
      <=> ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V0s ) )
          & ( V0s
           != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) )).
