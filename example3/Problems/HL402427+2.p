...
fof(conj_thm_2ElistRange_2EMEM__listRangeLHI,lemma,(
    ! [V0x] :
...
fof(conj_thm_2ElistRange_2ElistRangeLHI__EMPTY,lemma,(
    ! [V0hi] :
...
fof(conj_thm_2ElistRange_2ElistRangeLHI__CONS,lemma,(
    ! [V0lo] :
...
fof(conj_thm_2ElistRange_2ElistRangeLHI__ALL__DISTINCT,conjecture,(
    ! [V0lo] :
      ( mem(V0lo,ty_2Enum_2Enum)
     => ! [V1hi] :
          ( mem(V1hi,ty_2Enum_2Enum)
