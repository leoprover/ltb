...
thf(f1795_0_2E0,type,(
    f1795_0_2E0: u )).

thf(f1795_0_2E1,type,(
    f1795_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef1795_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ A_27a @ ( f1795_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ f1795_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Epred__set_2ESURJ__ID,axiom,(
    ! [A_27a: d,V1x_2E0: u] :
      ( ( s @ A_27a @ ( f1795_0_2E1 @ ( s @ A_27a @ V1x_2E0 ) ) )
      = ( s @ A_27a @ V1x_2E0 ) ) )).

thf(thm_2Epred__set_2ESURJ__ID,conjecture,(
    ! [A_27a: d,V0s_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2ESURJ_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ f1795_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) ) )).
