...
tff(conj_thm_2Eposet_2Eglb__pred,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1r: $i] :
          ( mem(V1r,arr(A_27a,arr(A_27a,bool)))
         => ! [V2p: $i] :
             ...
             => ! [V3x: $i] :
                  ( mem(V3x,A_27a)
                 => ( p(ap(ap(ap(c_2Eposet_2Eglb(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0s),V1r)),f166(A_27a,V0s,V2p)),V3x))
                  <=> p(ap(ap(ap(c_2Eposet_2Eglb(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0s),V1r)),V2p),V3x)) ) ) ) ) ) )).
