...
thf(conj_thm_2Eset__relation_2Efinite__strict__linear__order__has__maximal,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Eset__relation_2Efinite__linear__order__has__maximal,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1r: $i] :
          ( ( mem @ V1r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
