...
thf(conj_thm_2Ewhile_2EWHILE__INDUCTION,lemma,(
    ! [A_27a: del,V0B: $i] :
...
thf(conj_thm_2Ewhile_2EWHILE__RULE,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1R: $i] :
                        ...
                        @ ( ap
                          @ ( ap
                            @ ( ap @ ( c_2Ewhile_2EHOARE__SPEC @ A_27a @ A_27a )
                              @ ( lam @ A_27a
                                @ ^ [V5s: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V5s ) ) @ ( ap @ V2B @ V5s ) ) ) )
                            @ V3C )
                          @ V0P ) )
                     => ( p
                        @ ( ap @ ( ap @ ( ap @ ( c_2Ewhile_2EHOARE__SPEC @ A_27a @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( c_2Ewhile_2EWHILE @ A_27a ) @ V2B ) @ V3C ) )
                          @ ( lam @ A_27a
                            @ ^ [V6s: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V6s ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2B @ V6s ) ) ) ) ) ) ) ) ) ) ) ) )).
