...
fof(conj_thm_2Erich__list_2EREPLICATE__APPEND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1a] :
             ...
             => ! [V2m] :
                 ...
                 => ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Erich__list_2EREPLICATE(A_27a),V0n),V1a)),ap(ap(c_2Erich__list_2EREPLICATE(A_27a),V2m),V1a)) = ap(ap(c_2Erich__list_2EREPLICATE(A_27a),ap(ap(c_2Earithmetic_2E_2B,V0n),V2m)),V1a) ) ) ) ) )).
