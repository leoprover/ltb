...
fof(conj_thm_2Ereal__topology_2ELIMPT__APPROACHABLE__LE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1s] :
...
fof(conj_thm_2Ereal__topology_2EAT,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2EEVENTUALLY__WITHIN__LE,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
