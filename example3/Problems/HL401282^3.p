...
thf(thm_2Ebit_2ELESS__EQ__EXP__MULT,conjecture,(
    ! [V0a: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum] :
     ...
     => ? [V2p: tyop_2Enum_2Enum] :
          ( ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1b )
          = ( c_2Earithmetic_2E_2A @ V2p @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0a ) ) ) ) )).
