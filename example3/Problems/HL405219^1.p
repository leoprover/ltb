...
thf(f5997_0_2E0,type,(
    f5997_0_2E0: u )).

thf(f5997_0_2E1,type,(
    f5997_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef5997_0_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( f5997_0_2E1 @ ( s @ A_27b @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ f5997_0_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Ealist_2Eflookup__fupdate__list,axiom,(
    ! [A_27b: d,V3v_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( f5997_0_2E1 @ ( s @ A_27b @ V3v_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ V3v_2E0 ) ) ) ) )).

thf(thm_2Ealist_2Eflookup__fupdate__list,axiom,(
    ! [A_27a: d,A_27b: d,V0l_2E0: u,V1k_2E0: u,V2m_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE__LIST_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2m_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0l_2E0 ) ) ) @ ( s @ A_27a @ V1k_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Elist_2EREVERSE_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0l_2E0 ) ) ) @ ( s @ A_27a @ V1k_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2m_2E0 ) @ ( s @ A_27a @ V1k_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ f5997_0_2E0 ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFLOOKUP__EMPTY,axiom,(
    ! [A_27a: d,A_27b: d,V0k_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ c_2Efinite__map_2EFEMPTY_2E0 ) @ ( s @ A_27b @ V0k_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) )).
...
thf(thm_2Ealist_2Emem__to__flookup,conjecture,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1y_2E0: u,V2l_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EALL__DISTINCT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ c_2Epair_2EFST_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V2l_2E0 ) ) ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ A_27b @ V1y_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V2l_2E0 ) ) ) ) ) ) )
     => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE__LIST_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ c_2Efinite__map_2EFEMPTY_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V2l_2E0 ) ) ) @ ( s @ A_27a @ V0x_2E0 ) ) )
