...
thf(f3697_0_2E0,type,(
    f3697_0_2E0: u )).

thf(f3697_0_2E1,type,(
    f3697_0_2E1: du > u )).

thf(f3697_0_2E2,type,(
    f3697_0_2E2: du > du > u )).

thf(f3697_1_2E0,type,(
    f3697_1_2E0: u )).

thf(f3697_1_2E1,type,(
    f3697_1_2E1: du > u )).

thf(f3697_1_2E2,type,(
    f3697_1_2E2: du > du > u )).

thf(f3697_2_2E0,type,(
    f3697_2_2E0: u )).

thf(f3697_2_2E2,type,(
    f3697_2_2E2: du > du > u )).

thf(f3697_2_2E3,type,(
...
thf(mono_2Ef3697_0,type,(
    mono_2Ef3697_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3697_1,type,(
    mono_2Ef3697_1: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3697_2,type,(
    mono_2Ef3697_2: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EWHEN__AS__SUNTIL,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V5t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3697_1 @ V0b @ V5t )
    <=> ( (~) @ ( V0b @ V5t ) ) ) )).

thf(def1_2Ethm_2ETemporal__Logic_2EWHEN__AS__SUNTIL,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3697_0 @ V0b @ V3t )
    <=> ( (~) @ ( V0b @ V3t ) ) ) )).

thf(def2_2Ethm_2ETemporal__Logic_2EWHEN__AS__SUNTIL,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V4t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3697_2 @ V1a @ V0b @ V4t )
    <=> ( ( V1a @ V4t )
        & ( V0b @ V4t ) ) ) )).
...
thf(thm_2ETemporal__Logic_2EWHEN__AS__SUNTIL,conjecture,(
    ...
    <=> ( ( mono_2Ec_2ETemporal__Logic_2ESUNTIL @ ( mono_2Ef3697_0 @ V0b ) @ ( mono_2Ef3697_2 @ V1a @ V0b ) @ V2x )
        | ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ ( mono_2Ef3697_1 @ V0b ) @ V2x ) ) ) )).
