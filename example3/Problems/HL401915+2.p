...
fof(conj_thm_2Earithmetic_2EMULT__EXP__MONO,lemma,(
    ! [V0p] :
...
fof(conj_thm_2Earithmetic_2ENOT__EXP__0,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Enumeral__bit_2ENUMERAL__TIMES__2EXP,conjecture,
    ( ! [V0n] :
        ( mem(V0n,ty_2Enum_2Enum)
