...
fof(conj_thm_2Elist_2ETAKE__APPEND2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
          ( mem(V0l1,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2Erich__list_2ETAKE__EL__SNOC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
         ...
         => ! [V1n] :
             ...
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V1n),ap(c_2Elist_2ELENGTH(A_27a),V0ls)))
               => ap(ap(c_2Elist_2ETAKE(A_27a),ap(ap(c_2Earithmetic_2E_2B,V1n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V0ls) = ap(ap(c_2Elist_2ESNOC(A_27a),ap(ap(c_2Elist_2EEL(A_27a),V1n),V0ls)),ap(ap(c_2Elist_2ETAKE(A_27a),V1n),V0ls)) ) ) ) ) )).
