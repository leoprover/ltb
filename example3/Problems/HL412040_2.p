...
tff(conj_thm_2Elebesgue_2Eintegrable__indicator,lemma,(
    ! [A_27a: del,V0m: $i] :
...
tff(conj_thm_2Elebesgue_2Eintegral__indicator,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Elebesgue_2Eintegral__cmul,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V2c: tp__ty_2Erealax_2Ereal] :
             ...
             => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),f4198(A_27a,V1f,V2c))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,inj__ty_2Erealax_2Ereal(V2c))),ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),V1f))) ) ) ) )).

tff(conj_thm_2Elebesgue_2Eintegral__cmul__indicator,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2c: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))) )
             => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),f4149(A_27a,V1s,V2c))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2ENormal,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2c)),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s)))) ) ) ) )).
