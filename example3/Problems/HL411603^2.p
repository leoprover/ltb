...
thf(conj_thm_2Ereal__topology_2ELIM__WITHIN__UNION,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal,V3s: $i] :
          ( ( mem @ V3s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ! [V4t: $i] :
              ( ( mem @ V4t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Erealax_2Ereal ) @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ V3s ) @ V4t ) ) ) )
              <=> ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Erealax_2Ereal ) @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) @ V3s ) ) )
                  & ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Erealax_2Ereal ) @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) @ V4t ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__UNION__LOCAL,conjecture,(
    ! [V0t: $i] :
