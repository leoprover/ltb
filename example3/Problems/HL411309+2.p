...
fof(lamtp_f3913,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => mem(f3913(V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

fof(lameq_f3913,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V2x] :
          ( mem(V2x,ty_2Erealax_2Ereal)
         => ap(f3913(V0a),V2x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),ap(ap(c_2Ereal_2Ereal__gt,V2x),V0a)) ) ) )).

fof(conj_thm_2Ereal__topology_2EINTERIOR__HALFSPACE__COMPONENT__GE,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ap(c_2Ereal__topology_2Einterior,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3901(V0a))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3913(V0a)) ) )).
