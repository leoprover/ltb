...
tff(conj_thm_2Ecardinal_2ECARD__MUL__FINITE,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__MUL__LT__LEMMA,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
         => ! [V2u: $i] :
             ...
             => ( ( p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V0s),V1t))
               ...
               => ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27c,A_27c),V2u),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s),V1t))) ) ) ) ) )).
