...
tff(conj_thm_2Esptree_2Edomain__mapi,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(A_27b,A_27a)))
     => ! [V1pt: $i] :
          ( mem(V1pt,ty_2Esptree_2Espt(A_27b))
         => ap(c_2Esptree_2Edomain(A_27a),ap(ap(c_2Esptree_2Emapi(A_27a,A_27a),V0f),V1pt)) = ap(c_2Esptree_2Edomain(A_27b),V1pt) ) ) )).
