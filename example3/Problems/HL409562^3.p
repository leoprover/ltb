...
thf(thm_2Elift__ieee_2Efloat__sub__relative,axiom,(
    ! [A_27t: $tType,A_27w: $tType,V0a: tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w,V1b: tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w] :
      ( ( ( c_2Ebinary__ieee_2Efloat__is__finite @ A_27t @ A_27w @ V0a )
        ...
        & ( c_2Elift__ieee_2Enormalizes @ A_27t @ A_27w @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27t @ A_27w ) ) @ ( c_2Ereal_2Ereal__sub @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V0a ) @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V1b ) ) ) )
     => ( ( c_2Ebinary__ieee_2Efloat__is__finite @ A_27t @ A_27w @ ( c_2Epair_2ESND @ tyop_2Ebinary__ieee_2Eflags @ ( tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w ) @ ( c_2Ebinary__ieee_2Efloat__sub @ A_27t @ A_27w @ c_2Ebinary__ieee_2EroundTiesToEven @ V0a @ V1b ) ) )
        & ? [V2e: tyop_2Erealax_2Ereal] :
            ...
            & ( ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ ( c_2Epair_2ESND @ tyop_2Ebinary__ieee_2Eflags @ ( tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w ) @ ( c_2Ebinary__ieee_2Efloat__sub @ A_27t @ A_27w @ c_2Ebinary__ieee_2EroundTiesToEven @ V0a @ V1b ) ) )
              = ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__sub @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V0a ) @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V1b ) ) @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2e ) ) ) ) ) ) )).
    ...
    ! [V0a: tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ),V1b: tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) )] :
     ...
     => ( ( c_2Emachine__ieee_2Efp32__isFinite @ ( c_2Emachine__ieee_2Efp32__sub @ c_2Ebinary__ieee_2EroundTiesToEven @ V0a @ V1b ) )
        & ? [V2e: tyop_2Erealax_2Ereal] :
            ...
            & ( ( c_2Emachine__ieee_2Efp32__to__real @ ( c_2Emachine__ieee_2Efp32__sub @ c_2Ebinary__ieee_2EroundTiesToEven @ V0a @ V1b ) )
              = ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__sub @ ( c_2Emachine__ieee_2Efp32__to__real @ V0a ) @ ( c_2Emachine__ieee_2Efp32__to__real @ V1b ) ) @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2e ) ) ) ) ) ) )).
