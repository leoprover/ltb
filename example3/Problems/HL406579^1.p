...
thf(arityeq2_2Emono_2Ec_2Esptree_2Einter_2E2_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27a ) ) ) @ c_2Esptree_2Einter_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Esptree_2Ewf__inter,axiom,(
    ! [A_27a: d,A_27b: d,V0m1_2E0: u,V1m2_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esptree_2Ewf_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0m1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ V1m2_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Esptree_2Einter__eq,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0t1_2E0: u,V1t2_2E0: u,V2t3_2E0: u,V3t4_2E0: u] :
      ( ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ V1t2_2E0 ) ) )
        = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V2t3_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V3t4_2E0 ) ) ) )
    <=> ! [V4x: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ V1t2_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V2t3_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V3t4_2E0 ) ) ) ) ) ) ) )).
