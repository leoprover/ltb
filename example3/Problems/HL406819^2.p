...
thf(tp_c_2Etc_2ETC__ITER,type,(
    c_2Etc_2ETC__ITER: del > $i )).

thf(mem_c_2Etc_2ETC__ITER,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Etc_2ETC__MOD__LEM,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
             ...
             => ! [V3f: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x ) @ ( ap @ ( c_2Efinite__map_2EFDOM @ A_27a @ ( arr @ A_27a @ bool ) ) @ V3f ) ) )
                      & ( ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ V1s )
                        = ( ap @ ( c_2Etc_2EFMAP__TO__RELN @ A_27a ) @ V3f ) ) )
                   => ( ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V2x ) @ V1s ) )
                      = ( ap @ ( c_2Etc_2EFMAP__TO__RELN @ A_27a ) @ ( ap @ ( ap @ ( c_2Efinite__map_2Eo__f @ A_27a @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( ap @ ( c_2Etc_2ETC__MOD @ A_27a ) @ V2x ) @ ( ap @ ( ap @ ( c_2Efinite__map_2EFAPPLY @ A_27a @ ( arr @ A_27a @ bool ) ) @ V3f ) @ V2x ) ) ) @ V3f ) ) ) ) ) ) ) ) )).

thf(ax_thm_2Etc_2ETC__ITER,axiom,(
    ! [A_27a: del] :
      ( ! [V0r: $i] :
          ( ( mem @ V0r @ ( ty_2Efinite__map_2Efmap @ A_27a @ ( arr @ A_27a @ bool ) ) )
         => ( ( ap @ ( ap @ ( c_2Etc_2ETC__ITER @ A_27a ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ V0r )
            = V0r ) )
      & ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ! [V2d: $i] :
             ...
             => ! [V3r: $i] :
                 ...
                 => ( ( ap @ ( ap @ ( c_2Etc_2ETC__ITER @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V1x ) @ V2d ) ) @ V3r )
                    = ( ap @ ( ap @ ( c_2Etc_2ETC__ITER @ A_27a ) @ V2d ) @ ( ap @ ( ap @ ( c_2Efinite__map_2Eo__f @ A_27a @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( ap @ ( c_2Etc_2ETC__MOD @ A_27a ) @ V1x ) @ ( ap @ ( ap @ ( c_2Efinite__map_2EFAPPLY @ A_27a @ ( arr @ A_27a @ bool ) ) @ V3r ) @ V1x ) ) ) @ V3r ) ) ) ) ) ) ) )).

thf(conj_thm_2Etc_2ETC__ITER__THM,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1d: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( ( ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ V3s ) @ ( ap @ ( c_2Elist_2ELIST__TO__SET @ A_27a ) @ V1d ) )
                        = ( ap @ ( c_2Efinite__map_2EFDOM @ A_27a @ ( arr @ A_27a @ bool ) ) @ V2f ) )
                      & ( ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ V3s )
                        = ( ap @ ( c_2Etc_2EFMAP__TO__RELN @ A_27a ) @ V2f ) ) )
                   => ( ( ap @ ( c_2Erelation_2ETC @ A_27a ) @ V0R )
                      = ( ap @ ( c_2Etc_2EFMAP__TO__RELN @ A_27a ) @ ( ap @ ( ap @ ( c_2Etc_2ETC__ITER @ A_27a ) @ V1d ) @ V2f ) ) ) ) ) ) ) ) )).
