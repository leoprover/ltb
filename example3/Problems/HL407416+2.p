...
fof(conj_thm_2Ereal_2ESUM__POS,lemma,(
    ! [V0f] :
...
fof(lameq_f2730,axiom,(
    ! [V0f] :
     ...
     => ! [V3m] :
         ...
         => ap(f2730(V0f),V3m) = ap(c_2Ereal_2Eabs,ap(V0f,V3m)) ) ) )).

fof(lamtp_f2731,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
fof(lameq_f2731,axiom,(
    ! [V0f] :
     ...
     => ! [V4m] :
         ...
         => ap(f2731(V0f),V4m) = ap(c_2Ereal_2Eabs,ap(V0f,V4m)) ) ) )).

fof(conj_thm_2Ereal_2ESUM__ABS,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m] :
         ...
         => ! [V2n] :
             ...
             => ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1m),V2n)),f2730(V0f))) = ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1m),V2n)),f2731(V0f)) ) ) ) )).
