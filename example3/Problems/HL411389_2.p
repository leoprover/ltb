...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__SYM__EQ,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V2y)))
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__EQ,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
          ( ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V2y))
        <=> ( ( ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),V0s))
