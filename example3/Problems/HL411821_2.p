...
tff(conj_thm_2Ereal__topology_2EDIST__LE__0,lemma,(
...
tff(lmtp_f4058,type,(
    f4058: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f4058,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f4058(V1a,V2x,V0s),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f4058,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3y: tp__ty_2Erealax_2Ereal] : ap(f4058(V1a,V2x,V0s),inj__ty_2Erealax_2Ereal(V3y)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3y)),V0s)),ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2x)))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V3y))))) ) )).

tff(lmtp_f4057,type,(
    f4057: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f4057,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f4057(V1a,V0s),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f4057,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f4057(V1a,V0s),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),V0s)),ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f4058(V1a,V2x,V0s))) ) )).

tff(ax_thm_2Ereal__topology_2Eclosest__point,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),inj__ty_2Erealax_2Ereal(V1a))) = surj__ty_2Erealax_2Ereal(ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f4057(V1a,V0s))) ) )).

tff(conj_thm_2Ereal__topology_2ECLOSEST__POINT__SELF,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
