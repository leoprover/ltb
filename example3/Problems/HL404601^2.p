...
thf(stp_fo_c_2Estring_2EisHexDigit,type,(
    fo__c_2Estring_2EisHexDigit: tp__ty_2Estring_2Echar > $o )).

thf(stp_eq_fo_c_2Estring_2EisHexDigit,axiom,(
    ! [X0: tp__ty_2Estring_2Echar] :
      ( ( inj__o @ ( fo__c_2Estring_2EisHexDigit @ X0 ) )
      = ( ap @ c_2Estring_2EisHexDigit @ ( inj__ty_2Estring_2Echar @ X0 ) ) ) )).
...
thf(stp_fo_c_2Estring_2EisLower,type,(
    fo__c_2Estring_2EisLower: tp__ty_2Estring_2Echar > $o )).

thf(stp_eq_fo_c_2Estring_2EisLower,axiom,(
    ! [X0: tp__ty_2Estring_2Echar] :
      ( ( inj__o @ ( fo__c_2Estring_2EisLower @ X0 ) )
      = ( ap @ c_2Estring_2EisLower @ ( inj__ty_2Estring_2Echar @ X0 ) ) ) )).
...
thf(conj_thm_2EASCIInumbers_2EHEX__UNHEX,conjecture,(
    ! [V0c: tp__ty_2Estring_2Echar] :
      ( ( p @ ( ap @ c_2Estring_2EisHexDigit @ ( inj__ty_2Estring_2Echar @ V0c ) ) )
