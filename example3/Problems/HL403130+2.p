...
fof(lameq_f937,axiom,(
    ! [V0b] :
     ...
     => ! [V5t] :
          ( mem(V5t,ty_2Enum_2Enum)
         => ap(f937(V0b),V5t) = ap(c_2Ebool_2E_7E,ap(V0b,V5t)) ) ) )).

fof(lamtp_f938,axiom,(
    ! [V1a] :
...
fof(lameq_f938,axiom,(
    ! [V1a] :
     ...
     => ! [V10t] :
         ...
         => ap(f938(V1a),V10t) = ap(c_2Ebool_2E_7E,ap(V1a,V10t)) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EBEFORE__SIMP,conjecture,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
