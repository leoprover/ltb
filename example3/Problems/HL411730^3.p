...
thf(c_2Ereal__topology_2Elim__def,type,(
    c_2Ereal__topology_2Elim__def: 
      !>[A_27a: $tType] :
        ( ( tyop_2Ereal__topology_2Enet @ A_27a ) > ( A_27a > tyop_2Erealax_2Ereal ) > tyop_2Erealax_2Ereal ) )).
...
thf(thm_2Ereal__topology_2ESUMS__LIM,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o] :
      ( ( c_2Ereal__topology_2Esums @ V0f
        @ ( c_2Ereal__topology_2Elim__def @ tyop_2Enum_2Enum @ c_2Ereal__topology_2Esequentially
          @ ^ [V2n: tyop_2Enum_2Enum] :
              ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V1s @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V2n ) ) @ V0f ) )
        @ V1s )
