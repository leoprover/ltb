...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__OPEN__PREIMAGE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EOPEN__HALFSPACE__COMPONENT__GT,lemma,(
...
tff(conj_thm_2Ereal__topology_2ESEPARATION__CLOSURES,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
