...
tff(mem_c_2Ewords_2Ebit__count,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Ebit__count(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Enum_2Enum)) )).
...
tff(conj_thm_2Ewords_2Eword__eq__0,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2Ebit__count__is__zero,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
