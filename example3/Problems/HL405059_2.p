...
tff(conj_thm_2ETemporal__Logic_2EBEFORE__SIGNAL,lemma,(
    ! [V0a: $i] :
...
tff(conj_thm_2EOmega__Automata_2ECO__BUECHI__BEFORE__CLOSURE,conjecture,(
             ...
             => ! [V3Psi: $i] :
                 ...
                 => ! [V4phi: $i] :
                     ...
                     => ! [V5t0: tp__ty_2Enum_2Enum,V6c: $i] :
                          ( mem(V6c,A_27b)
                         => ( p(ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f2037(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi)),V4phi),inj__ty_2Enum_2Enum(V5t0)))
                          <=> ? [V12p1: $i] :
