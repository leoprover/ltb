...
thf(thm_2Elist_2Elazy__list__case__compute,conjecture,(
    ! [A_27a: $tType,A_27b: $tType] :
      ...
      = ( ^ [V0l: tyop_2Elist_2Elist @ A_27a,V1b: A_27b,V2f: A_27a > ( tyop_2Elist_2Elist @ A_27a ) > A_27b] :
            ( c_2Ebool_2ECOND @ A_27b @ ( c_2Elist_2ENULL @ A_27a @ V0l ) @ V1b @ ( V2f @ ( c_2Elist_2EHD @ A_27a @ V0l ) @ ( c_2Elist_2ETL @ A_27a @ V0l ) ) ) ) ) )).
