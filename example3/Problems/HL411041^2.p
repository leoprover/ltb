...
thf(conj_thm_2Ereal__topology_2ECOMPACT__REAL__LEMMA,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1b: tp__ty_2Erealax_2Ereal] :
          ( ! [V2n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) )
              ...
              & ! [V7e: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ? [V8N: tp__ty_2Enum_2Enum] :
                    ! [V9n: tp__ty_2Enum_2Enum] :
                     ...
                     => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0s @ ( ap @ V4r @ ( inj__ty_2Enum_2Enum @ V9n ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V7e ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__LEMMA,conjecture,(
    ! [A_27a: del,V0x: $i] :
