...
fof(lamtp_f2019,axiom,(
    ! [A_27a,V1p] :
      ( mem(V1p,arr(A_27a,bool))
     => mem(f2019(A_27a,V1p),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) )).

fof(lameq_f2019,axiom,(
    ! [A_27a,V1p] :
      ( mem(V1p,arr(A_27a,bool))
     => ! [V4x] :
          ( mem(V4x,A_27a)
         => ap(f2019(A_27a,V1p),V4x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4x),ap(V1p,V4x)) ) ) )).

fof(conj_thm_2Etopology_2EHULL__INDUCT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(arr(A_27a,bool),bool))
             ...
             => ! [V2s] :
                 ...
                 => ( ( ! [V3x] :
                         ...
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2s))
                           => p(ap(V1p,V3x)) ) )
                      & p(ap(V0P,ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f2019(A_27a,V1p)))) )
                   => ! [V5x] :
                        ( mem(V5x,A_27a)
