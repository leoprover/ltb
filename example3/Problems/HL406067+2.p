...
fof(lamtp_f2195,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => mem(f2195(V2n),arr(bool,bool)) ) )).
...
fof(lameq_f2195,axiom,(
    ! [V2n] :
     ...
     => ! [V5v] :
          ( mem(V5v,bool)
         => ap(f2195(V2n),V5v) = ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),V2n),V5v)) ) ) )).

fof(lamtp_f2194,axiom,(
    mem(f2194,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

fof(lameq_f2194,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => ap(f2194,V2n) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,f2195(V2n))))) ) )).
...
fof(lamtp_f2201,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => ! [V3z] :
          ( mem(V3z,bool)
         => mem(f2201(V2n,V3z),arr(bool,bool)) ) ) )).
...
fof(lameq_f2201,axiom,(
    ! [V2n] :
     ...
     => ! [V3z] :
         ...
         => ! [V5v] :
              ( mem(V5v,bool)
             => ap(f2201(V2n,V3z),V5v) = ap(ap(c_2Ebool_2E_5C_2F,V3z),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),V2n),V5v))) ) ) ) )).

fof(lamtp_f2200,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => mem(f2200(V2n),arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) ) )).
...
fof(lameq_f2200,axiom,(
    ! [V2n] :
     ...
     => ! [V3z] :
          ( mem(V3z,bool)
         => ap(f2200(V2n),V3z) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,f2201(V2n,V3z))) ) ) )).

fof(lamtp_f2199,axiom,(
    mem(f2199,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

fof(lameq_f2199,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => ap(f2199,V2n) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2200(V2n)) ) )).
...
fof(conj_thm_2Ewords_2EWORD__EQ__SUB__RADD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0v] :
          ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2EWORD__NOT__LESS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
