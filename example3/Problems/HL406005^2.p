...
thf(conj_thm_2Ewords_2EASR__ADD,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
          ( ( ap @ ( ap @ ( c_2Ewords_2Eword__asr @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__asr @ A_27a ) @ V0w ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) )
          = ( ap @ ( ap @ ( c_2Ewords_2Eword__asr @ A_27a ) @ V0w ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) )).
