...
thf(conj_thm_2Ealist_2Ealookup__distinct__reverse,lemma,(
...
thf(conj_thm_2Ealist_2Eflookup__fupdate__list,lemma,(
    ! [A_27a: del,A_27b: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) )
     => ! [V1k: $i] :
          ( ( mem @ V1k @ A_27a )
...
thf(conj_thm_2Ealist_2Emem__to__flookup,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1y: $i] :
          ( ( mem @ V1y @ A_27b )
