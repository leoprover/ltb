...
tff(conj_thm_2Ebinary__ieee_2EULP__le__mono,lemma,(
    ! [A_27a: del,A_27t: del,V0e1: $i] :
      ( mem(V0e1,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1e2: $i] :
          ( mem(V1e2,ty_2Efcp_2Ecart(bool,bool))
         => ( V1e2 != ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))
...
tff(conj_thm_2Ebinary__ieee_2Eulp__lt__ULP,conjecture,(
