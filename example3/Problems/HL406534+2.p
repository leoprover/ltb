...
fof(mem_c_2Ewords_2Eword__ror__bv,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__ror__bv(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).
    ...
    ! [A_27a,V1m] :
     ...
     => ! [V2k] :
         ...
         => ! [V0w] :
             ...
             => ! [V3a] :
                  ( mem(V3a,bool)
                 => mem(f2329(A_27a,V1m,V2k,V0w,V3a),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
...
fof(lamtp_f2328,axiom,(
    ! [A_27a,V1m] :
     ...
     => ! [V2k] :
         ...
         => ! [V0w] :
              ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
             => mem(f2328(A_27a,V1m,V2k,V0w),arr(bool,arr(ty_2Enum_2Enum,bool))) ) ) ) )).
    ...
    ! [A_27a,V1m] :
     ...
     => ! [V2k] :
         ...
         => ! [V0w] :
             ...
             => ! [V3a] :
                  ( mem(V3a,bool)
                 => ap(f2328(A_27a,V1m,V2k,V0w),V3a) = f2329(A_27a,V1m,V2k,V0w,V3a) ) ) ) ) )).

fof(lamtp_f2327,axiom,(
    ! [A_27a,V0w] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1m] :
          ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2327(A_27a,V0w,V1m),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f2327,axiom,(
    ! [A_27a,V0w] :
     ...
     => ! [V1m] :
         ...
         => ! [V2k] :
              ( mem(V2k,ty_2Enum_2Enum)
             => ap(f2327(A_27a,V0w,V1m),V2k) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Enum_2Enum,ty_2Enum_2Enum),f2328(A_27a,V1m,V2k,V0w)),c_2Ebool_2EF),ap(c_2Erich__list_2ECOUNT__LIST,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) ) )).

fof(conj_thm_2Eblast_2Eword__ror__bv__expand,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1m] :
              ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
             => ap(ap(c_2Ewords_2Eword__ror__bv(A_27a),V0w),V1m) = ap(c_2Efcp_2EFCP(bool,bool),f2327(A_27a,V0w,V1m)) ) ) ) )).
