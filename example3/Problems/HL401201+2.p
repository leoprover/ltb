...
fof(conj_thm_2Egcd_2EGCD__REF,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Egcd_2EGCD__ADD__R__THM,lemma,
    ( ! [V0a] :
        ( mem(V0a,ty_2Enum_2Enum)
       => ! [V1b] :
            ( mem(V1b,ty_2Enum_2Enum)
...
fof(conj_thm_2Egcd_2EGCD__SUCfree__ind,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Egcd_2ELINEAR__GCD,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
