...
thf(conj_thm_2Ereal__topology_2EOPEN__MAP__IMP__QUOTIENT__MAP,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__MONOTONE__QUOTIENT__PREIMAGE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EOPEN__MAP__RESTRICT,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                              ...
                              @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal )
                                @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean )
                                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                    @ ( lam @ ty_2Erealax_2Ereal
                                      @ ^ [V6x: $i] :
                                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V6x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V6x ) ) @ V3t_27 ) ) ) ) ) ) )
                              @ V5u ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__OPEN__MONOTONE__PREIMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                     ...
                     => ( p
                        @ ( ap @ c_2Ereal__topology_2Econnected
                          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                            @ ( lam @ ty_2Erealax_2Ereal
                              @ ^ [V5x: $i] :
                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V5x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V5x ) ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) ) ) ) ) ) ) )
               => ! [V6c: $i] :
                     ...
                     => ( p
                        @ ( ap @ c_2Ereal__topology_2Econnected
                          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                            @ ( lam @ ty_2Erealax_2Ereal
                              @ ^ [V7x: $i] :
                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V7x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V7x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V7x ) ) @ V6c ) ) ) ) ) ) ) ) ) ) ) ) ) )).
