...
fof(conj_thm_2Ereal__topology_2EINTERVAL__SUBSET__IS__INTERVAL,lemma,(
    ! [V0s] :
     ...
     => ! [V1a] :
         ...
         => ! [V2b] :
             ...
             => ( p(ap(c_2Ereal__topology_2Eis__interval,V0s))
               => ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))),V0s))
                <=> ( ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                    | ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1a),V0s))
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2b),V0s)) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EINTERVAL__CONTAINS__COMPACT__NEIGHBOURHOOD,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
           ...
           => ? [V2a] :
                ...
                & ? [V3b] :
                    ...
                    & ? [V4d] :
                        ...
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))))
