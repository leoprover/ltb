...
fof(conj_thm_2Esptree_2Enum__set__domain__eq,conjecture,(
    ! [V0t1] :
      ( mem(V0t1,ty_2Esptree_2Espt(ty_2Eone_2Eone))
     => ! [V1t2] :
          ( mem(V1t2,ty_2Esptree_2Espt(ty_2Eone_2Eone))
         => ( ( p(ap(c_2Esptree_2Ewf(ty_2Eone_2Eone),V0t1))
              & p(ap(c_2Esptree_2Ewf(ty_2Eone_2Eone),V1t2)) )
           => ( ap(c_2Esptree_2Edomain(ty_2Eone_2Eone),V0t1) = ap(c_2Esptree_2Edomain(ty_2Eone_2Eone),V1t2)
            <=> V0t1 = V1t2 ) ) ) ) )).
