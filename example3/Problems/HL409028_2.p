...
tff(conj_thm_2Ecomplex_2ECOMPLEX__OF__REAL__ADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(ap(c_2Ecomplex_2Ecomplex__add,ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V1y)))) = surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__real,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))) )).

tff(conj_thm_2Ecomplex_2ECOMPLEX__OF__REAL__NEG,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__neg,ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V0x)))) = surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__real,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x)))) )).

tff(conj_thm_2Ecomplex_2ECOMPLEX__OF__REAL__SUB,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(ap(c_2Ecomplex_2Ecomplex__sub,ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V1y)))) = surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__real,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))) )).
