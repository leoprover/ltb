...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__NEG,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SUB,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V0f),V2s))
                  & p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V1g),V2s)) )
               => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,f2910(V0f,V1g)),V2s)) ) ) ) ) )).
