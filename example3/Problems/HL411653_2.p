...
tff(conj_thm_2Ereal__topology_2EOPEN__MAP__FROM__COMPOSITION__INJECTIVE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
                     ...
                     => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s)),V3t))
                          ...
                          & ! [V5x: tp__ty_2Erealax_2Ereal,V6y: tp__ty_2Erealax_2Ereal] :
                              ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V3t))
                                ...
                                & surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Erealax_2Ereal(V5x))) = surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Erealax_2Ereal(V6y))) )
                             => V5x = V6y )
                          & ! [V7k: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__FROM__COMPOSITION__INJECTIVE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
