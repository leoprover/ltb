...
tff(lmtp_f813,type,(
    f813: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f813,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : mem(f813(V0n),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).

tff(lameq_f813,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V2n_27: tp__ty_2Enum_2Enum] : ap(f813(V0n),inj__ty_2Enum_2Enum(V2n_27)) = ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2n_27)),inj__ty_2Enum_2Enum(V0n)) )).

tff(conj_thm_2Erich__list_2ECOUNT__LIST__ADD,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] : surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(ap(c_2Erich__list_2ECOUNT__LIST,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1m)))) = surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(ap(ap(c_2Elist_2EAPPEND(ty_2Enum_2Enum),ap(c_2Erich__list_2ECOUNT__LIST,inj__ty_2Enum_2Enum(V0n))),ap(ap(c_2Elist_2EMAP(ty_2Enum_2Enum,ty_2Enum_2Enum),f813(V0n)),ap(c_2Erich__list_2ECOUNT__LIST,inj__ty_2Enum_2Enum(V1m))))) )).
