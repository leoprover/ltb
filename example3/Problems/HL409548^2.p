...
thf(conj_thm_2Eutil__prob_2EMINIMAL__SUC,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1p: $i] :
     ...
     => ( ( ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
      ...
      <=> ( ~ ( p @ ( ap @ V1p @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
          & ( V0n
            = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Eutil__prob_2Eminimal @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ bool @ ty_2Enum_2Enum ) @ V1p ) @ c_2Enum_2ESUC ) ) ) )
          & ( p @ ( ap @ V1p @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) ) )).

thf(conj_thm_2Eutil__prob_2EMINIMAL__SUC__IMP,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1p: $i] :
      ( ( mem @ V1p @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ( ( ( p @ ( ap @ V1p @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
          & ~ ( p @ ( ap @ V1p @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
