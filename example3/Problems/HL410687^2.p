...
thf(conj_thm_2Ereal__topology_2EREAL__WLOG__LE,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__REAL__LEMMA,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__SEGMENT,conjecture,
    ( ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
