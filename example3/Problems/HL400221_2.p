...
tff(mem_c_2EnormalForms_2EEXT__POINT,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2EnormalForms_2EEXT__POINT(A_27a,A_27a),arr(arr(A_27a,A_27b),arr(arr(A_27a,A_27b),A_27a))) )).
...
tff(conj_thm_2EnormalForms_2EEXT__POINT,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,A_27b))
