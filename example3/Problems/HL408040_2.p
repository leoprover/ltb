...
tff(conj_thm_2Eseq_2ETRIANGLE__2D__NUM,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ( ! [V1d: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] : p(ap(ap(V0P,inj__ty_2Enum_2Enum(V2n)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1d)),inj__ty_2Enum_2Enum(V2n))))
