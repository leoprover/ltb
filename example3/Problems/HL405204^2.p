...
thf(conj_thm_2Ealist_2Ealist__to__fmap__to__alist__PERM,lemma,(
...
thf(conj_thm_2Ealist_2EPERM__fmap__to__alist,lemma,(
...
thf(conj_thm_2Esorting_2EALL__DISTINCT__PERM,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Ealist_2Ealist__to__fmap__PERM,conjecture,(
