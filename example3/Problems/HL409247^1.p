...
thf(f10768_0_2E0,type,(
    f10768_0_2E0: u )).

thf(f10768_0_2E1,type,(
    f10768_0_2E1: du > u )).

thf(f10768_0_2E2,type,(
    f10768_0_2E2: du > du > u )).

thf(f10768_1_2E0,type,(
    f10768_1_2E0: u )).

thf(f10768_1_2E2,type,(
    f10768_1_2E2: du > du > u )).

thf(f10769_0_2E0,type,(
    f10769_0_2E0: u )).

thf(f10769_0_2E1,type,(
    f10769_0_2E1: du > u )).

thf(f10769_0_2E2,type,(
    f10769_0_2E2: du > du > u )).

thf(f10769_1_2E0,type,(
    f10769_1_2E0: u )).

thf(f10769_1_2E2,type,(
...
thf(mono_2Ef10768_0,type,(
    mono_2Ef10768_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef10768_1,type,(
    mono_2Ef10768_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef10769_0,type,(
    mono_2Ef10769_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef10769_1,type,(
    mono_2Ef10769_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Eintegral_2EDINT__DELTA__LEFT,axiom,(
    ! [V2x: mono_2Etyop_2Erealax_2Ereal,V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef10768_1 @ V2x @ V0a )
    <=> ( V2x = V0a ) ) )).

thf(def1_2Ethm_2Eintegral_2EDINT__DELTA__LEFT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef10768_0 @ V0a @ V2x )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef10768_1 @ V2x @ V0a ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).

thf(thm_2Eintegral_2EDINT__DELTA__LEFT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Etransc_2EDint @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0a @ V1b ) @ ( mono_2Ef10768_0 @ V0a ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )).

thf(def0_2Ethm_2Eintegral_2EDINT__DELTA__RIGHT,axiom,(
    ! [V2x: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef10769_1 @ V2x @ V1b )
    <=> ( V2x = V1b ) ) )).

thf(def1_2Ethm_2Eintegral_2EDINT__DELTA__RIGHT,axiom,(
    ! [V1b: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef10769_0 @ V1b @ V2x )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef10769_1 @ V2x @ V1b ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).

thf(thm_2Eintegral_2EDINT__DELTA__RIGHT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Etransc_2EDint @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0a @ V1b ) @ ( mono_2Ef10769_0 @ V1b ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )).
