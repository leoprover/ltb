...
thf(c_2EreaderMonad_2EUNIT_2E0,type,(
    c_2EreaderMonad_2EUNIT_2E0: u )).

thf(c_2EreaderMonad_2EUNIT_2E1,type,(
    c_2EreaderMonad_2EUNIT_2E1: du > u )).

thf(c_2EreaderMonad_2EUNIT_2E2,type,(
...
thf(arityeq2_2Emono_2Ec_2EreaderMonad_2EBIND_2E2_2Emono_2EA_27c_20mono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2EreaderMonad_2EBIND_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ X1_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ec_2EreaderMonad_2EUNIT_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27a @ ( c_2EreaderMonad_2EUNIT_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ c_2EreaderMonad_2EUNIT_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2EreaderMonad_2EUNIT_2E1_2Emono_2EA_27c_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ ( c_2EreaderMonad_2EUNIT_2E1 @ ( s @ A_27c @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) ) @ c_2EreaderMonad_2EUNIT_2E0 ) @ ( s @ A_27c @ X0_2E0 ) ) ) ) )).
...
thf(thm_2EreaderMonad_2EUNIT__def,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1s_2E0: u] :
      ( ( s @ A_27a @ ( c_2EreaderMonad_2EUNIT_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ A_27b @ V1s_2E0 ) ) )
      = ( s @ A_27a @ V0x_2E0 ) ) )).

thf(thm_2EreaderMonad_2EBIND__UNITL,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0x_2E0: u,V1f_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2EreaderMonad_2EBIND_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ ( c_2EreaderMonad_2EUNIT_2E1 @ ( s @ A_27c @ V0x_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V1f_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V1f_2E0 ) @ ( s @ A_27c @ V0x_2E0 ) ) ) ) )).
