...
thf(f3685_0_2E0,type,(
    f3685_0_2E0: u )).

thf(f3685_0_2E1,type,(
    f3685_0_2E1: du > u )).

thf(f3685_1_2E0,type,(
    f3685_1_2E0: u )).

thf(f3685_1_2E2,type,(
    f3685_1_2E2: du > du > u )).

thf(f3685_2_2E0,type,(
    f3685_2_2E0: u )).

thf(f3685_2_2E2,type,(
    f3685_2_2E2: du > du > u )).
...
thf(mono_2Ef3685_0,type,(
    mono_2Ef3685_0: ( mono_2Etyop_2Enum_2Enum > $o ) > $o )).

thf(mono_2Ef3685_1,type,(
    mono_2Ef3685_1: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > $o )).

thf(mono_2Ef3685_2,type,(
    mono_2Ef3685_2: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EWHEN__SWHEN__LEMMA,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ef3685_0 @ V0b )
    <=> ! [V2t1: mono_2Etyop_2Enum_2Enum] :
        ? [V3t2: mono_2Etyop_2Enum_2Enum] :
          ( V0b @ ( mono_2Ec_2Earithmetic_2E_2B @ V3t2 @ V2t1 ) ) ) )).

thf(def1_2Ethm_2ETemporal__Logic_2EWHEN__SWHEN__LEMMA,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ef3685_2 @ V1a @ V0b )
    <=> ? [V5t1: mono_2Etyop_2Enum_2Enum] :
        ! [V6t2: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ V1a @ V0b @ ( mono_2Ec_2Earithmetic_2E_2B @ V6t2 @ V5t1 ) )
          & ( (~) @ ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ V1a @ V0b @ ( mono_2Ec_2Earithmetic_2E_2B @ V6t2 @ V5t1 ) ) ) ) ) )).

thf(def2_2Ethm_2ETemporal__Logic_2EWHEN__SWHEN__LEMMA,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ef3685_1 @ V1a @ V0b )
    <=> ! [V4t0: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ V1a @ V0b @ V4t0 )
          = ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ V1a @ V0b @ V4t0 ) ) ) )).

thf(thm_2ETemporal__Logic_2EWHEN__SWHEN__LEMMA,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ef3685_0 @ V0b ) @ ( mono_2Ef3685_1 @ V1a @ V0b ) @ ( mono_2Ef3685_2 @ V1a @ V0b ) ) )).
