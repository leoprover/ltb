...
tff(conj_thm_2Erich__list_2EBUTLASTN__TAKE,lemma,(
...
tff(lmtp_f818,type,(
    f818: ( del * tp__ty_2Enum_2Enum * tp__o * $i ) > $i )).

tff(lamtp_f818,axiom,(
...
tff(lameq_f818,axiom,(
    ! [A_27a: del,V1n: tp__ty_2Enum_2Enum,V0longer_20than_20list: tp__o,V2l: $i] :
      ( mem(V2l,ty_2Elist_2Elist(A_27a))
     => ! [V3m: tp__ty_2Enum_2Enum] : ap(f818(A_27a,V1n,V0longer_20than_20list,V2l),inj__ty_2Enum_2Enum(V3m)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(A_27a)),ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(V3m))),ap(ap(c_2Elist_2ETAKE(A_27a),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V1n))),V2l)),ap(ap(ap(ap(c_2Ecombin_2EFAIL(arr(ty_2Enum_2Enum,arr(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a))),arr(ty_2Enum_2Enum,arr(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)))),c_2Erich__list_2EBUTLASTN(A_27a)),inj__o(V0longer_20than_20list)),inj__ty_2Enum_2Enum(V1n)),V2l)) ) )).

tff(conj_thm_2Erich__list_2EBUTLASTN__compute,conjecture,(
    ! [A_27a: del,V0longer_20than_20list: tp__o,V1n: tp__ty_2Enum_2Enum,V2l: $i] :
      ( mem(V2l,ty_2Elist_2Elist(A_27a))
     => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),inj__ty_2Enum_2Enum(V1n)),V2l) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f818(A_27a,V1n,V0longer_20than_20list,V2l)),ap(c_2Elist_2ELENGTH(A_27a),V2l)) ) )).
