...
thf(thm_2Emeasure_2EIN__MEASURABLE__BOREL__MUL,axiom,(
...
thf(thm_2Emeasure_2EIN__MEASURABLE__BOREL__POW,conjecture,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V2f: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V1a )
        & ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ V2f @ ( c_2Emeasure_2Emeasurable @ A_27a @ tyop_2Eextreal_2Eextreal @ V1a @ c_2Emeasure_2EBorel ) )
        & ! [V3x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3x @ ( c_2Emeasure_2Espace @ A_27a @ V1a ) )
           => ( ( (~)
                @ ( ( V2f @ V3x )
                  = c_2Eextreal_2ENegInf ) )
              & ( (~)
     ...
     => ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal )
        @ ^ [V4x: A_27a] :
            ( c_2Eextreal_2Eextreal__pow @ ( V2f @ V4x ) @ V0n )
        @ ( c_2Emeasure_2Emeasurable @ A_27a @ tyop_2Eextreal_2Eextreal @ V1a @ c_2Emeasure_2EBorel ) ) ) )).
