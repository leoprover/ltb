...
tff(conj_thm_2Equotient__list_2ELENGTH__PRS,conjecture,(
         ...
         => ! [V2rep: $i] :
             ...
             => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
               => ! [V3l: $i] :
                   ...
                   => surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27b),V3l)) = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V2rep),V3l))) ) ) ) ) ) )).
