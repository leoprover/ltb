...
fof(mem_c_2Ewhile_2EHOARE__SPEC,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Ewhile_2EHOARE__SPEC(A_27a,A_27a),arr(arr(A_27a,bool),arr(arr(A_27a,A_27b),arr(arr(A_27b,bool),bool)))) ) ) )).
...
fof(conj_thm_2Ewhile_2EWHILE__INDUCTION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0B] :
...
fof(conj_thm_2Ewhile_2EWHILE__RULE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
