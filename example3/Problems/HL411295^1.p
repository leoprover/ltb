...
thf(f13524_0_2E0,type,(
    f13524_0_2E0: u )).

thf(f13524_0_2E1,type,(
    f13524_0_2E1: du > u )).

thf(f13524_0_2E2,type,(
    f13524_0_2E2: du > du > u )).

thf(f13524_1_2E0,type,(
    f13524_1_2E0: u )).

thf(f13524_1_2E2,type,(
    f13524_1_2E2: du > du > u )).

thf(f13525_0_2E0,type,(
    f13525_0_2E0: u )).

thf(f13525_0_2E2,type,(
    f13525_0_2E2: du > du > u )).

thf(f13525_0_2E3,type,(
    f13525_0_2E3: du > du > du > u )).

thf(f13525_1_2E0,type,(
    f13525_1_2E0: u )).

thf(f13525_1_2E3,type,(
...
thf(mono_2Ef13524_0,type,(
    mono_2Ef13524_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13524_1,type,(
    mono_2Ef13524_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef13525_0,type,(
    mono_2Ef13525_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13525_1,type,(
    mono_2Ef13525_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2ECLOSED__HYPERPLANE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13525_1 @ V0a @ V2x @ V1b )
    <=> ( ( mono_2Ec_2Erealax_2Ereal__mul @ V0a @ V2x )
        = V1b ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ECLOSED__HYPERPLANE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13525_0 @ V0a @ V1b @ V2x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V2x @ ( mono_2Ef13525_1 @ V0a @ V2x @ V1b ) ) ) )).

thf(thm_2Ereal__topology_2ECLOSED__HYPERPLANE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal__topology_2EClosed @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13525_0 @ V0a @ V1b ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ECLOSED__STANDARD__HYPERPLANE,axiom,(
    ! [V1x: mono_2Etyop_2Erealax_2Ereal,V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13524_1 @ V1x @ V0a )
    <=> ( V1x = V0a ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ECLOSED__STANDARD__HYPERPLANE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13524_0 @ V0a @ V1x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V1x @ ( mono_2Ef13524_1 @ V1x @ V0a ) ) ) )).

thf(thm_2Ereal__topology_2ECLOSED__STANDARD__HYPERPLANE,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal__topology_2EClosed @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13524_0 @ V0a ) ) ) )).
