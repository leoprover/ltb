...
fof(conj_thm_2EOmega__Automata_2EBUECHI__PROP__REDUCTION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27state] :
          ( ne(A_27state)
                                      ...
                                      & ? [V14p] :
                                          ...
                                          & ! [V15t] :
                                             ...
                                             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V15t),ap(ap(c_2Earithmetic_2E_2B,V11x0),V12l)))
                                               => p(ap(V1TransRel,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V13j,V15t)),ap(ap(c_2Epair_2E_2C(A_27state,A_27state),ap(V14p,V15t)),ap(V14p,ap(ap(c_2Earithmetic_2E_2B,V15t),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))) ) )
                                          & ? [V16t] :
