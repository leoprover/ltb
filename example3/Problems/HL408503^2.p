...
thf(conj_thm_2Ebinary__ieee_2EULP__le__mono,lemma,(
    ! [A_27a: del,A_27t: del,V0e1: $i] :
      ( ( mem @ V0e1 @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1e2: $i] :
          ( ( mem @ V1e2 @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ( ( V1e2
             != ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
           => ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( c_2Ebinary__ieee_2EULP @ A_27t @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) @ ( ty_2Ebool_2Eitself @ A_27t ) ) @ V0e1 ) @ ( c_2Ebool_2Ethe__value @ A_27t ) ) ) ) @ ( ap @ ( c_2Ebinary__ieee_2EULP @ A_27t @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) @ ( ty_2Ebool_2Eitself @ A_27t ) ) @ V1e2 ) @ ( c_2Ebool_2Ethe__value @ A_27t ) ) ) ) )
...
thf(conj_thm_2Ebinary__ieee_2Eulp__lt__ULP,conjecture,(
