...
tff(conj_thm_2Efinite__map_2Eo__f__FRANGE,lemma,(
...
tff(conj_thm_2Efinite__map_2EIMAGE__FRANGE,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1fm: $i] :
          ( mem(V1fm,ty_2Efinite__map_2Efmap(A_27c,A_27c))
         => ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(c_2Efinite__map_2EFRANGE(A_27c,A_27c),V1fm)) = ap(c_2Efinite__map_2EFRANGE(A_27c,A_27c),ap(ap(c_2Efinite__map_2Eo__f(A_27c,A_27c,A_27c),V0f),V1fm)) ) ) )).
