...
thf(c_2Eenumeral_2Esinter_2E0,type,(
    c_2Eenumeral_2Esinter_2E0: u )).

thf(c_2Eenumeral_2Esinter_2E3,type,(
...
thf(arityeq3_2Emono_2Ec_2Eenumeral_2Esinter_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Eenumeral_2Esinter_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X2_2E0 ) ) )
...
thf(thm_2Eenumeral_2EOL__INTER__IMP,axiom,(
    ! [A_27a: d,V0cmp_2E0: u,V1l_2E0: u] :
     ...
     => ! [V2m_2E0: u] :
         ...
         => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eenumeral_2EOL_2E2 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0cmp_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Eenumeral_2Esinter_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0cmp_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2m_2E0 ) ) ) ) ) )
            & ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Eenumeral_2Esinter_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0cmp_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2m_2E0 ) ) ) ) )
              = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINTER_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2m_2E0 ) ) ) ) ) ) ) ) ) )).
...
thf(thm_2Eenumeral_2EOWL__INTER__THM,conjecture,(
    ! [A_27a: d,V0cmp_2E0: u,V1s_2E0: u,V2l_2E0: u,V3t_2E0: u,V4m_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eenumeral_2EOWL_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0cmp_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINTER_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3t_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Eenumeral_2Esinter_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0cmp_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4m_2E0 ) ) ) ) ) ) ) )).
