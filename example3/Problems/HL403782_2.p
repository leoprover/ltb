...
tff(conj_thm_2Estring_2ESTRLEN__CAT,conjecture,(
    ! [V0l1: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar,V1l2: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] : surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(ty_2Estring_2Echar),ap(ap(c_2Elist_2EAPPEND(ty_2Estring_2Echar),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V0l1)),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V1l2)))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(ty_2Estring_2Echar),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V0l1))),ap(c_2Elist_2ELENGTH(ty_2Estring_2Echar),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V1l2)))) )).
