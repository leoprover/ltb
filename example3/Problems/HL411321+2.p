...
fof(conj_thm_2Ereal__topology_2ESURJECTIVE__IMAGE__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ereal__topology_2EBOUNDED__NEGATIONS,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__LE,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ~ p(ap(c_2Ereal__topology_2Ebounded__def,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3900(V0a)))) ) )).

fof(conj_thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__GE,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
