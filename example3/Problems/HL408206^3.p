...
thf(c_2Epoly_2Ersquarefree,type,(
    c_2Epoly_2Ersquarefree: ( tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal ) > $o )).
...
thf(thm_2Epoly_2ERSQUAREFREE__ROOTS,conjecture,(
    ...
    <=> ! [V1a: tyop_2Erealax_2Ereal] :
          ...
          @ ( ( ( c_2Epoly_2Epoly @ V0p @ V1a )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
            & ( ( c_2Epoly_2Epoly @ ( c_2Epoly_2Ediff @ V0p ) @ V1a )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) ) )).
