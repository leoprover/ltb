...
fof(conj_thm_2EHolSmt_2Er138,conjecture,(
    ! [V0a] :
         ...
         => ! [V2y] :
             ...
             => ! [V3z] :
                 ...
                 => ( V0a = ap(ap(c_2Erealax_2Ereal__add,V1x),ap(ap(c_2Erealax_2Ereal__add,V2y),V3z))
                  <=> ap(ap(c_2Erealax_2Ereal__add,V1x),ap(ap(c_2Erealax_2Ereal__add,V2y),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V0a)),V3z))) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) ) )).
