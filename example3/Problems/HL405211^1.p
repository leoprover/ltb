...
thf(thm_2Ealist_2EIN__FRANGE__alist__to__fmap__suff,conjecture,(
    ! [A_27a: d,A_27b: d,V0ls_2E0: u,V1P_2E0: u] :
      ( ! [V2v_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27a ) @ c_2Epair_2ESND_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ V0ls_2E0 ) ) ) ) ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ A_27a @ V2v_2E0 ) ) ) ) )
     => ! [V3v_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFRANGE_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ ( c_2Ealist_2Ealist__to__fmap_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ V0ls_2E0 ) ) ) ) ) ) ) )
