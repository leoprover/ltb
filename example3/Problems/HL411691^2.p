...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__HYPERPLANES,lemma,(
     ...
     => ( p
        @ ( ap
          ...
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V5x: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V5x ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ V5x ) ) @ ( inj__ty_2Erealax_2Ereal @ V3d ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__HYPERPLANE__STANDARD__HYPERPLANE,conjecture,(
