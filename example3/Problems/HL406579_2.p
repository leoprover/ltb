...
tff(conj_thm_2Esptree_2Einter__eq,conjecture,(
     ...
     => ! [V1t2: $i] :
         ...
         => ! [V2t3: $i] :
             ...
             => ! [V3t4: $i] :
                 ...
                 => ( ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V0t1),V1t2) = ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V2t3),V3t4)
                  <=> ! [V4x: tp__ty_2Enum_2Enum] : ap(ap(c_2Esptree_2Elookup(A_27a),inj__ty_2Enum_2Enum(V4x)),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V0t1),V1t2)) = ap(ap(c_2Esptree_2Elookup(A_27a),inj__ty_2Enum_2Enum(V4x)),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V2t3),V3t4)) ) ) ) ) ) )).
