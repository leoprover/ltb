...
tff(conj_thm_2Eseq_2ESEQ__DIV,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0: tp__ty_2Erealax_2Ereal,V2y: $i] :
          ( mem(V2y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(lmtp_f2890,type,(
    f2890: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2890,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f2890(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f2890,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V2n: tp__ty_2Enum_2Enum] : ap(f2890(V0x),inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Enum_2Enum(V2n)) )).

tff(conj_thm_2Eseq_2EGP__FINITE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Eseq_2EGP,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
