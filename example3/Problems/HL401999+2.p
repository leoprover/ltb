...
fof(conj_thm_2Eset__relation_2Erel__to__reln__IS__UNCURRY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => c_2Eset__relation_2Erel__to__reln(A_27a,A_27a) = c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a) ) ) )).
