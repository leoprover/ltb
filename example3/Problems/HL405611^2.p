...
thf(conj_thm_2Eordinal_2Esup__preds__SUC,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ ( ap @ ( c_2Eordinal_2EordSUC @ A_27a ) @ V0a ) ) )
        = V0a ) ) )).
...
thf(conj_thm_2Eordinal_2Epreds__sup__thm,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
