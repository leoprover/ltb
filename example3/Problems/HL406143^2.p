...
thf(conj_thm_2Ewords_2Eword__abs,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( ap @ ( c_2Ewords_2Eword__abs @ A_27a ) @ V0w )
        = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V1i: $i] :
                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ V0w ) ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0w ) @ V1i ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ V0w ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ V0w ) ) @ V1i ) ) ) ) ) ) ) )).
