...
fof(conj_thm_2Ebit_2ELESS__MULT__MONO2,lemma,(
    ! [V0a] :
...
fof(mem_c_2Ewords_2Esaturate__mul,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Esaturate__mul(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).
...
fof(conj_thm_2Ewords_2ENOT__FINITE__IMP__dimword__2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ewords_2Esaturate__mul,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1b] :
              ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
             => ap(ap(c_2Ewords_2Esaturate__mul(A_27a),V0a),V1b) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a))),ap(ap(c_2Ewords_2Eword__ls(ty_2Esum_2Esum(A_27a,A_27a)),ap(c_2Ewords_2Ew2w(A_27a,A_27a),c_2Ewords_2Eword__T(A_27a))),ap(ap(c_2Ewords_2Eword__mul(ty_2Esum_2Esum(A_27a,A_27a)),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0a)),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V1b))))),c_2Ewords_2Eword__T(A_27a)),ap(ap(c_2Ewords_2Eword__mul(A_27a),V0a),V1b)) ) ) ) )).
