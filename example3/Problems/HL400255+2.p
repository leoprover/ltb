...
fof(conj_thm_2Ecombin_2EGEN__literal__case__RAND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0P] :
                 ...
                 => ! [V1f] :
                     ...
                     => ! [V2v] :
                          ( mem(V2v,A_27c)
                         => ap(V0P,ap(ap(c_2Ebool_2Eliteral__case(A_27c,A_27c),V1f),V2v)) = ap(ap(c_2Ebool_2Eliteral__case(A_27c,A_27c),ap(ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),V0P),V1f)),V2v) ) ) ) ) ) ) )).
