    ...
    ! [V2t1] :
     ...
     => ! [V0b] :
         ...
         => ! [V3t2] :
             ...
             => ap(f911(V2t1,V0b),V3t2) = ap(V0b,ap(ap(c_2Earithmetic_2E_2B,V3t2),V2t1)) ) ) ) )).

fof(lamtp_f910,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f910,axiom,(
    ! [V0b] :
     ...
     => ! [V2t1] :
          ( mem(V2t1,ty_2Enum_2Enum)
         => ap(f910(V0b),V2t1) = ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f911(V2t1,V0b)) ) ) )).

fof(lamtp_f912,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
    ...
    ! [V0b] :
     ...
     => ! [V1a] :
         ...
         => ! [V4t0] :
             ...
             => ap(f912(V0b,V1a),V4t0) = ap(ap(c_2Emin_2E_3D(bool),ap(ap(ap(c_2ETemporal__Logic_2EWHEN,V1a),V0b),V4t0)),ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V1a),V0b),V4t0)) ) ) ) )).

fof(lamtp_f914,axiom,(
    ! [V5t1] :
     ...
     => ! [V1a] :
         ...
         => ! [V0b] :
             ...
             => ! [V6t2] :
                 ...
                 => ap(f914(V5t1,V1a,V0b),V6t2) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2EWHEN,V1a),V0b),ap(ap(c_2Earithmetic_2E_2B,V6t2),V5t1))),ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V1a),V0b),ap(ap(c_2Earithmetic_2E_2B,V6t2),V5t1)))) ) ) ) ) )).

fof(lamtp_f913,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f913,axiom,(
    ! [V0b] :
     ...
     => ! [V1a] :
         ...
         => ! [V5t1] :
              ( mem(V5t1,ty_2Enum_2Enum)
             => ap(f913(V0b,V1a),V5t1) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f914(V5t1,V1a,V0b)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EWHEN__SWHEN__LEMMA,conjecture,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
