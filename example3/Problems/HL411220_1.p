...
tff(f13897_0_2E0,type,(
    f13897_0_2E0: u )).

tff(f13897_0_2E1,type,(
    f13897_0_2E1: du > u )).

tff(f13897_0_2E2,type,(
    f13897_0_2E2: ( du * du ) > u )).
...
tff(def0_2Ethm_2Ereal__topology_2ECONTINUOUS__COMPONENT__COMPOSE,axiom,(
    ! [A_27a: d,V1f_2E0: u,V3x_2E0: u] : j_mono_2Etyop_2Erealax_2Ereal(s(tyop_2Erealax_2Ereal,f13897_0_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V1f_2E0),s(A_27a,V3x_2E0)))) = j_mono_2Etyop_2Erealax_2Ereal(s(tyop_2Erealax_2Ereal,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V1f_2E0),s(A_27a,V3x_2E0)))) )).

tff(thm_2Ereal__topology_2ECONTINUOUS__COMPONENT__COMPOSE,conjecture,(
    ! [A_27a: d,A_27b: d,V0net_2E0: u,V1f_2E0: u,V2i_2E0: u] :
     ...
     => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Econtinuous_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),f13897_0_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V1f_2E0))),s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0))))) ) )).
