...
thf(conj_thm_2Elist_2EFRONT__SNOC,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1l: $i] :
...
thf(conj_thm_2Erich__list_2EBUTLASTN__SUC__FRONT,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) )
       => ( ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ V1l )
          = ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2EFRONT @ A_27a ) @ V1l ) ) ) ) ) )).
