...
fof(conj_thm_2Ereal__topology_2ELIMPT__OF__SEQUENCE__SUBSEQUENCE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
          ( mem(V1l,ty_2Erealax_2Ereal)
         => ( p(ap(ap(c_2Ereal__topology_2Elimit__point__of,V1l),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))
           => ? [V2r] :
                ...
                & ! [V3m] :
                   ...
                   => ! [V4n] :
                        ( mem(V4n,ty_2Enum_2Enum)
                       => ( p(ap(ap(c_2Eprim__rec_2E_3C,V3m),V4n))
                         => p(ap(ap(c_2Eprim__rec_2E_3C,ap(V2r,V3m)),ap(V2r,V4n))) ) ) )
                & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),V2r)),V1l),c_2Ereal__topology_2Esequentially)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESEQUENCE__UNIQUE__LIMPT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
          ( mem(V1l,ty_2Erealax_2Ereal)
