...
fof(conj_thm_2Ereal__topology_2EDIAMETER__SING,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2EDIAMETER__EQ__0,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
       => ( ap(c_2Ereal__topology_2Ediameter,V0s) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
        <=> ( V0s = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
            | ? [V1a] :
                ( mem(V1a,ty_2Erealax_2Ereal)
                & V0s = ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V1a),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) ) ) ) ) ) )).
