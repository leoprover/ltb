...
tff(conj_thm_2Elist_2EREVERSE__o__REVERSE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Elist_2Elist(A_27b)))
     => ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Elist_2EREVERSE(A_27b)),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Elist_2EREVERSE(A_27b)),V0f)) = V0f ) )).
