...
tff(conj_thm_2Ealist_2EFRANGE__alist__to__fmap__SUBSET,lemma,(
...
tff(conj_thm_2Ealist_2EIN__FRANGE__alist__to__fmap__suff,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
      ( mem(V0ls,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27b,A_27b)))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
         => ( ! [V2v: $i] :
                ( mem(V2v,A_27a)
               => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2v),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),c_2Epair_2ESND(A_27b,A_27b)),V0ls))))
                 => p(ap(V1P,V2v)) ) )
           => ! [V3v: $i] :
                ( mem(V3v,A_27a)
               => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3v),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),ap(c_2Ealist_2Ealist__to__fmap(A_27b,A_27b),V0ls))))
                 => p(ap(V1P,V3v)) ) ) ) ) ) )).
