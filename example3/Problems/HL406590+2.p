...
fof(conj_thm_2Eone_2EFORALL__ONE,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Esptree_2Esubspt__domain,conjecture,(
    ! [V0t1] :
      ( mem(V0t1,ty_2Esptree_2Espt(ty_2Eone_2Eone))
     => ! [V1t2] :
          ( mem(V1t2,ty_2Esptree_2Espt(ty_2Eone_2Eone))
         => ( p(ap(ap(c_2Esptree_2Esubspt(ty_2Eone_2Eone),V0t1),V1t2))
          <=> p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Enum_2Enum),ap(c_2Esptree_2Edomain(ty_2Eone_2Eone),V0t1)),ap(c_2Esptree_2Edomain(ty_2Eone_2Eone),V1t2))) ) ) ) )).
