...
tff(conj_thm_2Equotient__pair_2EFST__RSP,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0R1: $i] :
                   ...
                   => ! [V4abs2: $i] :
                       ...
                       => ! [V5rep2: $i] :
                           ...
                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                             => ! [V6p1: $i] :
                                  ( mem(V6p1,ty_2Epair_2Eprod(A_27a,A_27a))
                                 => ! [V7p2: $i] :
                                      ( mem(V7p2,ty_2Epair_2Eprod(A_27a,A_27a))
                                     => ( p(ap(ap(ap(ap(c_2Equotient__pair_2E_23_23_23(A_27a,A_27a,A_27a,A_27a),V0R1),V3R2),V6p1),V7p2))
                                       => p(ap(ap(V0R1,ap(c_2Epair_2EFST(A_27a,A_27a),V6p1)),ap(c_2Epair_2EFST(A_27a,A_27a),V7p2))) ) ) ) ) ) ) ) ) ) ) ) )).
