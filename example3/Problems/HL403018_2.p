...
tff(conj_thm_2EindexedLists_2ELENGTH__MAPi,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(A_27a,A_27b)))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
         => surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27b),ap(ap(c_2EindexedLists_2EMAPi(A_27b,A_27b),V0f),V1l))) = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),V1l)) ) ) )).
