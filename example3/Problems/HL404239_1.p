...
tff(arityeq2_2Ef267_0_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f267_0_2E2(s(A_27a,X0_2E0),s(A_27a,X1_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f267_0_2E0),s(A_27a,X0_2E0))),s(A_27a,X1_2E0)))) )).
...
tff(def0_2Ethm_2Ecombin_2EAPPLY__UPDATE__THM,axiom,(
    ! [A_27a: d,V1a_2E0: u,V3c_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f267_0_2E2(s(A_27a,V1a_2E0),s(A_27a,V3c_2E0)))))
    <=> s(A_27a,V1a_2E0) = s(A_27a,V3c_2E0) ) )).

tff(thm_2Ecombin_2EAPPLY__UPDATE__THM,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1a_2E0: u,V2b_2E0: u,V3c_2E0: u] : s(A_27b,c_2Ecombin_2EUPDATE_2E4(s(A_27a,V1a_2E0),s(A_27b,V2b_2E0),s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0),s(A_27a,V3c_2E0))) = s(A_27b,c_2Ebool_2ECOND_2E3(s(tyop_2Emin_2Ebool,f267_0_2E2(s(A_27a,V1a_2E0),s(A_27a,V3c_2E0))),s(A_27b,V2b_2E0),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0),s(A_27a,V3c_2E0))))) )).

tff(def0_2Ethm_2Eupdate_2EAPPLY__UPDATE__THM,axiom,(
    ! [A_27a: d,V1a_2E0: u,V3c_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f267_0_2E2(s(A_27a,V1a_2E0),s(A_27a,V3c_2E0)))))
    <=> s(A_27a,V1a_2E0) = s(A_27a,V3c_2E0) ) )).

tff(thm_2Eupdate_2EAPPLY__UPDATE__THM,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1a_2E0: u,V2b_2E0: u,V3c_2E0: u] : s(A_27b,c_2Ecombin_2EUPDATE_2E4(s(A_27a,V1a_2E0),s(A_27b,V2b_2E0),s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0),s(A_27a,V3c_2E0))) = s(A_27b,c_2Ebool_2ECOND_2E3(s(tyop_2Emin_2Ebool,f267_0_2E2(s(A_27a,V1a_2E0),s(A_27a,V3c_2E0))),s(A_27b,V2b_2E0),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0),s(A_27a,V3c_2E0))))) )).
