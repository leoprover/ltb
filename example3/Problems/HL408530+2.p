...
fof(conj_thm_2Ebinary__ieee_2Ebottom__properties,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
...
fof(conj_thm_2Ebinary__ieee_2Eround__roundTowardZero__bottom,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
...
fof(conj_thm_2Ebinary__ieee_2Efloat__round__roundTowardZero__bottom,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0b] :
             ...
             => ! [V1y] :
                 ...
                 => ! [V2x] :
                     ...
                     => ( p(ap(ap(c_2Erealax_2Ereal__lt,V2x),ap(c_2Erealax_2Ereal__neg,ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))))
                       => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),c_2Ebinary__ieee_2EroundTowardZero),V0b),V2x) = ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) ) ) )).
