...
fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__HYPERPLANES,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(lamtp_f4001,axiom,(
    ! [V2c] :
      ( mem(V2c,ty_2Erealax_2Ereal)
     => mem(f4001(V2c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).
...
fof(lameq_f4001,axiom,(
    ! [V2c] :
     ...
     => ! [V4x] :
          ( mem(V4x,ty_2Erealax_2Ereal)
         => ap(f4001(V2c),V4x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4x),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V4x),V2c)) ) ) )).

fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__HYPERPLANE__STANDARD__HYPERPLANE,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
