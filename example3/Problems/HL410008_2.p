...
tff(conj_thm_2Epred__set_2EINFINITE__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EINFINITE__INJ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eextreal_2ENUM__IN__Q,lemma,(
...
tff(conj_thm_2Eextreal_2EQ__INFINITE,conjecture,(
