...
thf(conj_thm_2Eiterate_2ESIMP__REAL__ARCH,lemma,(
...
thf(conj_thm_2Ereal__topology_2EREAL__OF__NUM__GE,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Ereal__topology_2EIN__CBALL__0,lemma,(
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__SUBSET__CBALL,lemma,(
    ! [V0s: $i] :
     ...
     => ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
       => ? [V1f: $i] :
            ...
            & ! [V2n: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ ( ap @ V1f @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) )
            & ! [V3n: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ ( ap @ V1f @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V0s ) )
            & ! [V4n: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ ( ap @ V1f @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) @ ( ap @ V1f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V4n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) )
            & ( ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal )
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V5n: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) @ ( ap @ V1f @ V5n ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V5n ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) )
              = V0s )
            & ! [V6k: $i] :
