...
tff(conj_thm_2Ereal__topology_2EBOUNDED__NEGATIONS,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__LE,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : ~ p(ap(c_2Ereal__topology_2Ebounded__def,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3900(V0a)))) )).

tff(conj_thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__GE,conjecture,(
