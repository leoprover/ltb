...
fof(lamtp_f2100,axiom,(
    ! [A_27b,A_27a,A_27a,A_27b,V2v] :
      ( mem(V2v,A_27b)
     => ! [V1k] :
          ( mem(V1k,A_27a)
...
fof(lamtp_f2099,axiom,(
    ! [A_27a,A_27a,A_27b,A_27b,V1k] :
      ( mem(V1k,A_27a)
...
fof(lamtp_f2098,axiom,(
    ! [A_27b,A_27b,A_27a,A_27a] : mem(f2098(A_27b,A_27b,A_27a,A_27a),arr(A_27a,arr(A_27b,arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a))))) )).

fof(lameq_f2098,axiom,(
    ! [A_27b,A_27b,A_27a,A_27a,V1k] :
      ( mem(V1k,A_27a)
...
fof(conj_thm_2Ealist_2EFDOM__alist__to__fmap,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
