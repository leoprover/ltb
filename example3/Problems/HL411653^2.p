...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__COMPOSE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Ereal__topology_2EOPEN__MAP__FROM__COMPOSITION__INJECTIVE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__INJECTIVE__OPEN__MAP,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__IMP__OPEN__MAP,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__FROM__COMPOSITION__INJECTIVE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                 ...
                 => ! [V4u: $i] :
                     ...
                     => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V0f ) @ V2s ) )
                          ...
                          & ! [V5x: tp__ty_2Erealax_2Ereal,V6y: tp__ty_2Erealax_2Ereal] :
                             ...
                             => ( V5x = V6y ) )
                          & ? [V7h: $i] :
                              ( ( mem @ V7h @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                              & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphism @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2s ) @ V4u ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1g ) @ V0f ) ) @ V7h ) ) ) ) )
                       => ( ? [V8f_27: $i] :
                              ( ( mem @ V8f_27 @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                              & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphism @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2s ) @ V3t ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) @ V0f ) @ V8f_27 ) ) ) )
                          & ? [V9g_27: $i] :
                              ( ( mem @ V9g_27 @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                              & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphism @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V3t ) @ V4u ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) @ V1g ) @ V9g_27 ) ) ) ) ) ) ) ) ) ) ) )).
