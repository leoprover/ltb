    ...
    ! [A_27a: del,A_27b: del,V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum,V2a: $i] :
     ...
     => ( ( ap @ ( ap @ ( ap @ ( c_2Ewords_2Ebit__field__insert @ A_27a @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0h ) ) @ ( inj__ty_2Enum_2Enum @ V1l ) ) @ V2a )
        = ( ap @ ( c_2Ewords_2Eword__modify @ A_27a )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V3i: $i] :
                ( ap @ ( ap @ ( c_2Ebool_2ECOND @ bool ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1l ) ) @ V3i ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V3i ) @ ( inj__ty_2Enum_2Enum @ V0h ) ) ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27b ) @ V2a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ V3i ) @ ( inj__ty_2Enum_2Enum @ V1l ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2Ebit__field__insert,conjecture,(
    ! [A_27a: del,A_27b: del,V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum,V2a: $i] :
              ...
              = ( ap
                @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Efcp_2Ecart @ bool @ A_27b ) @ ( ty_2Efcp_2Ecart @ bool @ A_27b ) )
                  @ ( lam @ ( ty_2Efcp_2Ecart @ bool @ A_27b )
                    @ ^ [V4mask: $i] :
                        ( ap @ ( ap @ ( c_2Ewords_2Eword__or @ A_27b ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__and @ A_27b ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27b ) @ ( ap @ ( c_2Ewords_2Ew2w @ A_27a @ A_27b ) @ V2a ) ) @ ( inj__ty_2Enum_2Enum @ V1l ) ) ) @ V4mask ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__and @ A_27b ) @ V3b ) @ ( ap @ ( c_2Ewords_2Eword__1comp @ A_27b ) @ V4mask ) ) ) ) )
