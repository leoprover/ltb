...
thf(thm_2Equotient_2EEQUIV__RES__ABSTRACT__LEFT,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0R1: A_27a > A_27a > $o,V1R2: A_27b > A_27b > $o,V2f1: A_27a > A_27b,V3f2: A_27a > A_27b,V4x1: A_27a,V5x2: A_27a] :
      ( ( ( V1R2 @ ( V2f1 @ V4x1 ) @ ( V3f2 @ V5x2 ) )
        & ( V0R1 @ V4x1 @ V4x1 ) )
     => ( V1R2 @ ( c_2Ebool_2ERES__ABSTRACT @ A_27a @ A_27b @ ( c_2Equotient_2Erespects @ A_27a @ $o @ V0R1 ) @ V2f1 @ V4x1 ) @ ( V3f2 @ V5x2 ) ) ) )).
