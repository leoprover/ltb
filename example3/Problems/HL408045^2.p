...
thf(conj_thm_2Eseq_2ESUMMABLE__LE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ c_2Eseq_2Esummable @ V0f ) )
            & ! [V2n: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ V0f ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) )
