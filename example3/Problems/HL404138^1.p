...
thf(thm_2Epath_2Eel__def__compute,conjecture,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0p_2E0: u] :
          ( ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 ) ) )
          = ( s @ A_27a @ ( c_2Epath_2Efirst_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 ) ) ) )
      & ! [V1n: mono_2Etyop_2Enum_2Enum,V2p_2E0: u] :
          ( ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1n ) ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) )
          = ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1n ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Etail_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) ) ) ) )
      & ! [V3n: mono_2Etyop_2Enum_2Enum,V4p_2E0: u] :
          ( ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V3n ) ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V4p_2E0 ) ) )
          = ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V3n ) ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Etail_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V4p_2E0 ) ) ) ) ) ) ) )).
