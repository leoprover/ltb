...
tff(conj_thm_2Ebinary__ieee_2Efloat__is__finite,lemma,(
...
tff(conj_thm_2Ebinary__ieee_2Efloat__cases__finite,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
     => ( p(ap(c_2Ebinary__ieee_2Efloat__is__nan(A_27a,A_27a),V0x))
        | p(ap(c_2Ebinary__ieee_2Efloat__is__infinite(A_27a,A_27a),V0x))
        | p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),V0x)) ) ) )).

tff(conj_thm_2Ebinary__ieee_2Efloat__cases,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
     => ( p(ap(c_2Ebinary__ieee_2Efloat__is__nan(A_27a,A_27a),V0x))
        | p(ap(c_2Ebinary__ieee_2Efloat__is__infinite(A_27a,A_27a),V0x))
