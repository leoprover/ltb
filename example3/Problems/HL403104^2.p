...
thf(conj_thm_2ETemporal__Logic_2EWHEN__SWHEN__LEMMA,conjecture,(
    ! [V0b: $i] :
                  ...
                  @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Enum_2Enum )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V2t1: $i] :
                          ...
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V3t2: $i] :
                                ( ap @ V0b @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V3t2 ) @ V2t1 ) ) ) ) ) ) )
                @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V4t0: $i] :
                        ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EWHEN @ V1a ) @ V0b ) @ V4t0 ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESWHEN @ V1a ) @ V0b ) @ V4t0 ) ) ) ) )
              @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V5t1: $i] :
                      ( ap @ ( c_2Ebool_2E_21 @ ty_2Enum_2Enum )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V6t2: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EWHEN @ V1a ) @ V0b ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V6t2 ) @ V5t1 ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESWHEN @ V1a ) @ V0b ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V6t2 ) @ V5t1 ) ) ) ) ) ) ) ) ) ) ) ) )).
