...
thf(f7989_0_2E0,type,(
    f7989_0_2E0: u )).

thf(f7989_0_2E2,type,(
    f7989_0_2E2: du > du > u )).
...
thf(mono_2Ef7989_0,type,(
    mono_2Ef7989_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Esptree_2Einsert__insert,axiom,(
    ! [V0x1: mono_2Etyop_2Enum_2Enum,V1x2: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef7989_0 @ V0x1 @ V1x2 )
    <=> ( V0x1 = V1x2 ) ) )).

thf(thm_2Esptree_2Einsert__insert,axiom,(
    ! [A_27a: d,V0x1: mono_2Etyop_2Enum_2Enum,V1x2: mono_2Etyop_2Enum_2Enum,V2v1_2E0: u,V3v2_2E0: u,V4t_2E0: u] :
      ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0x1 ) ) @ ( s @ A_27a @ V2v1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x2 ) ) @ ( s @ A_27a @ V3v2_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V4t_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef7989_0 @ V0x1 @ V1x2 ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0x1 ) ) @ ( s @ A_27a @ V2v1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V4t_2E0 ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x2 ) ) @ ( s @ A_27a @ V3v2_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0x1 ) ) @ ( s @ A_27a @ V2v1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V4t_2E0 ) ) ) ) ) ) ) ) )).

thf(thm_2Esptree_2Einsert__shadow,conjecture,(
    ! [A_27a: d,V0t_2E0: u,V1a: mono_2Etyop_2Enum_2Enum,V2b_2E0: u,V3c_2E0: u] :
      ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1a ) ) @ ( s @ A_27a @ V2b_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1a ) ) @ ( s @ A_27a @ V3c_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1a ) ) @ ( s @ A_27a @ V2b_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) ) ) )).
