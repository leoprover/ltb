...
tff(conj_thm_2Equotient__pred__set_2EINSERTR__RSP,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
                       ...
                       => ! [V5s1: $i] :
                           ...
                           => ! [V6s2: $i] :
                               ...
                               => ( ( p(ap(ap(V0R,V3x1),V4x2))
                                 ...
                                 => p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R),c_2Emin_2E_3D(bool)),ap(ap(ap(c_2Equotient__pred__set_2EINSERTR(A_27a),V0R),V3x1),V5s1)),ap(ap(ap(c_2Equotient__pred__set_2EINSERTR(A_27a),V0R),V4x2),V6s2))) ) ) ) ) ) ) ) ) ) )).
