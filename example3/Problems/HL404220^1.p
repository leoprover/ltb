...
thf(thm_2Epath_2Eokpath__unfold,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0P_2E0: u,V1m_2E0: u,V2proj_2E0: u,V3f_2E0: u,V4s_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V4s_2E0 ) ) ) )
        & ! [V5s_2E0: u,V6s_27_2E0: u,V7l_2E0: u] :
            ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V5s_2E0 ) ) ) )
              & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) ) @ V3f_2E0 ) @ ( s @ A_27a @ V5s_2E0 ) ) )
                = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V6s_27_2E0 ) @ ( s @ A_27c @ V7l_2E0 ) ) ) ) ) ) )
           => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V6s_27_2E0 ) ) ) ) )
        & ! [V8s_2E0: u,V9s_27_2E0: u,V10l_2E0: u] :
            ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V8s_2E0 ) ) ) )
              & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) ) @ V3f_2E0 ) @ ( s @ A_27a @ V8s_2E0 ) ) )
                = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V9s_27_2E0 ) @ ( s @ A_27c @ V10l_2E0 ) ) ) ) ) ) )
           => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ V1m_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2proj_2E0 ) @ ( s @ A_27a @ V8s_2E0 ) ) ) ) ) @ ( s @ A_27c @ V10l_2E0 ) ) ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2proj_2E0 ) @ ( s @ A_27a @ V9s_27_2E0 ) ) ) ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Eokpath_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ V1m_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27b @ A_27c ) @ ( c_2Epath_2Eunfold_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2proj_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) ) @ V3f_2E0 ) @ ( s @ A_27a @ V4s_2E0 ) ) ) ) ) ) ) )).
