...
tff(conj_thm_2Epath_2EfirstP__at__zero,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1p: $i] :
          ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
         => ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),V1p),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
          <=> p(ap(V0P,ap(c_2Epath_2Efirst(A_27a,A_27a),V1p))) ) ) ) )).

tff(conj_thm_2Epath_2EfirstP__at__unique,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1p: $i] :
          ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
         => ! [V2n: tp__ty_2Enum_2Enum] :
              ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),V1p),inj__ty_2Enum_2Enum(V2n)))
             => ! [V3m: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),V1p),inj__ty_2Enum_2Enum(V3m)))
                <=> V3m = V2n ) ) ) ) )).
