...
thf(thm_2Emeasure_2EMEASURE__DOWN,conjecture,(
    ! [A_27a: $tType,V0m0: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1m1: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m0 ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m0 ) ) )
        & ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m0 ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V1m1 ) )
        & ( ( c_2Emeasure_2Emeasure @ A_27a @ V0m0 )
          = ( c_2Emeasure_2Emeasure @ A_27a @ V1m1 ) )
