...
thf(conj_thm_2Ereal__topology_2ELIMPT__APPROACHABLE__LE,lemma,(
...
thf(conj_thm_2Ereal__topology_2EAT,lemma,(
...
thf(conj_thm_2Ereal__topology_2EEVENTUALLY__WITHIN__LE,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
