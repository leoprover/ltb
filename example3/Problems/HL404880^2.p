...
thf(ax_thm_2Elbtree_2Epath__follow__def,axiom,(
    ! [A_27a: del,A_27b: del] :
      ...
      & ! [V2g: $i] :
         ...
         => ! [V3x: $i] :
              ( ( mem @ V3x @ A_27b )
             => ! [V4h: $o,V5t: tp__c_ty_2Elist_2Elist_o] :
                  ( ( ap @ ( ap @ ( ap @ ( c_2Elbtree_2Epath__follow @ A_27a @ A_27b ) @ V2g ) @ V3x ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ V4h ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V5t ) ) )
                                ...
                                @ ^ [V8v2: $i] :
                                    ...
                                    @ ( lam @ A_27b
                                      @ ^ [V9y: $i] :
                                          ( lam @ A_27b
                                          @ ^ [V10z: $i] :
                                              ( ap @ ( ap @ ( ap @ ( c_2Elbtree_2Epath__follow @ A_27a @ A_27b ) @ V2g ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27b ) @ ( inj__o @ V4h ) ) @ V9y ) @ V10z ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V5t ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Elbtree_2Elbtree__ue__Axiom,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
