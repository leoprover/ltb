...
tff(lameq_f3661,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : ap(f3661(V0f),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V1x))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) )).

tff(conj_thm_2Ereal__topology_2ESUBSPACE__KERNEL,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Ereal__topology_2Elinear,V0f))
