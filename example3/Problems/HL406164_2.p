...
tff(conj_thm_2Ebit_2ELESS__MULT__MONO2,lemma,(
...
tff(mem_c_2Ewords_2Esaturate__mul,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Esaturate__mul(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(conj_thm_2Ewords_2ENOT__FINITE__IMP__dimword__2,lemma,(
    ! [A_27a: del] :
...
tff(conj_thm_2Ewords_2Esaturate__mul,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
