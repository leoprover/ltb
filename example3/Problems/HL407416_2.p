...
tff(conj_thm_2Ereal_2ESUM__POS,lemma,(
    ! [V0f: $i] :
...
tff(lamtp_f2730,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2730(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2730,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3m: tp__ty_2Enum_2Enum] : ap(f2730(V0f),inj__ty_2Enum_2Enum(V3m)) = ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Enum_2Enum(V3m))) ) )).

tff(lmtp_f2731,type,(
    f2731: $i > $i )).

tff(lamtp_f2731,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2731(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2731,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V4m: tp__ty_2Enum_2Enum] : ap(f2731(V0f),inj__ty_2Enum_2Enum(V4m)) = ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Enum_2Enum(V4m))) ) )).

tff(conj_thm_2Ereal_2ESUM__ABS,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n))),f2730(V0f)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n))),f2731(V0f))) ) )).
