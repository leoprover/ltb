...
fof(conj_thm_2Enumeral__bit_2ELOG__compute,conjecture,(
    ! [V0base_20_3C_202_20or_20n_20_3D_200] :
     ...
     => ! [V1m] :
         ...
         => ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ap(ap(c_2Elogroot_2ELOG,V1m),V2n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Eprim__rec_2E_3C,V1m),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V2n),c_2Enum_2E0))),ap(ap(ap(ap(c_2Ecombin_2EFAIL(arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum)),arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))),c_2Elogroot_2ELOG),V0base_20_3C_202_20or_20n_20_3D_200),V1m),V2n)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,V2n),V1m)),c_2Enum_2E0),ap(c_2Enum_2ESUC,ap(ap(c_2Elogroot_2ELOG,V1m),ap(ap(c_2Earithmetic_2EDIV,V2n),V1m))))) ) ) ) )).
