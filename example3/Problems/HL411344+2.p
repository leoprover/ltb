...
fof(conj_thm_2Ereal__topology_2EINTERIOR__IMAGE__SUBSET,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
              ...
              & ! [V3x] :
                 ...
                 => ! [V4y] :
                     ...
                     => ( ap(V0f,V3x) = ap(V0f,V4y)
                       => V3x = V4y ) ) ) )
           => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Einterior,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s))),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Einterior,V1s)))) ) ) ) )).
