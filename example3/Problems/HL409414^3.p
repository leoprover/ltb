...
thf(c_2Emachine__ieee_2Efp64__isSignallingNan,type,(
    c_2Emachine__ieee_2Efp64__isSignallingNan: ( tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) ) ) > $o )).
...
thf(thm_2Emachine__ieee_2Efp64__isSignallingNan__def,axiom,
...
thf(thm_2Emachine__ieee_2Efp64__isSignallingNan,conjecture,
    ( ! [V0a: tyop_2Ebinary__ieee_2Efloat @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ tyop_2Eone_2Eone ) ) ) ) ) @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) )] :
        ( ( c_2Emachine__ieee_2Efp64__isSignallingNan @ ( c_2Emachine__ieee_2Efloat__to__fp64 @ V0a ) )
        = ( c_2Ebinary__ieee_2Efloat__is__signalling @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ tyop_2Eone_2Eone ) ) ) ) ) @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ V0a ) )
    & ! [V1a: tyop_2Enum_2Enum] :
        ( ( c_2Emachine__ieee_2Efp64__isSignallingNan @ ( c_2Ewords_2En2w @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) ) @ V1a ) )
        = ( c_2Ebinary__ieee_2Efloat__is__signalling @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ tyop_2Eone_2Eone ) ) ) ) ) @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ ( c_2Emachine__ieee_2Efp64__to__float @ ( c_2Ewords_2En2w @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) ) @ V1a ) ) ) ) )).
