...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__HYPERPLANES,lemma,(
...
tff(lmtp_f4001,type,(
    f4001: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f4001,axiom,(
    ! [V2c: tp__ty_2Erealax_2Ereal] : mem(f4001(V2c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f4001,axiom,(
    ! [V2c: tp__ty_2Erealax_2Ereal,V4x: tp__ty_2Erealax_2Ereal] : ap(f4001(V2c),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),inj__ty_2Erealax_2Ereal(V2c))) )).

tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__HYPERPLANE__STANDARD__HYPERPLANE,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] :
      ( V0a != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
     => p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3898(V1b,V0a))),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4001(V2c)))) ) )).
