...
tff(conj_thm_2Ereal__topology_2EALWAYS__EVENTUALLY,lemma,(
    ! [A_27a: del,V0p: $i] :
...
tff(conj_thm_2Ereal__topology_2EEVENTUALLY__MP,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1p: $i] :
          ( mem(V1p,arr(A_27a,bool))
...
tff(conj_thm_2Ereal__topology_2ELIM__NULL__CMUL__BOUNDED,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
