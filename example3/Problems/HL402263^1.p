...
thf(f2442_0_2E0,type,(
    f2442_0_2E0: u )).

thf(f2442_0_2E2,type,(
    f2442_0_2E2: du > du > u )).
...
thf(mono_2Ef2442_0,type,(
    mono_2Ef2442_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Elist_2ELUPDATE__SEM,axiom,(
    ! [V6p: mono_2Etyop_2Enum_2Enum,V4n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2442_0 @ V6p @ V4n )
    <=> ( V6p = V4n ) ) )).

thf(thm_2Elist_2ELUPDATE__SEM,axiom,(
    ! [A_27a: d] :
      ( ! [V0e_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V2l_2E0: u] :
          ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V0e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) ) )
          = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) )
      & ! [V3e_2E0: u,V4n: mono_2Etyop_2Enum_2Enum,V5l_2E0: u,V6p: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V6p @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5l_2E0 ) ) ) ) )
         => ( ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6p ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V3e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5l_2E0 ) ) ) ) )
            = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef2442_0 @ V6p @ V4n ) ) ) @ ( s @ A_27a @ V3e_2E0 ) @ ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6p ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5l_2E0 ) ) ) ) ) ) ) ) )).

thf(thm_2Elist_2ELENGTH__LUPDATE,conjecture,(
