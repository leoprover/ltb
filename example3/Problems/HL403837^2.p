...
thf(conj_thm_2Ellist_2ELTAKE__EQ__NONE__LNTH,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( ( mem @ V1ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
...
thf(conj_thm_2Ellist_2ELTAKE__EQ,conjecture,(
    ! [A_27a: del,V0ll1: $i] :
      ( ( mem @ V0ll1 @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1ll2: $i] :
          ( ( mem @ V1ll2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( V0ll1 = V1ll2 )
          <=> ! [V2n: tp__ty_2Enum_2Enum] :
                ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V0ll1 )
                = ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V1ll2 ) ) ) ) ) )).
