...
thf(thm_2Ereal__topology_2ESERIES__CAUCHY,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ? [V2l: mono_2Etyop_2Erealax_2Ereal] :
          ( mono_2Ec_2Ereal__topology_2Esums @ V0f @ V2l @ V1s )
    <=> ! [V3e: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V4N: mono_2Etyop_2Enum_2Enum] :
            ! [V5m: mono_2Etyop_2Enum_2Enum,V6n: mono_2Etyop_2Enum_2Enum] :
              ( ( mono_2Ec_2Earithmetic_2E_3E_3D @ V5m @ V4N )
             => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Enum_2Enum @ V1s @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V5m @ V6n ) ) @ V0f ) ) @ V3e ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ESERIES__COMPARISON,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ? [V3l: mono_2Etyop_2Erealax_2Ereal] :
            ( mono_2Ec_2Ereal__topology_2Esums @ V1g @ V3l @ V2s )
        & ? [V4N: mono_2Etyop_2Enum_2Enum] :
          ! [V5n: mono_2Etyop_2Enum_2Enum] :
            ( ( ( mono_2Ec_2Earithmetic_2E_3E_3D @ V5n @ V4N )
              & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V5n @ V2s ) )
           => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Eabs @ ( V0f @ V5n ) ) @ ( V1g @ V5n ) ) ) )
     => ? [V6l: mono_2Etyop_2Erealax_2Ereal] :
          ( mono_2Ec_2Ereal__topology_2Esums @ V0f @ V6l @ V2s ) ) )).
