...
fof(conj_thm_2Epred__set_2EFINITE__BIJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2t] :
                     ...
                     => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
                       ...
                       => ( p(ap(c_2Epred__set_2EFINITE(A_27b),V2t))
                          & ap(c_2Epred__set_2ECARD(A_27a),V1s) = ap(c_2Epred__set_2ECARD(A_27b),V2t) ) ) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2EFINITE__BIJ__CARD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
