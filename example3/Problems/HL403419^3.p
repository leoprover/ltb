...
thf(thm_2Ebag_2Emlt__INSERT__CANCEL__I,axiom,(
    ! [A_27a: $tType,V0e: A_27a,V1R: A_27a > A_27a > $o,V2a: A_27a > tyop_2Enum_2Enum,V3b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Erelation_2ETC @ ( A_27a > tyop_2Enum_2Enum ) @ ( c_2Ebag_2Emlt1 @ A_27a @ V1R ) @ V2a @ V3b )
     => ( c_2Erelation_2ETC @ ( A_27a > tyop_2Enum_2Enum ) @ ( c_2Ebag_2Emlt1 @ A_27a @ V1R ) @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0e @ V2a ) @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0e @ V3b ) ) ) )).
