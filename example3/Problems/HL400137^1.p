...
thf(mono_2Ef154_0,type,(
    mono_2Ef154_0: $o > $o )).

thf(mono_2Ef154_1,type,(
    mono_2Ef154_1: $o > $o )).

thf(mono_2Ef154_2,type,(
    mono_2Ef154_2: $o > $o )).

thf(mono_2Ef154_3,type,(
    mono_2Ef154_3: $o > $o )).
...
thf(def0_2Ethm_2Ebool_2EBOOL__FUN__INDUCT,axiom,(
    ! [V4b: $o] :
      ( ( mono_2Ef154_3 @ V4b )
    <=> ( (~) @ V4b ) ) )).

thf(def1_2Ethm_2Ebool_2EBOOL__FUN__INDUCT,axiom,(
    ! [V1b: $o] :
      ( ( mono_2Ef154_0 @ V1b )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def2_2Ethm_2Ebool_2EBOOL__FUN__INDUCT,axiom,(
    ! [V2b: $o] :
      ( ( mono_2Ef154_1 @ V2b )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def3_2Ethm_2Ebool_2EBOOL__FUN__INDUCT,axiom,(
    ! [V3b: $o] :
      ( ( mono_2Ef154_2 @ V3b )
      = V3b ) )).

thf(thm_2Ebool_2EBOOL__FUN__INDUCT,conjecture,(
    ! [V0P: ( $o > $o ) > $o] :
      ( ( ( V0P @ mono_2Ef154_0 )
        & ( V0P @ mono_2Ef154_1 )
        & ( V0P @ mono_2Ef154_2 )
