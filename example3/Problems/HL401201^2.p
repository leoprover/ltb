...
thf(conj_thm_2Egcd_2EGCD__REF,lemma,(
...
thf(conj_thm_2Egcd_2EGCD__ADD__R__THM,lemma,
    ( ! [V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum] :
    ...
    & ! [V2a: tp__ty_2Enum_2Enum,V3b: tp__ty_2Enum_2Enum] :
        ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Egcd_2Egcd @ ( inj__ty_2Enum_2Enum @ V2a ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V3b ) ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Egcd_2Egcd @ ( inj__ty_2Enum_2Enum @ V2a ) ) @ ( inj__ty_2Enum_2Enum @ V3b ) ) ) ) )).

thf(conj_thm_2Egcd_2EGCD__SUCfree__ind,lemma,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1y: tp__ty_2Enum_2Enum] :
          ...
          & ! [V4x: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V4x ) ) @ ( inj__ty_2Enum_2Enum @ V4x ) ) )
       ...
       => ! [V7m: tp__ty_2Enum_2Enum,V8n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V7m ) ) @ ( inj__ty_2Enum_2Enum @ V8n ) ) ) ) ) )).
...
thf(conj_thm_2Egcd_2ELINEAR__GCD,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
      ( ( V0n != fo__c_2Enum_2E0 )
