                                ...
                                @ ( ap @ V0R
                                  @ ( ap
                                    @ ( ap @ ( c_2Elist_2EFILTER @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) )
                                      @ ( lam @ ( ty_2Epair_2Eprod @ A_27a @ A_27b )
                                        @ ^ [V3y: $i] :
                                            ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V2x ) ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V3y ) ) ) ) )
                                    @ V1t ) )
                              ...
                              @ ( ap @ V4OVERRIDE
                                @ ( ap
                                  @ ( ap @ ( c_2Elist_2EFILTER @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) )
                                    @ ( lam @ ( ty_2Epair_2Eprod @ A_27a @ A_27b )
                                      @ ^ [V8y: $i] :
                                          ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V6x ) ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V8y ) ) ) ) )
                                  @ V7t ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eupdate_2EOVERRIDE__def,conjecture,(
    ! [A_27a: del,A_27b: del] :
                  ...
                  @ ( ap @ ( c_2Eupdate_2EOVERRIDE @ A_27a @ A_27b )
                    @ ( ap
                      @ ( ap @ ( c_2Elist_2EFILTER @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) )
                        @ ( lam @ ( ty_2Epair_2Eprod @ A_27a @ A_27b )
                          @ ^ [V2y: $i] :
                              ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V0x ) ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V2y ) ) ) ) )
                      @ V1t ) ) ) ) ) ) ) )).
