...
fof(lamtp_f3945,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2n] :
          ( mem(V2n,ty_2Enum_2Enum)
         => mem(f3945(A_27a,V1f,V2n),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3945,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2n] :
          ( mem(V2n,ty_2Enum_2Enum)
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f3945(A_27a,V1f,V2n),V4x) = ap(ap(c_2Ereal_2Epow,ap(V1f,V4x)),V2n) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__POW,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
