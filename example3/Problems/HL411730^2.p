            ...
            = ( surj__ty_2Erealax_2Ereal
              @ ( ap @ ( c_2Emin_2E_40 @ ty_2Erealax_2Ereal )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2l: $i] :
                      ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a ) @ V1f ) @ V2l ) @ V0net ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ESUMS__LIM,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
         ...
         => ( ( p
              @ ( ap
                @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V0f )
                  @ ( ap @ ( ap @ ( c_2Ereal__topology_2Elim__def @ ty_2Enum_2Enum ) @ c_2Ereal__topology_2Esequentially )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V2n: $i] :
                          ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Enum_2Enum ) @ V1s ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V2n ) ) ) @ V0f ) ) ) )
                @ V1s ) )
