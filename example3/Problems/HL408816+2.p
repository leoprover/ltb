...
fof(conj_thm_2EHolSmt_2Er195,conjecture,(
    ! [V0u] :
                 ...
                 => ! [V4w] :
                     ...
                     => ! [V5z] :
                         ...
                         => ! [V6a] :
                             ...
                             => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V0u)),V1x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2v),V3y)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V4w)),V5z)))),V6a))
                              <=> ~ p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0u),V1x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V2v)),V3y)),ap(ap(c_2Erealax_2Ereal__mul,V4w),V5z)))),ap(c_2Erealax_2Ereal__neg,V6a))) ) ) ) ) ) ) ) ) )).
