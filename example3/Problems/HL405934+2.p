...
fof(conj_thm_2Elist_2ETL__GENLIST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
...
fof(conj_thm_2Erich__list_2EOR__EL__FOLDL,lemma,(
    ! [V0l] :
...
fof(conj_thm_2Ewords_2ENOT__0w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
...
fof(conj_thm_2Ewords_2Ereduce__or,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ap(c_2Ewords_2Ereduce__or(A_27a),V0w) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),V0w),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0))),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),c_2Enum_2E0)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))) ) ) )).
