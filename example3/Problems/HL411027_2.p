...
tff(conj_thm_2Ereal__topology_2ESUBSPACE__MUL,lemma,(
...
tff(conj_thm_2Ereal__topology_2ESUBSPACE__BOUNDED__EQ__TRIVIAL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Esubspace,V0s))
       => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
        <=> V0s = ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) ) ) ) )).
