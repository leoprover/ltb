...
fof(conj_thm_2Epath_2Eel__def__compute,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ! [V0p] :
            ...
            & ! [V3n] :
               ...
               => ! [V4p] :
                   ...
                   => ap(ap(c_2Epath_2Eel(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,V3n))),V4p) = ap(ap(c_2Epath_2Eel(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V3n))),ap(c_2Epath_2Etail(A_27a,A_27a),V4p)) ) ) ) ) ) )).
