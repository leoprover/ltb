...
tff(mem_c_2Ewords_2Eword__ror__bv,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__ror__bv(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(lmtp_f2329,type,(
    f2329: ( del * $i * tp__ty_2Enum_2Enum * $i * tp__o ) > $i )).

tff(lamtp_f2329,axiom,(
    ! [A_27a: del,V1m: $i] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2k: tp__ty_2Enum_2Enum,V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V3a: tp__o] : mem(f2329(A_27a,V1m,V2k,V0w,V3a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f2329,axiom,(
    ! [A_27a: del,V1m: $i] :
     ...
     => ! [V2k: tp__ty_2Enum_2Enum,V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V3a: tp__o,V4j: tp__ty_2Enum_2Enum] : ap(f2329(A_27a,V1m,V2k,V0w,V3a),inj__ty_2Enum_2Enum(V4j)) = ap(ap(c_2Ebool_2E_5C_2F,inj__o(V3a)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ewords_2Eword__mod(A_27a),V1m),ap(c_2Ewords_2En2w(A_27a),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V4j)))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V4j)),inj__ty_2Enum_2Enum(V2k))),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))))) ) ) )).

tff(lmtp_f2328,type,(
    f2328: ( del * $i * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2328,axiom,(
    ! [A_27a: del,V1m: $i] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2k: tp__ty_2Enum_2Enum,V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
tff(lameq_f2328,axiom,(
    ! [A_27a: del,V1m: $i] :
     ...
     => ! [V2k: tp__ty_2Enum_2Enum,V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V3a: tp__o] : ap(f2328(A_27a,V1m,V2k,V0w),inj__o(V3a)) = f2329(A_27a,V1m,V2k,V0w,V3a) ) ) )).

tff(lmtp_f2327,type,(
    f2327: ( del * $i * $i ) > $i )).

tff(lamtp_f2327,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
...
tff(lameq_f2327,axiom,(
    ! [A_27a: del,V0w: $i] :
     ...
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2k: tp__ty_2Enum_2Enum] : ap(f2327(A_27a,V0w,V1m),inj__ty_2Enum_2Enum(V2k)) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Enum_2Enum,ty_2Enum_2Enum),f2328(A_27a,V1m,V2k,V0w)),inj__o(fo__c_2Ebool_2EF)),ap(c_2Erich__list_2ECOUNT__LIST,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) )).

tff(conj_thm_2Eblast_2Eword__ror__bv__expand,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
