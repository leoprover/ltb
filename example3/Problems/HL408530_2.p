...
tff(conj_thm_2Ebinary__ieee_2Eround__roundTowardZero__bottom,lemma,(
...
tff(conj_thm_2Ebinary__ieee_2Efloat__round__roundTowardZero__bottom,conjecture,(
    ! [A_27t: del,A_27w: del,V0b: tp__o,V1y: $i] :
     ...
     => ! [V2x: tp__ty_2Erealax_2Ereal] :
         ...
         => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTowardZero)),inj__o(V0b)),inj__ty_2Erealax_2Ereal(V2x)) = ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) )).
