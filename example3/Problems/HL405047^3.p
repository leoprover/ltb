...
thf(thm_2EOmega__Automata_2EBOREL__HIERARCHY__G,conjecture,(
    ! [V0t0: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum > $o] :
      ...
      <=> ? [V3q: tyop_2Enum_2Enum > $o] :
            ...
            & ? [V5t: tyop_2Enum_2Enum] :
                ( V3q @ ( c_2Earithmetic_2E_2B @ V5t @ V0t0 ) ) ) )
      & ( ! [V6t: tyop_2Enum_2Enum] :
            ( V1a @ ( c_2Earithmetic_2E_2B @ V6t @ V0t0 ) )
      <=> ? [V7q: tyop_2Enum_2Enum > $o] :
            ( ( V7q @ V0t0 )
            & ! [V8t: tyop_2Enum_2Enum] :
                ( ( V7q @ ( c_2Enum_2ESUC @ ( c_2Earithmetic_2E_2B @ V8t @ V0t0 ) ) )
              <=> ( ( V7q @ ( c_2Earithmetic_2E_2B @ V8t @ V0t0 ) )
                  & ( V1a @ ( c_2Earithmetic_2E_2B @ V8t @ V0t0 ) ) ) )
            & ? [V9t1: tyop_2Enum_2Enum] :
              ! [V10t2: tyop_2Enum_2Enum] :
                ( V7q @ ( c_2Earithmetic_2E_2B @ V9t1 @ ( c_2Earithmetic_2E_2B @ V10t2 @ V0t0 ) ) ) ) )
      & ( ! [V11t: tyop_2Enum_2Enum] :
            ( V1a @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) )
      <=> ? [V12q: tyop_2Enum_2Enum > $o] :
            ( ( V12q @ V0t0 )
            & ! [V13t: tyop_2Enum_2Enum] :
                ( ( V12q @ ( c_2Enum_2ESUC @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) ) )
              <=> ( ( V12q @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) )
                  & ( V1a @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) ) ) )
            & ! [V14t1: tyop_2Enum_2Enum] :
              ? [V15t2: tyop_2Enum_2Enum] :
                ( V12q @ ( c_2Earithmetic_2E_2B @ V14t1 @ ( c_2Earithmetic_2E_2B @ V15t2 @ V0t0 ) ) ) ) ) ) )).
