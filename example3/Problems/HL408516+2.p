...
fof(conj_thm_2Ebinary__ieee_2Eround__roundTowardZero__is__zero,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0x] :
             ...
             => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,V0x)),ap(c_2Ebinary__ieee_2Eulp(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))))
               => ( ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),c_2Ebinary__ieee_2EroundTowardZero),V0x) = ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))
                  | ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),c_2Ebinary__ieee_2EroundTowardZero),V0x) = ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) ) )).

fof(conj_thm_2Ebinary__ieee_2Eround__roundTowardZero__is__plus__zero,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0x] :
              ( mem(V0x,ty_2Erealax_2Ereal)
             => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,V0x)),ap(c_2Ebinary__ieee_2Eulp(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))))
               => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),c_2Ebinary__ieee_2EroundTowardZero),c_2Ebool_2EF),V0x) = ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) )).
