...
tff(lamtp_f923,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => mem(f923(V1b),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f923,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V5t: tp__ty_2Enum_2Enum] : ap(f923(V1b),inj__ty_2Enum_2Enum(V5t)) = ap(c_2Ebool_2E_7E,ap(V1b,inj__ty_2Enum_2Enum(V5t))) ) )).

tff(lmtp_f922,type,(
    f922: ( $i * $i ) > $i )).

tff(lamtp_f922,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f922(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f922,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2t: tp__ty_2Enum_2Enum] : ap(f922(V0a,V1b),inj__ty_2Enum_2Enum(V2t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f893(V1b)),f900(V0a,V1b)),inj__ty_2Enum_2Enum(V2t))),ap(ap(c_2ETemporal__Logic_2EALWAYS,f923(V1b)),inj__ty_2Enum_2Enum(V2t))) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EWHEN__AS__SUNTIL,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ETemporal__Logic_2EWHEN,V0a),V1b) = f922(V0a,V1b) ) ) )).
