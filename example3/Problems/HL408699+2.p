...
fof(conj_thm_2EHolSmt_2Er078,conjecture,(
    ! [V0a] :
     ...
     => ! [V1x] :
         ...
         => ! [V2v] :
             ...
             => ! [V3y] :
                 ...
                 => ! [V4w] :
                      ( mem(V4w,ty_2Einteger_2Eint)
                     => ! [V5z] :
                          ( mem(V5z,ty_2Einteger_2Eint)
                         => ( ap(ap(c_2Einteger_2Eint__add,V0a),ap(ap(c_2Einteger_2Eint__add,ap(ap(c_2Einteger_2Eint__mul,ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V1x)),ap(ap(c_2Einteger_2Eint__add,ap(ap(c_2Einteger_2Eint__mul,V2v),V3y)),ap(ap(c_2Einteger_2Eint__mul,V4w),V5z)))) = ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)
                          <=> ap(ap(c_2Einteger_2Eint__add,V1x),ap(ap(c_2Einteger_2Eint__add,ap(ap(c_2Einteger_2Eint__mul,ap(c_2Einteger_2Eint__neg,V2v)),V3y)),ap(ap(c_2Einteger_2Eint__mul,ap(c_2Einteger_2Eint__neg,V4w)),V5z))) = V0a ) ) ) ) ) ) ) )).
