...
thf(thm_2Esum_2Esum__case__cong,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f1_27_2E0: u,V1f_27_2E0: u,V2M_2E0: u,V3M_27_2E0: u,V4f_2E0: u,V5f1_2E0: u] :
      ( ( ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V2M_2E0 )
          = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V3M_27_2E0 ) )
        & ! [V6x_2E0: u] :
            ( ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V3M_27_2E0 )
              = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27a @ V6x_2E0 ) ) ) )
           => ( ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V4f_2E0 ) @ ( s @ A_27a @ V6x_2E0 ) ) )
              = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_27_2E0 ) @ ( s @ A_27a @ V6x_2E0 ) ) ) ) )
        & ! [V7y_2E0: u] :
            ( ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V3M_27_2E0 )
              = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ V7y_2E0 ) ) ) )
           => ( ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V5f1_2E0 ) @ ( s @ A_27b @ V7y_2E0 ) ) )
              = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V0f1_27_2E0 ) @ ( s @ A_27b @ V7y_2E0 ) ) ) ) ) )
     => ( ( s @ A_27c @ ( c_2Esum_2Esum__CASE_2E3 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V2M_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V4f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V5f1_2E0 ) ) )
        = ( s @ A_27c @ ( c_2Esum_2Esum__CASE_2E3 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V3M_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V0f1_27_2E0 ) ) ) ) ) )).
