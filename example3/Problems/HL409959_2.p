...
tff(lamtp_f3457,axiom,(
    ! [A_27b: del,A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,arr(A_27b,ty_2Eextreal_2Eextreal)))
     => ! [V1s_27: $i] :
          ( mem(V1s_27,arr(A_27b,bool))
         => mem(f3457(A_27b,A_27a,V2f,V1s_27),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f3457,axiom,(
    ! [A_27b: del,A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,arr(A_27b,ty_2Eextreal_2Eextreal)))
     => ! [V1s_27: $i] :
          ( mem(V1s_27,arr(A_27b,bool))
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3457(A_27b,A_27a,V2f,V1s_27),V3x) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27b),ap(V2f,V3x)),V1s_27) ) ) ) )).

tff(lmtp_f3458,type,(
    f3458: ( del * del * $i ) > $i )).

tff(lamtp_f3458,axiom,(
    ! [A_27a: del,A_27b: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,arr(A_27b,ty_2Eextreal_2Eextreal)))
     => mem(f3458(A_27a,A_27b,V2f),arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f3458,axiom,(
    ! [A_27a: del,A_27b: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,arr(A_27b,ty_2Eextreal_2Eextreal)))
     => ! [V4x: $i] :
          ( mem(V4x,ty_2Epair_2Eprod(A_27a,A_27a))
         => ap(f3458(A_27a,A_27b,V2f),V4x) = ap(ap(V2f,ap(c_2Epair_2EFST(A_27a,A_27a),V4x)),ap(c_2Epair_2ESND(A_27a,A_27a),V4x)) ) ) )).

tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__EXTREAL__SUM__IMAGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1s_27: $i] :
          ( mem(V1s_27,arr(A_27b,bool))
         => ! [V2f: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
               ...
               => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),f3457(A_27b,A_27a,V2f,V1s_27)),V0s)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Epair_2Eprod(A_27a,A_27a)),f3458(A_27a,A_27b,V2f)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s),V1s_27))) ) ) ) ) )).
