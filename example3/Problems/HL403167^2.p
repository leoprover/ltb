...
thf(conj_thm_2ETemporal__Logic_2EEVENTUAL__FIX,conjecture,(
    ! [V0y: $i] :
     ...
     => ! [V1a: $i] :
         ...
         => ( ( V0y
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V2t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1a @ V2t ) ) @ ( ap @ V0y @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V2t ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
          <=> ( ( V0y
