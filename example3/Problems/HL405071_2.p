...
tff(conj_thm_2EOmega__Automata_2EBUECHI__PROP__REDUCTION,conjecture,(
             ...
             => ( ! [V3s: $i] :
               ...
               => ( ? [V6i: $i] :
                      ...
                      & ? [V7q: $i] :
                          ...
                          & ! [V8t: tp__ty_2Enum_2Enum] : p(ap(V1TransRel,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V6i,inj__ty_2Enum_2Enum(V8t))),ap(ap(c_2Epair_2E_2C(A_27state,A_27state),ap(V7q,inj__ty_2Enum_2Enum(V8t))),ap(V7q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V8t)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))))
