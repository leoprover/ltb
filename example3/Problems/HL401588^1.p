...
thf(f1838_0_2E0,type,(
    f1838_0_2E0: u )).

thf(f1838_0_2E3,type,(
    f1838_0_2E3: du > du > du > u )).

thf(f1838_0_2E4,type,(
...
thf(c_2Epred__set_2ELINV__OPT_2E2,type,(
    c_2Epred__set_2ELINV__OPT_2E2: du > du > u )).
...
thf(arityeq3_2Emono_2Ef1838_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f1838_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ef1838_0_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f1838_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ec_2Epred__set_2EIMAGE_2E2_2Emono_2EA_27b_20mono_2Etyop_2Eoption_2Eoption_28A_27b_29,axiom,(
    ! [A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EIMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ec_2Epred__set_2EINJ_2E3_2Emono_2EA_27a_20mono_2Etyop_2Eoption_2Eoption_28A_27b_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EINJ_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ tyop_2Emin_2Ebool ) @ X2_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ec_2Epred__set_2ELINV__OPT_2E2_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ ( c_2Epred__set_2ELINV__OPT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) )
...
thf(def0_2Ethm_2Epred__set_2ELINV__OPT__def,axiom,(
    ! [A_27a: d,A_27b: d,V1s_2E0: u,V0f_2E0: u,V2y_2E0: u,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f1838_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27b @ V2y_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
    <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) )
...
thf(thm_2Epred__set_2ELINV__OPT__def,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1s_2E0: u,V2y_2E0: u] :
      ...
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27b @ V2y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EIMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ ( c_2Emin_2E_40_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f1838_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27b @ V2y_2E0 ) ) ) ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) ) ) )).
