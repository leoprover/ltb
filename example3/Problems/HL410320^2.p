...
thf(conj_thm_2Ereal__topology_2ETRANSITIVE__STEPWISE__LE__EQ,lemma,(
    ! [V0R: $i] :
      ( ( mem @ V0R @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ bool ) ) )
     => ( ( ! [V1x: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0R @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) )
       ...
       => ( ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] :
        ...
        <=> ! [V7n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0R @ ( inj__ty_2Enum_2Enum @ V7n ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V7n ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ETRANSITIVE__STEPWISE__LE,conjecture,(
    ! [V0R: $i] :
      ( ( mem @ V0R @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ bool ) ) )
     => ( ( ! [V1x: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0R @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) )
          ...
          & ! [V5n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0R @ ( inj__ty_2Enum_2Enum @ V5n ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) ) )
