...
thf(thm_2EHolSmt_2Er078,conjecture,(
    ! [V0z: tyop_2Einteger_2Eint,V1y: tyop_2Einteger_2Eint,V2x: tyop_2Einteger_2Eint,V3w: tyop_2Einteger_2Eint,V4v: tyop_2Einteger_2Eint,V5a: tyop_2Einteger_2Eint] :
      ( ( ( c_2Einteger_2Eint__add @ V5a @ ( c_2Einteger_2Eint__add @ ( c_2Einteger_2Eint__mul @ ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V2x ) @ ( c_2Einteger_2Eint__add @ ( c_2Einteger_2Eint__mul @ V4v @ V1y ) @ ( c_2Einteger_2Eint__mul @ V3w @ V0z ) ) ) )
        = ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) )
    <=> ( ( c_2Einteger_2Eint__add @ V2x @ ( c_2Einteger_2Eint__add @ ( c_2Einteger_2Eint__mul @ ( c_2Einteger_2Eint__neg @ V4v ) @ V1y ) @ ( c_2Einteger_2Eint__mul @ ( c_2Einteger_2Eint__neg @ V3w ) @ V0z ) ) )
        = V5a ) ) )).
