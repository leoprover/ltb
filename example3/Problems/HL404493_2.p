...
tff(lmtp_f1882,type,(
    f1882: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1882,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V5y: $i] :
     ...
     => ! [V0R: $i] :
         ...
         => ! [V1s: $i] :
             ...
             => mem(f1882(A_27a,A_27b,A_27a,V5y,V0R,V1s),arr(A_27a,bool)) ) ) ) )).

tff(lameq_f1882,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V5y: $i] :
      ( mem(V5y,A_27b)
     => ! [V0R: $i] :
          ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
         => ! [V1s: $i] :
             ...
             => ! [V6x: $i] :
                  ( mem(V6x,A_27a)
                 => ap(f1882(A_27a,A_27b,A_27a,V5y,V0R,V1s),V6x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V6x),V1s)),ap(ap(V0R,V6x),V5y)) ) ) ) ) )).

tff(lmtp_f1881,type,(
    f1881: ( del * del * $i * $i ) > $i )).

tff(lamtp_f1881,axiom,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => mem(f1881(A_27a,A_27b,V0R,V1s),arr(A_27b,ty_2Epair_2Eprod(A_27b,A_27b))) ) ) )).

tff(lameq_f1881,axiom,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V5y: $i] :
              ( mem(V5y,A_27b)
             => ap(f1881(A_27a,A_27b,V0R,V1s),V5y) = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V5y),ap(c_2Ebool_2E_3F(A_27a),f1882(A_27a,A_27b,A_27a,V5y,V0R,V1s))) ) ) ) )).

tff(conj_thm_2Ecardinal_2ECARD__LE__RELATIONAL,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
               ...
               => ! [V3y: $i] :
                   ...
                   => ! [V4y_27: $i] :
                       ...
                       => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s))
                         ...
                         => V3y = V4y_27 ) ) ) )
           => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),ap(c_2Epred__set_2EGSPEC(A_27b,A_27b),f1881(A_27a,A_27b,V0R,V1s))),V1s)) ) ) ) )).
