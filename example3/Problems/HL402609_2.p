...
tff(conj_thm_2Erich__list_2EREVERSE__FOLDR,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ap(c_2Elist_2EREVERSE(A_27a),V0l) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),c_2Elist_2ESNOC(A_27a)),c_2Elist_2ENIL(A_27a)),V0l) ) )).
