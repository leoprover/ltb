...
fof(conj_thm_2Erich__list_2ESEG__SUC__CONS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
...
fof(conj_thm_2Erich__list_2ESEG__APPEND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
         => ! [V1l1] :
             ...
             => ! [V2n] :
                 ...
                 => ! [V3l2] :
                     ...
                     => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,V0m),ap(c_2Elist_2ELENGTH(A_27a),V1l1)))
                          & p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Elist_2ELENGTH(A_27a),V1l1)),ap(ap(c_2Earithmetic_2E_2B,V2n),V0m)))
                          & p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V2n),V0m)),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(A_27a),V1l1)),ap(c_2Elist_2ELENGTH(A_27a),V3l2)))) )
                       => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V2n),V0m),ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),V3l2)) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(ap(c_2Erich__list_2ESEG(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(A_27a),V1l1)),V0m)),V0m),V1l1)),ap(ap(ap(c_2Erich__list_2ESEG(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2B,V2n),V0m)),ap(c_2Elist_2ELENGTH(A_27a),V1l1))),c_2Enum_2E0),V3l2)) ) ) ) ) ) ) )).
