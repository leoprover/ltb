...
tff(conj_thm_2Ecardinal_2ECARD__LE__SQUARE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V0s),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s),V0s))) ) )).

tff(conj_thm_2Ecardinal_2ECARD__SQUARE__NUM,conjecture,(
    p(ap(ap(c_2Ecardinal_2Ecardeq(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epred__set_2ECROSS(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) )).
