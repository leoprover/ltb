...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__RESTRICT,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1k: $i] :
          ( ( mem @ V1k @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ( ( p
              @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V2n: $i] :
                      ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V2n ) @ V1k ) ) @ ( ap @ V0f @ V2n ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) )
          <=> ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V1k ) @ V0f ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINFSUM__RESTRICT,conjecture,(
    ! [V0k: $i] :
      ( ( mem @ V0k @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
         => ( ( surj__ty_2Erealax_2Ereal
              @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V2n: $i] :
                      ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V2n ) @ V0k ) ) @ ( ap @ V1a @ V2n ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) )
            = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V0k ) @ V1a ) ) ) ) ) )).
