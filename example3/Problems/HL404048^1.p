...
thf(thm_2Equotient_2EABSTRACT__RES__ABSTRACT,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0R1_2E0: u,V1abs1_2E0: u,V2rep1_2E0: u] :
     ...
     => ! [V3R2_2E0: u,V4f_2E0: u,V5g_2E0: u] :
         ...
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Equotient_2E_3D_3D_3D_3E_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V3R2_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V4f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2Ebool_2ERES__ABSTRACT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Equotient_2Erespects_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R1_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V5g_2E0 ) ) ) ) ) ) ) ) )).
