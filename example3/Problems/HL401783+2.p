...
fof(conj_thm_2Epred__set_2EGSPEC__F__COND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ( ! [V1x] :
                    ( mem(V1x,A_27a)
                   => ~ p(ap(c_2Epair_2ESND(A_27b,A_27b),ap(V0f,V1x))) )
               => ap(c_2Epred__set_2EGSPEC(A_27b,A_27b),V0f) = c_2Epred__set_2EEMPTY(A_27b) ) ) ) ) )).
