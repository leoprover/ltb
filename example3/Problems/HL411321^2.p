...
thf(conj_thm_2Ereal__topology_2ESURJECTIVE__IMAGE__EQ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__NEGATIONS,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__GE,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ~ ( p
        @ ( ap @ c_2Ereal__topology_2Ebounded__def
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
