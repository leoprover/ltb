...
thf(thm_2Enumeral_2Etexp__help__def,axiom,
    ( ! [V0acc: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Enumeral_2Etexp__help @ mono_2Ec_2Enum_2E0 @ V0acc )
        = ( mono_2Ec_2Earithmetic_2EBIT2 @ V0acc ) )
    & ! [V1n: mono_2Etyop_2Enum_2Enum,V2acc: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Enumeral_2Etexp__help @ ( mono_2Ec_2Enum_2ESUC @ V1n ) @ V2acc )
        = ( mono_2Ec_2Enumeral_2Etexp__help @ V1n @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V2acc ) ) ) )).
...
thf(thm_2Enumeral_2Enumeral__texp__help,conjecture,(
