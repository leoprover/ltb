...
thf(c_2EreaderMonad_2EJOIN_2E0,type,(
    c_2EreaderMonad_2EJOIN_2E0: u )).

thf(c_2EreaderMonad_2EJOIN_2E1,type,(
    c_2EreaderMonad_2EJOIN_2E1: du > u )).

thf(c_2EreaderMonad_2EJOIN_2E2,type,(
    c_2EreaderMonad_2EJOIN_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ec_2EreaderMonad_2EBIND_2E2_2Emono_2Etyop_2Emin_2Efun_28A_27a_2CA_27b_29_20mono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2EreaderMonad_2EBIND_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ X1_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ec_2EreaderMonad_2EJOIN_2E1_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2EreaderMonad_2EJOIN_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ c_2EreaderMonad_2EJOIN_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2EreaderMonad_2EJOIN_2E2_2Emono_2EA_27a_20mono_2EA_27s,axiom,(
    ! [A_27a: d,A_27s: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27a @ ( c_2EreaderMonad_2EJOIN_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) ) @ X0_2E0 ) @ ( s @ A_27s @ X1_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) ) @ c_2EreaderMonad_2EJOIN_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) ) @ X0_2E0 ) ) ) @ ( s @ A_27s @ X1_2E0 ) ) ) ) )).
...
thf(thm_2EreaderMonad_2EJOIN__def,axiom,(
    ! [A_27a: d,A_27s: d,V0MM_2E0: u,V1s_2E0: u] :
      ( ( s @ A_27a @ ( c_2EreaderMonad_2EJOIN_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) ) @ V0MM_2E0 ) @ ( s @ A_27s @ V1s_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) ) @ V0MM_2E0 ) @ ( s @ A_27s @ V1s_2E0 ) ) ) @ ( s @ A_27s @ V1s_2E0 ) ) ) ) )).

thf(thm_2EreaderMonad_2EJOIN__BIND,conjecture,(
    ! [A_27a: d,A_27b: d,V0M_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2EreaderMonad_2EJOIN_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V0M_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2EreaderMonad_2EBIND_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V0M_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ c_2Ecombin_2EI_2E0 ) ) ) ) )).
