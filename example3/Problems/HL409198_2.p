...
tff(lamtp_f3190,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2f_27: $i] :
          ( mem(V2f_27,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3190(A_27a,V1f,V2f_27),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f3190,axiom,(
    ! [A_27a: del,V1f: $i] :
     ...
     => ! [V2f_27: $i] :
         ...
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3190(A_27a,V1f,V2f_27),V3x) = ap(ap(c_2Ereal_2Ereal__sub,ap(V1f,V3x)),ap(V2f_27,V3x)) ) ) ) )).

tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__SUB,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2f_27: $i] :
              ( mem(V2f_27,arr(A_27a,ty_2Erealax_2Ereal))
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3190(A_27a,V1f,V2f_27)),V0s)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V1f),V0s)),ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V2f_27),V0s))) ) ) ) ) )).
