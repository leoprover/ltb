...
thf(c_2EDecode_2Edecode__option,type,(
    c_2EDecode_2Edecode__option: 
      !>[A_27a: $tType] :
        ( ( ( tyop_2Eoption_2Eoption @ A_27a ) > $o ) > ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) ) ) > ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( tyop_2Elist_2Elist @ $o ) ) ) ) )).
...
thf(c_2EEncode_2Eencode__option,type,(
    c_2EEncode_2Eencode__option: 
      !>[A_27a: $tType] :
        ( ( A_27a > ( tyop_2Elist_2Elist @ $o ) ) > ( tyop_2Eoption_2Eoption @ A_27a ) > ( tyop_2Elist_2Elist @ $o ) ) )).

thf(c_2EEncode_2Elift__option,type,(
    c_2EEncode_2Elift__option: 
      !>[A_27a: $tType] :
        ( ( A_27a > $o ) > ( tyop_2Eoption_2Eoption @ A_27a ) > $o ) )).
...
thf(thm_2EDecode_2Edecode__option__def,axiom,(
    ! [A_27a: $tType,V0p: ( tyop_2Eoption_2Eoption @ A_27a ) > $o,V1d: ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) )] :
      ( ( c_2EDecode_2Edecode__option @ A_27a @ V0p @ V1d )
      = ( c_2EDecode_2Eenc2dec @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V0p @ ( c_2EEncode_2Eencode__option @ A_27a @ ( c_2EDecode_2Edec2enc @ A_27a @ V1d ) ) ) ) )).
...
thf(thm_2EDecode_2Edec2enc__decode__option,conjecture,(
    ! [A_27a: $tType,V0p: A_27a > $o,V1d: ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) ),V2x: tyop_2Eoption_2Eoption @ A_27a] :
      ( ( ( c_2EDecode_2Ewf__decoder @ A_27a @ V0p @ V1d )
        & ( c_2EEncode_2Elift__option @ A_27a @ V0p @ V2x ) )
     => ( ( c_2EDecode_2Edec2enc @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2EDecode_2Edecode__option @ A_27a @ ( c_2EEncode_2Elift__option @ A_27a @ V0p ) @ V1d ) @ V2x )
        = ( c_2EEncode_2Eencode__option @ A_27a @ ( c_2EDecode_2Edec2enc @ A_27a @ V1d ) @ V2x ) ) ) )).
