    ...
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2s_27: tyop_2Erealax_2Ereal > $o,V3t_27: tyop_2Erealax_2Ereal > $o] :
      ( ! [V4b: tyop_2Erealax_2Ereal] :
          ( ( ! [V5x: tyop_2Erealax_2Ereal] :
               ...
               => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V5x @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V1t ) ) @ V4b ) )
            & ! [V6y: tyop_2Erealax_2Ereal] :
                ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V6y @ V1t )
               => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V6y @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V0s ) ) @ V4b ) ) )
        <=> ( ! [V7x: tyop_2Erealax_2Ereal] :
                ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V2s_27 )
               => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V7x @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V3t_27 ) ) @ V4b ) )
            & ! [V8y: tyop_2Erealax_2Ereal] :
                ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V8y @ V3t_27 )
               => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V8y @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V2s_27 ) ) @ V4b ) ) ) )
     => ( ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V1t ) )
        = ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V2s_27 @ V3t_27 ) ) ) ) )).
