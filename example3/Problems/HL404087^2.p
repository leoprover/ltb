...
thf(stp_fo_c_2EPast__Temporal__Logic_2EInitPoint,type,(
    fo__c_2EPast__Temporal__Logic_2EInitPoint: tp__ty_2Enum_2Enum > $o )).

thf(stp_eq_fo_c_2EPast__Temporal__Logic_2EInitPoint,axiom,(
    ! [X0: tp__ty_2Enum_2Enum] :
      ( ( inj__o @ ( fo__c_2EPast__Temporal__Logic_2EInitPoint @ X0 ) )
      = ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ ( inj__ty_2Enum_2Enum @ X0 ) ) ) )).
...
thf(ax_thm_2EPast__Temporal__Logic_2EInitPoint,axiom,
    ...
    = ( lam @ ty_2Enum_2Enum
      @ ^ [V0t: $i] :
          ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V0t ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )).
...
thf(conj_thm_2EPast__Temporal__Logic_2EPNEXT__INWARDS__NORMAL__FORM,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ( ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
              ...
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V3t: $i] :
                    ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V0a ) @ V3t ) ) ) )
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V4t: $i] :
              ...
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V5t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) @ V5t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V1b ) @ V5t ) ) ) )
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V6t: $i] :
              ...
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V7t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) @ V7t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V1b ) @ V7t ) ) ) )
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) )
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V8t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ V8t ) ) @ ( ap @ V0a @ V8t ) ) ) )
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ ( ap @ c_2ETemporal__Logic_2EALWAYS @ V0a ) )
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V9t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ V9t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2EALWAYS @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) ) @ V9t ) ) ) )
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ ( ap @ c_2ETemporal__Logic_2EEVENTUAL @ V0a ) )
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V10t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ V10t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2EEVENTUAL @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) ) @ V10t ) ) ) )
            ...
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ ( ap @ c_2EPast__Temporal__Logic_2EPEVENTUAL @ V0a ) )
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V11t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ V11t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPEVENTUAL @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V0a ) ) @ V11t ) ) ) )
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a ) @ V1b ) )
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V12t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ V12t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) ) @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) ) @ V12t ) ) ) )
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN @ V0a ) @ V1b ) )
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V13t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ V13t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) ) @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) ) @ V13t ) ) ) )
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE @ V0a ) @ V1b ) )
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V14t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ V14t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V0a ) ) @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V1b ) ) @ V14t ) ) ) )
