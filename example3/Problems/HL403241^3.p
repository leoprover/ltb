...
thf(thm_2Ebag_2EBAG__DELETE__concrete,conjecture,(
    ...
    <=> ( ( c_2Earithmetic_2E_3E @ ( V0b0 @ V2e ) @ c_2Enum_2E0 )
        & ( V1b
          = ( ^ [V3x: A_27a] :
                ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Emin_2E_3D @ A_27a @ V3x @ V2e ) @ ( c_2Earithmetic_2E_2D @ ( V0b0 @ V2e ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( V0b0 @ V3x ) ) ) ) ) ) )).
