...
tff(lmtp_f1857,type,(
    f1857: ( del * del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1857,axiom,(
    ! [A_27a: del,A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : mem(f1857(A_27a,A_27a,V0A,V1n),arr(ty_2Elist_2Elist(A_27a),ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)))) ) )).
...
tff(lameq_f1857,axiom,(
    ! [A_27a: del,A_27a: del,V0A: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum,V2l: $i] :
          ( mem(V2l,ty_2Elist_2Elist(A_27a))
         => ap(f1857(A_27a,A_27a,V0A,V1n),V2l) = ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V2l),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(c_2Elist_2ELENGTH(A_27a),V2l)),inj__ty_2Enum_2Enum(V1n))),ap(c_2Ebool_2E_21(A_27a),f1858(A_27a,A_27a,V2l,V0A)))) ) ) )).

tff(conj_thm_2Ecardinal_2Eset__exp__count,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ecardinal_2Ecardeq(arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)),arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a))),ap(ap(c_2Ecardinal_2Eset__exp(ty_2Enum_2Enum,ty_2Enum_2Enum),V0A),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V1n)))),ap(c_2Epred__set_2EGSPEC(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),f1857(A_27a,A_27a,V0A,V1n)))) ) )).
