...
thf(tp_c_2Etopology_2Eopen,type,(
    c_2Etopology_2Eopen: del > $i )).

thf(mem_c_2Etopology_2Eopen,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Etopology_2Eopen__DEF,axiom,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Etopology_2Eopen__topspace,conjecture,(
    ! [A_27a: del,V0top: $i] :
      ( ( mem @ V0top @ ( ty_2Etopology_2Etopology @ A_27a ) )
