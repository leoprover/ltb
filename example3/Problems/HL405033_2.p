...
tff(conj_thm_2Equotient__sum_2ESUM__REL__ind,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,arr(A_27a,bool)),arr(arr(A_27b,arr(A_27b,bool)),arr(ty_2Esum_2Esum(A_27a,A_27a),arr(ty_2Esum_2Esum(A_27a,A_27a),bool)))))
     => ( ( ! [V1R1: $i] :
             ...
             => ! [V2R2: $i] :
                 ...
                 => ! [V3a1: $i] :
                     ...
                     => ! [V4a2: $i] :
                          ( mem(V4a2,A_27a)
                         => p(ap(ap(ap(ap(V0P,V1R1),V2R2),ap(c_2Esum_2EINL(A_27a,A_27a),V3a1)),ap(c_2Esum_2EINL(A_27a,A_27a),V4a2))) ) ) ) )
          & ! [V5R1: $i] :
             ...
             => ! [V6R2: $i] :
                 ...
                 => ! [V7b1: $i] :
                     ...
                     => ! [V8b2: $i] :
                          ( mem(V8b2,A_27b)
                         => p(ap(ap(ap(ap(V0P,V5R1),V6R2),ap(c_2Esum_2EINR(A_27a,A_27a),V7b1)),ap(c_2Esum_2EINR(A_27a,A_27a),V8b2))) ) ) ) )
          & ! [V9R1: $i] :
             ...
             => ! [V10R2: $i] :
                 ...
                 => ! [V11a1: $i] :
                     ...
                     => ! [V12b2: $i] :
                          ( mem(V12b2,A_27b)
                         => p(ap(ap(ap(ap(V0P,V9R1),V10R2),ap(c_2Esum_2EINL(A_27a,A_27a),V11a1)),ap(c_2Esum_2EINR(A_27a,A_27a),V12b2))) ) ) ) )
          & ! [V13R1: $i] :
             ...
             => ! [V14R2: $i] :
                 ...
                 => ! [V15b1: $i] :
                     ...
                     => ! [V16a2: $i] :
                          ( mem(V16a2,A_27a)
                         => p(ap(ap(ap(ap(V0P,V13R1),V14R2),ap(c_2Esum_2EINR(A_27a,A_27a),V15b1)),ap(c_2Esum_2EINL(A_27a,A_27a),V16a2))) ) ) ) ) )
       => ! [V17v: $i] :
            ( mem(V17v,arr(A_27a,arr(A_27a,bool)))
           => ! [V18v1: $i] :
                ( mem(V18v1,arr(A_27b,arr(A_27b,bool)))
               => ! [V19v2: $i] :
                    ( mem(V19v2,ty_2Esum_2Esum(A_27a,A_27a))
                   => ! [V20v3: $i] :
                        ( mem(V20v3,ty_2Esum_2Esum(A_27a,A_27a))
