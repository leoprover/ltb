...
fof(conj_thm_2Epred__set_2Ecross__countable,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epred__set_2Ecountable__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Epred__set_2Ecross__countable__IFF,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
